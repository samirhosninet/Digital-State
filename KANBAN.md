...
## In Progress
- [ ] **ADAPTER-FIX-014**: Runtime Adapter Decoupling & Verification under ADR-0001 (`014-adapter-fix-verification`). State: `READY_FOR_AUDIT`.

## Completed
- [x] **DS-GOV-ADR-0001-ACCEPT**: Architectural Decision Record ADR-0001 Accepted (Audit & Governance Architecture Separation). Closed 2026-07-22.
- [x] Initial Governance Kernel bootstrap (`feat-001`)
- [x] **011-multi-tenant-key-server**: Multi-Tenant Key Server Authentication & Identity Scoping (`tenant_id`). Closed 2026-07-19.
