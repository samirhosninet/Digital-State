...
- **Messaging configured** (optional but recommended) — [Telegram](../../user-guide/messaging/telegram/index.md) or Discord set up with a home channel
...
## Step 1: Test the Workflow Manually[​](index.md#step-1-test-the-workflow-manually "Direct link to Step 1: Test the Workflow Manually")
...
## Step 2: Create the Cron Job[​](index.md#step-2-create-the-cron-job "Direct link to Step 2: Create the Cron Job")
...
### Option A: Natural Language (in chat)[​](index.md#option-a-natural-language-in-chat "Direct link to Option A: Natural Language (in chat)")
...
### Option B: CLI Slash Command[​](index.md#option-b-cli-slash-command "Direct link to Option B: CLI Slash Command")
...
### The Golden Rule: Self-Contained Prompts[​](index.md#the-golden-rule-self-contained-prompts "Direct link to The Golden Rule: Self-Contained Prompts")
...
## Step 3: Customize the Briefing[​](index.md#step-3-customize-the-briefing "Direct link to Step 3: Customize the Briefing")

Once the basic briefing works, you can get creative.

### Multi-Topic Briefings[​](index.md#multi-topic-briefings "Direct link to Multi-Topic Briefings")
...
### Using Delegation for Parallel Research[​](index.md#using-delegation-for-parallel-research "Direct link to Using Delegation for Parallel Research")
...
Each sub-agent searches independently and in parallel, then the main agent combines everything into one polished briefing. See the [Delegation docs](../../user-guide/features/delegation/index.md) for more on how this works.

### Weekday-Only Schedule[​](index.md#weekday-only-schedule "Direct link to Weekday-Only Schedule")
...
### Twice-Daily Briefings[​](index.md#twice-daily-briefings "Direct link to Twice-Daily Briefings")
...
### Adding Personal Context with Memory[​](index.md#adding-personal-context-with-memory "Direct link to Adding Personal Context with Memory")

If you have [memory](../../user-guide/features/memory/index.md) enabled, you can store preferences that persist across sessions. But remember — cron jobs run in fresh sessions without conversational memory. To add personal context, bake it directly into the prompt:
...
## Step 4: Manage Your Jobs[​](index.md#step-4-manage-your-jobs "Direct link to Step 4: Manage Your Jobs")

### List All Scheduled Jobs[​](index.md#list-all-scheduled-jobs "Direct link to List All Scheduled Jobs")
...
### Remove a Job[​](index.md#remove-a-job "Direct link to Remove a Job")
...
### Check Gateway Status[​](index.md#check-gateway-status "Direct link to Check Gateway Status")
...
- **[Scheduled Tasks (Cron)](../../user-guide/features/cron/index.md)** — Full reference for schedule formats, repeat limits, and delivery options
- **[Delegation](../../user-guide/features/delegation/index.md)** — Deep dive into parallel sub-agent workflows
- **[Messaging Platforms](../../user-guide/messaging/index.md)** — Set up Telegram, Discord, or other delivery targets
- **[Memory](../../user-guide/features/memory/index.md)** — Persistent context across sessions
- **[Tips & Best Practices](../tips/index.md)** — More prompt engineering advice
...
- [Step 1: Test the Workflow Manually](index.md#step-1-test-the-workflow-manually)
- [Step 2: Create the Cron Job](index.md#step-2-create-the-cron-job)
  - [Option A: Natural Language (in chat)](index.md#option-a-natural-language-in-chat)
  - [Option B: CLI Slash Command](index.md#option-b-cli-slash-command)
  - [The Golden Rule: Self-Contained Prompts](index.md#the-golden-rule-self-contained-prompts)
- [Step 3: Customize the Briefing](index.md#step-3-customize-the-briefing)
  - [Multi-Topic Briefings](index.md#multi-topic-briefings)
  - [Using Delegation for Parallel Research](index.md#using-delegation-for-parallel-research)
  - [Weekday-Only Schedule](index.md#weekday-only-schedule)
  - [Twice-Daily Briefings](index.md#twice-daily-briefings)
  - [Adding Personal Context with Memory](index.md#adding-personal-context-with-memory)
- [Step 4: Manage Your Jobs](index.md#step-4-manage-your-jobs)
  - [List All Scheduled Jobs](index.md#list-all-scheduled-jobs)
  - [Remove a Job](index.md#remove-a-job)
  - [Check Gateway Status](index.md#check-gateway-status)
