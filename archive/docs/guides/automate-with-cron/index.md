...
title: Automate Anything with Cron | Hermes Agent
archived_at: 2026-05-13T02:40:25Z
---

The [daily briefing bot tutorial](../daily-briefing-bot/index.md) covers the basics. This guide goes further — five real-world automation patterns you can adapt for your own workflows.

For the full feature reference, see [Scheduled Tasks (Cron)](../../user-guide/features/cron/index.md).
...
## Pattern 2: Weekly Report[​](index.md#pattern-2-weekly-report "Direct link to Pattern 2: Weekly Report")
...
## Pattern 3: GitHub Repository Watcher[​](index.md#pattern-3-github-repository-watcher "Direct link to Pattern 3: GitHub Repository Watcher")
...
## Pattern 4: Data Collection Pipeline[​](index.md#pattern-4-data-collection-pipeline "Direct link to Pattern 4: Data Collection Pipeline")
...
## Pattern 5: Multi-Skill Workflow[​](index.md#pattern-5-multi-skill-workflow "Direct link to Pattern 5: Multi-Skill Workflow")
...
## Managing Your Jobs[​](index.md#managing-your-jobs "Direct link to Managing Your Jobs")
...
## Delivery Targets[​](index.md#delivery-targets "Direct link to Delivery Targets")
...
*For the complete cron reference — all parameters, edge cases, and internals — see [Scheduled Tasks (Cron)](../../user-guide/features/cron/index.md).*

- [Pattern 1: Website Change Monitor](index.md#pattern-1-website-change-monitor)
- [Pattern 2: Weekly Report](index.md#pattern-2-weekly-report)
- [Pattern 3: GitHub Repository Watcher](index.md#pattern-3-github-repository-watcher)
- [Pattern 4: Data Collection Pipeline](index.md#pattern-4-data-collection-pipeline)
- [Pattern 5: Multi-Skill Workflow](index.md#pattern-5-multi-skill-workflow)
- [Managing Your Jobs](index.md#managing-your-jobs)
- [Delivery Targets](index.md#delivery-targets)
- [Tips](index.md#tips)
