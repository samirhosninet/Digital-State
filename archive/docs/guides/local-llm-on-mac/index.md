...
title: Run Local LLMs on Mac | Hermes Agent
...
## Choosing a model[​](index.md#choosing-a-model "Direct link to Choosing a model")
...
| --- | --- | --- | --- |
| Qwen3.5-9B-Q4\_K\_M (GGUF) | 5.3 GB | ~10 GB with quantized KV cache | llama.cpp |
...
## Option A: llama.cpp[​](index.md#option-a-llamacpp "Direct link to Option A: llama.cpp")

llama.cpp is the most portable local LLM runtime. On macOS it uses Metal for GPU acceleration out of the box.

### Install[​](index.md#install "Direct link to Install")
...
### Download the model[​](index.md#download-the-model "Direct link to Download the model")
...
### Start the server[​](index.md#start-the-server "Direct link to Start the server")
...
### Memory optimization for constrained systems[​](index.md#memory-optimization-for-constrained-systems "Direct link to Memory optimization for constrained systems")
...
### Test it[​](index.md#test-it "Direct link to Test it")
...
### Get the model name[​](index.md#get-the-model-name "Direct link to Get the model name")
...
## Option B: MLX via omlx[​](index.md#option-b-mlx-via-omlx "Direct link to Option B: MLX via omlx")
...
### Install[​](index.md#install-1 "Direct link to Install")

Download and install from [omlx.ai](https://omlx.ai). It provides a GUI for model management and a built-in server.

### Download the model[​](index.md#download-the-model-1 "Direct link to Download the model")
...
### Start the server[​](index.md#start-the-server-1 "Direct link to Start the server")

omlx serves models on `http://127.0.0.1:8000` by default. Start serving from the app UI, or use the CLI if available.

### Test it[​](index.md#test-it-1 "Direct link to Test it")
...
### List available models[​](index.md#list-available-models "Direct link to List available models")
...
## Benchmarks: llama.cpp vs MLX[​](index.md#benchmarks-llamacpp-vs-mlx "Direct link to Benchmarks: llama.cpp vs MLX")

Both backends tested on the same machine (Apple M5 Max, 128 GB unified memory) running the same model (Qwen3.5-9B) at comparable quantization levels (Q4\_K\_M for GGUF, mxfp4 for MLX). Five diverse prompts, three runs each, backends tested sequentially to avoid resource contention.

### Results[​](index.md#results "Direct link to Results")

| Metric | llama.cpp (Q4\_K\_M) | MLX (mxfp4) | Winner |
| --- | --- | --- | --- |
...
### What this means[​](index.md#what-this-means "Direct link to What this means")
...
### Which one should you pick?[​](index.md#which-one-should-you-pick "Direct link to Which one should you pick?")
...
## Connect to Hermes[​](index.md#connect-to-hermes "Direct link to Connect to Hermes")
...
## Timeouts[​](index.md#timeouts "Direct link to Timeouts")
...
- [Choosing a model](index.md#choosing-a-model)
- [Option A: llama.cpp](index.md#option-a-llamacpp)
  - [Install](index.md#install)
  - [Download the model](index.md#download-the-model)
  - [Start the server](index.md#start-the-server)
  - [Memory optimization for constrained systems](index.md#memory-optimization-for-constrained-systems)
  - [Test it](index.md#test-it)
  - [Get the model name](index.md#get-the-model-name)
- [Option B: MLX via omlx](index.md#option-b-mlx-via-omlx)
  - [Install](index.md#install-1)
  - [Download the model](index.md#download-the-model-1)
  - [Start the server](index.md#start-the-server-1)
  - [Test it](index.md#test-it-1)
  - [List available models](index.md#list-available-models)
- [Benchmarks: llama.cpp vs MLX](index.md#benchmarks-llamacpp-vs-mlx)
  - [Results](index.md#results)
  - [What this means](index.md#what-this-means)
  - [Which one should you pick?](index.md#which-one-should-you-pick)
- [Connect to Hermes](index.md#connect-to-hermes)
- [Timeouts](index.md#timeouts)
