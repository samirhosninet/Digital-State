...
For the full feature reference, see [Subagent Delegation](../../user-guide/features/delegation/index.md).

---

## When to Delegate[​](index.md#when-to-delegate "Direct link to When to Delegate")
...
## Pattern: Parallel Research[​](index.md#pattern-parallel-research "Direct link to Pattern: Parallel Research")
...
## Pattern: Code Review[​](index.md#pattern-code-review "Direct link to Pattern: Code Review")
...
## Pattern: Compare Alternatives[​](index.md#pattern-compare-alternatives "Direct link to Pattern: Compare Alternatives")
...
## Pattern: Multi-File Refactoring[​](index.md#pattern-multi-file-refactoring "Direct link to Pattern: Multi-File Refactoring")
...
## Pattern: Gather Then Analyze[​](index.md#pattern-gather-then-analyze "Direct link to Pattern: Gather Then Analyze")
...
## Toolset Selection[​](index.md#toolset-selection "Direct link to Toolset Selection")
...
## Constraints[​](index.md#constraints "Direct link to Constraints")
...
### Tuning Concurrency and Depth[​](index.md#tuning-concurrency-and-depth "Direct link to Tuning Concurrency and Depth")
...
*For the complete delegation reference — all parameters, ACP integration, and advanced configuration — see [Subagent Delegation](../../user-guide/features/delegation/index.md).*

- [When to Delegate](index.md#when-to-delegate)
- [Pattern: Parallel Research](index.md#pattern-parallel-research)
- [Pattern: Code Review](index.md#pattern-code-review)
- [Pattern: Compare Alternatives](index.md#pattern-compare-alternatives)
- [Pattern: Multi-File Refactoring](index.md#pattern-multi-file-refactoring)
- [Pattern: Gather Then Analyze](index.md#pattern-gather-then-analyze)
- [Toolset Selection](index.md#toolset-selection)
- [Constraints](index.md#constraints)
  - [Tuning Concurrency and Depth](index.md#tuning-concurrency-and-depth)
- [Tips](index.md#tips)
