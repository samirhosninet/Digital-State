...
title: Tips & Best Practices | Hermes Agent
...
## Getting the Best Results[​](index.md#getting-the-best-results "Direct link to Getting the Best Results")

### Be Specific About What You Want[​](index.md#be-specific-about-what-you-want "Direct link to Be Specific About What You Want")
...
### Provide Context Up Front[​](index.md#provide-context-up-front "Direct link to Provide Context Up Front")
...
### Use Context Files for Recurring Instructions[​](index.md#use-context-files-for-recurring-instructions "Direct link to Use Context Files for Recurring Instructions")
...
### Let the Agent Use Its Tools[​](index.md#let-the-agent-use-its-tools "Direct link to Let the Agent Use Its Tools")
...
### Use Skills for Complex Workflows[​](index.md#use-skills-for-complex-workflows "Direct link to Use Skills for Complex Workflows")
...
## CLI Power User Tips[​](index.md#cli-power-user-tips "Direct link to CLI Power User Tips")

### Multi-Line Input[​](index.md#multi-line-input "Direct link to Multi-Line Input")
...
### Paste Detection[​](index.md#paste-detection "Direct link to Paste Detection")
...
### Interrupt and Redirect[​](index.md#interrupt-and-redirect "Direct link to Interrupt and Redirect")
...
### Resume Sessions with `-c`[​](index.md#resume-sessions-with--c "Direct link to resume-sessions-with--c")
...
### Clipboard Image Paste[​](index.md#clipboard-image-paste "Direct link to Clipboard Image Paste")
...
### Slash Command Autocomplete[​](index.md#slash-command-autocomplete "Direct link to Slash Command Autocomplete")
...
## Context Files[​](index.md#context-files "Direct link to Context Files")

### AGENTS.md: Your Project's Brain[​](index.md#agentsmd-your-projects-brain "Direct link to AGENTS.md: Your Project's Brain")
...
### SOUL.md: Customize Personality[​](index.md#soulmd-customize-personality "Direct link to SOUL.md: Customize Personality")
...
For a full walkthrough, see [Use SOUL.md with Hermes](../use-soul-with-hermes/index.md).
...
### .cursorrules Compatibility[​](index.md#cursorrules-compatibility "Direct link to .cursorrules Compatibility")
...
### Discovery[​](index.md#discovery "Direct link to Discovery")
...
## Memory & Skills[​](index.md#memory--skills "Direct link to Memory & Skills")

### Memory vs. Skills: What Goes Where[​](index.md#memory-vs-skills-what-goes-where "Direct link to Memory vs. Skills: What Goes Where")
...
### When to Create Skills[​](index.md#when-to-create-skills "Direct link to When to Create Skills")
...
### Managing Memory Capacity[​](index.md#managing-memory-capacity "Direct link to Managing Memory Capacity")
...
### Let the Agent Remember[​](index.md#let-the-agent-remember "Direct link to Let the Agent Remember")
...
## Performance & Cost[​](index.md#performance--cost "Direct link to Performance & Cost")

### Don't Break the Prompt Cache[​](index.md#dont-break-the-prompt-cache "Direct link to Don't Break the Prompt Cache")
...
### Use /compress Before Hitting Limits[​](index.md#use-compress-before-hitting-limits "Direct link to Use /compress Before Hitting Limits")
...
### Delegate for Parallel Work[​](index.md#delegate-for-parallel-work "Direct link to Delegate for Parallel Work")
...
### Use execute\_code for Batch Operations[​](index.md#use-execute_code-for-batch-operations "Direct link to Use execute_code for Batch Operations")
...
### Choose the Right Model[​](index.md#choose-the-right-model "Direct link to Choose the Right Model")
...
## Messaging Tips[​](index.md#messaging-tips "Direct link to Messaging Tips")
...
### Use /title to Organize Sessions[​](index.md#use-title-to-organize-sessions "Direct link to Use /title to Organize Sessions")
...
### DM Pairing for Team Access[​](index.md#dm-pairing-for-team-access "Direct link to DM Pairing for Team Access")
...
### Tool Progress Display Modes[​](index.md#tool-progress-display-modes "Direct link to Tool Progress Display Modes")
...
### Use Docker for Untrusted Code[​](index.md#use-docker-for-untrusted-code "Direct link to Use Docker for Untrusted Code")
...
### Avoid Windows Encoding Pitfalls[​](index.md#avoid-windows-encoding-pitfalls "Direct link to Avoid Windows Encoding Pitfalls")
...
### Review Before Choosing "Always"[​](index.md#review-before-choosing-always "Direct link to Review Before Choosing \"Always\"")
...
### Command Approval Is Your Safety Net[​](index.md#command-approval-is-your-safety-net "Direct link to Command Approval Is Your Safety Net")
...
### Use Allowlists for Messaging Bots[​](index.md#use-allowlists-for-messaging-bots "Direct link to Use Allowlists for Messaging Bots")
...
- [Getting the Best Results](index.md#getting-the-best-results)
  - [Be Specific About What You Want](index.md#be-specific-about-what-you-want)
  - [Provide Context Up Front](index.md#provide-context-up-front)
  - [Use Context Files for Recurring Instructions](index.md#use-context-files-for-recurring-instructions)
  - [Let the Agent Use Its Tools](index.md#let-the-agent-use-its-tools)
  - [Use Skills for Complex Workflows](index.md#use-skills-for-complex-workflows)
- [CLI Power User Tips](index.md#cli-power-user-tips)
  - [Multi-Line Input](index.md#multi-line-input)
  - [Paste Detection](index.md#paste-detection)
  - [Interrupt and Redirect](index.md#interrupt-and-redirect)
  - [Resume Sessions with `-c`](index.md#resume-sessions-with--c)
  - [Clipboard Image Paste](index.md#clipboard-image-paste)
  - [Slash Command Autocomplete](index.md#slash-command-autocomplete)
- [Context Files](index.md#context-files)
  - [AGENTS.md: Your Project's Brain](index.md#agentsmd-your-projects-brain)
  - [SOUL.md: Customize Personality](index.md#soulmd-customize-personality)
  - [.cursorrules Compatibility](index.md#cursorrules-compatibility)
  - [Discovery](index.md#discovery)
- [Memory & Skills](index.md#memory--skills)
  - [Memory vs. Skills: What Goes Where](index.md#memory-vs-skills-what-goes-where)
  - [When to Create Skills](index.md#when-to-create-skills)
  - [Managing Memory Capacity](index.md#managing-memory-capacity)
  - [Let the Agent Remember](index.md#let-the-agent-remember)
- [Performance & Cost](index.md#performance--cost)
  - [Don't Break the Prompt Cache](index.md#dont-break-the-prompt-cache)
  - [Use /compress Before Hitting Limits](index.md#use-compress-before-hitting-limits)
  - [Delegate for Parallel Work](index.md#delegate-for-parallel-work)
  - [Use execute\_code for Batch Operations](index.md#use-execute_code-for-batch-operations)
  - [Choose the Right Model](index.md#choose-the-right-model)
- [Messaging Tips](index.md#messaging-tips)
  - [Set a Home Channel](index.md#set-a-home-channel)
  - [Use /title to Organize Sessions](index.md#use-title-to-organize-sessions)
  - [DM Pairing for Team Access](index.md#dm-pairing-for-team-access)
  - [Tool Progress Display Modes](index.md#tool-progress-display-modes)
- [Security](index.md#security)
  - [Use Docker for Untrusted Code](index.md#use-docker-for-untrusted-code)
  - [Avoid Windows Encoding Pitfalls](index.md#avoid-windows-encoding-pitfalls)
  - [Review Before Choosing "Always"](index.md#review-before-choosing-always)
  - [Command Approval Is Your Safety Net](index.md#command-approval-is-your-safety-net)
  - [Use Allowlists for Messaging Bots](index.md#use-allowlists-for-messaging-bots)
