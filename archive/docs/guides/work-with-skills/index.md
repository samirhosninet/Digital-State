...
title: Working with Skills | Hermes Agent
...
For the full technical reference, see [Skills System](../../user-guide/features/skills/index.md).

---

## Finding Skills[​](index.md#finding-skills "Direct link to Finding Skills")
...
### Searching for a Skill[​](index.md#searching-for-a-skill "Direct link to Searching for a Skill")
...
### The Skills Hub[​](index.md#the-skills-hub "Direct link to The Skills Hub")
...
## Using a Skill[​](index.md#using-a-skill "Direct link to Using a Skill")
...
## Installing from the Hub[​](index.md#installing-from-the-hub "Direct link to Installing from the Hub")
...
### Verifying Installation[​](index.md#verifying-installation "Direct link to Verifying Installation")
...
## Plugin-Provided Skills[​](index.md#plugin-provided-skills "Direct link to Plugin-Provided Skills")
...
For how to ship skills in your own plugin, see [Build a Hermes Plugin → Bundle skills](../build-a-hermes-plugin/index.md#bundle-skills).

---

## Configuring Skill Settings[​](index.md#configuring-skill-settings "Direct link to Configuring Skill Settings")
...
## Creating Your Own Skill[​](index.md#creating-your-own-skill "Direct link to Creating Your Own Skill")

Skills are just markdown files with YAML frontmatter. Creating one takes under five minutes.

### 1. Create the Directory[​](index.md#1-create-the-directory "Direct link to 1. Create the Directory")

```
mkdir -p ~/.hermes/skills/my-category/my-skill
```

### 2. Write SKILL.md[​](index.md#2-write-skillmd "Direct link to 2. Write SKILL.md")
...
### 3. Add Reference Files (Optional)[​](index.md#3-add-reference-files-optional "Direct link to 3. Add Reference Files (Optional)")
...
## Per-Platform Skill Management[​](index.md#per-platform-skill-management "Direct link to Per-Platform Skill Management")
...
## Skills vs Memory[​](index.md#skills-vs-memory "Direct link to Skills vs Memory")
...
## Tips[​](index.md#tips "Direct link to Tips")
...
*For the complete skills reference — frontmatter fields, conditional activation, external directories, and more — see [Skills System](../../user-guide/features/skills/index.md).*

- [Finding Skills](index.md#finding-skills)
  - [Searching for a Skill](index.md#searching-for-a-skill)
  - [The Skills Hub](index.md#the-skills-hub)
- [Using a Skill](index.md#using-a-skill)
  - [Progressive Disclosure](index.md#progressive-disclosure)
- [Installing from the Hub](index.md#installing-from-the-hub)
  - [Verifying Installation](index.md#verifying-installation)
- [Plugin-Provided Skills](index.md#plugin-provided-skills)
- [Configuring Skill Settings](index.md#configuring-skill-settings)
- [Creating Your Own Skill](index.md#creating-your-own-skill)
  - [1. Create the Directory](index.md#1-create-the-directory)
  - [2. Write SKILL.md](index.md#2-write-skillmd)
  - [3. Add Reference Files (Optional)](index.md#3-add-reference-files-optional)
  - [4. Test It](index.md#4-test-it)
- [Per-Platform Skill Management](index.md#per-platform-skill-management)
- [Skills vs Memory](index.md#skills-vs-memory)
- [Tips](index.md#tips)
