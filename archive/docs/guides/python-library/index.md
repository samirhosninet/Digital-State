...
## Basic Usage[​](index.md#basic-usage "Direct link to Basic Usage")
...
## Full Conversation Control[​](index.md#full-conversation-control "Direct link to Full Conversation Control")
...
## Configuring Tools[​](index.md#configuring-tools "Direct link to Configuring Tools")
...
## Multi-turn Conversations[​](index.md#multi-turn-conversations "Direct link to Multi-turn Conversations")
...
## Saving Trajectories[​](index.md#saving-trajectories "Direct link to Saving Trajectories")
...
## Custom System Prompts[​](index.md#custom-system-prompts "Direct link to Custom System Prompts")
...
## Batch Processing[​](index.md#batch-processing "Direct link to Batch Processing")
...
## Integration Examples[​](index.md#integration-examples "Direct link to Integration Examples")

### FastAPI Endpoint[​](index.md#fastapi-endpoint "Direct link to FastAPI Endpoint")
...
### Discord Bot[​](index.md#discord-bot "Direct link to Discord Bot")
...
### CI/CD Pipeline Step[​](index.md#cicd-pipeline-step "Direct link to CI/CD Pipeline Step")
...
## Key Constructor Parameters[​](index.md#key-constructor-parameters "Direct link to Key Constructor Parameters")
...
## Important Notes[​](index.md#important-notes "Direct link to Important Notes")
...
- [Full Conversation Control](index.md#full-conversation-control)
- [Configuring Tools](index.md#configuring-tools)
- [Multi-turn Conversations](index.md#multi-turn-conversations)
- [Saving Trajectories](index.md#saving-trajectories)
- [Custom System Prompts](index.md#custom-system-prompts)
- [Batch Processing](index.md#batch-processing)
- [Integration Examples](index.md#integration-examples)
  - [FastAPI Endpoint](index.md#fastapi-endpoint)
  - [Discord Bot](index.md#discord-bot)
  - [CI/CD Pipeline Step](index.md#cicd-pipeline-step)
- [Key Constructor Parameters](index.md#key-constructor-parameters)
- [Important Notes](index.md#important-notes)
