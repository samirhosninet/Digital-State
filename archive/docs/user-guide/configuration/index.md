...
## Managing Configuration[​](index.md#managing-configuration "Direct link to Managing Configuration")
...
## Configuration Precedence[​](index.md#configuration-precedence "Direct link to Configuration Precedence")
...
## Environment Variable Substitution[​](index.md#environment-variable-substitution "Direct link to Environment Variable Substitution")
...
For AI provider setup (OpenRouter, Anthropic, Copilot, custom endpoints, self-hosted LLMs, fallback models, etc.), see [AI Providers](../../integrations/providers/index.md).

### Provider Timeouts[​](index.md#provider-timeouts "Direct link to Provider Timeouts")
...
## Terminal Backend Configuration[​](index.md#terminal-backend-configuration "Direct link to Terminal Backend Configuration")
...
### Backend Overview[​](index.md#backend-overview "Direct link to Backend Overview")
...
| **vercel\_sandbox** | Vercel Sandbox | Full (cloud microVM) | Cloud execution with snapshot-backed filesystem persistence |
| **singularity** | Singularity/Apptainer container | Namespaces (--containall) | HPC clusters, shared machines |

### Local Backend[​](index.md#local-backend "Direct link to Local Backend")
...
### Docker Backend[​](index.md#docker-backend "Direct link to Docker Backend")
...
### SSH Backend[​](index.md#ssh-backend "Direct link to SSH Backend")
...
### Modal Backend[​](index.md#modal-backend "Direct link to Modal Backend")
...
### Daytona Backend[​](index.md#daytona-backend "Direct link to Daytona Backend")
...
### Vercel Sandbox Backend[​](index.md#vercel-sandbox-backend "Direct link to Vercel Sandbox Backend")
...
### Singularity/Apptainer Backend[​](index.md#singularityapptainer-backend "Direct link to Singularity/Apptainer Backend")
...
### Common Terminal Backend Issues[​](index.md#common-terminal-backend-issues "Direct link to Common Terminal Backend Issues")
...
### Remote-to-Host File Sync on Teardown[​](index.md#remote-to-host-file-sync-on-teardown "Direct link to Remote-to-Host File Sync on Teardown")
...
### Docker Volume Mounts[​](index.md#docker-volume-mounts "Direct link to Docker Volume Mounts")
...
### Docker Credential Forwarding[​](index.md#docker-credential-forwarding "Direct link to Docker Credential Forwarding")
...
### Running the Container as Your Host User[​](index.md#running-the-container-as-your-host-user "Direct link to Running the Container as Your Host User")
...
### Optional: Mount the Launch Directory into `/workspace`[​](index.md#optional-mount-the-launch-directory-into-workspace "Direct link to optional-mount-the-launch-directory-into-workspace")
...
### Persistent Shell[​](index.md#persistent-shell "Direct link to Persistent Shell")
...
See [Code Execution](../features/code-execution/index.md) and the [Terminal section of the README](../features/tools/index.md) for details on each backend.

## Skill Settings[​](index.md#skill-settings "Direct link to Skill Settings")
...
For details on declaring config settings in your own skills, see [Creating Skills — Config Settings](../../developer-guide/creating-skills/index.md#config-settings-configyaml).

### Guard on agent-created skill writes[​](index.md#guard-on-agent-created-skill-writes "Direct link to Guard on agent-created skill writes")
...
## Memory Configuration[​](index.md#memory-configuration "Direct link to Memory Configuration")
...
## File Read Safety[​](index.md#file-read-safety "Direct link to File Read Safety")
...
## Tool Output Truncation Limits[​](index.md#tool-output-truncation-limits "Direct link to Tool Output Truncation Limits")
...
## Global Toolset Disable[​](index.md#global-toolset-disable "Direct link to Global Toolset Disable")
...
## Git Worktree Isolation[​](index.md#git-worktree-isolation "Direct link to Git Worktree Isolation")
...
## Context Compression[​](index.md#context-compression "Direct link to Context Compression")
...
### Full reference[​](index.md#full-reference "Direct link to Full reference")
...
### Common setups[​](index.md#common-setups "Direct link to Common setups")
...
### How the three knobs interact[​](index.md#how-the-three-knobs-interact "Direct link to How the three knobs interact")
...
## Context Engine[​](index.md#context-engine "Direct link to Context Engine")

The context engine controls how conversations are managed when approaching the model's token limit. The built-in `compressor` engine uses lossy summarization (see [Context Compression](../../developer-guide/context-compression-and-caching/index.md)). Plugin engines can replace it with alternative strategies.
...
See [Memory Providers](../features/memory-providers/index.md) for the analogous single-select system for memory plugins.

## Iteration Budget Pressure[​](index.md#iteration-budget-pressure "Direct link to Iteration Budget Pressure")
...
`agent.api_max_retries` controls how many times Hermes retries a provider API call on transient errors (rate limits, connection drops, 5xx) **before** fallback-provider switching engages. The default is `3` — four attempts total. If you have [fallback providers](../features/fallback-providers/index.md) configured and want to fail over faster, drop this to `0` so the first transient error on your primary immediately hands off to the fallback instead of churning retries against the flaky endpoint.

### API Timeouts[​](index.md#api-timeouts "Direct link to API Timeouts")
...
## Context Pressure Warnings[​](index.md#context-pressure-warnings "Direct link to Context Pressure Warnings")
...
## Credential Pool Strategies[​](index.md#credential-pool-strategies "Direct link to Credential Pool Strategies")
...
Options: `fill_first` (default), `round_robin`, `least_used`, `random`. See [Credential Pools](../features/credential-pools/index.md) for full documentation.

## Auxiliary Models[​](index.md#auxiliary-models "Direct link to Auxiliary Models")
...
### Video Tutorial[​](index.md#video-tutorial "Direct link to Video Tutorial")

### The universal config pattern[​](index.md#the-universal-config-pattern "Direct link to The universal config pattern")
...
Available providers for auxiliary tasks: `auto`, `main`, plus any provider in the [provider registry](../../reference/environment-variables/index.md) — `openrouter`, `nous`, `openai-codex`, `copilot`, `copilot-acp`, `anthropic`, `gemini`, `google-gemini-cli`, `qwen-oauth`, `zai`, `kimi-coding`, `kimi-coding-cn`, `minimax`, `minimax-cn`, `minimax-oauth`, `deepseek`, `nvidia`, `xai`, `ollama-cloud`, `alibaba`, `bedrock`, `huggingface`, `arcee`, `xiaomi`, `kilocode`, `opencode-zen`, `opencode-go`, `ai-gateway`, `azure-foundry` — or any named custom provider from your `custom_providers` list (e.g. `provider: "beans"`).

MiniMax OAuth

`minimax-oauth` logs in via browser OAuth (no API key needed). Run `hermes model` and select **MiniMax (OAuth)** to authenticate. Auxiliary tasks use `MiniMax-M2.7-highspeed` automatically. See the [MiniMax OAuth guide](../../guides/minimax-oauth/index.md).

`"main"` is for auxiliary tasks only

The `"main"` provider option means "use whatever provider my main agent uses" — it's only valid inside `auxiliary:`, `compression:`, and `fallback_model:` configs. It is **not** a valid value for your top-level `model.provider` setting. If you use a custom OpenAI-compatible endpoint, set `provider: custom` in your `model:` section. See [AI Providers](../../integrations/providers/index.md) for all main model provider options.

### Full auxiliary config reference[​](index.md#full-auxiliary-config-reference "Direct link to Full auxiliary config reference")
...
Context compression has its own `compression:` block for thresholds and an `auxiliary.compression:` block for model/provider settings — see [Context Compression](index.md#context-compression) above. The fallback model uses a `fallback_model:` block — see [Fallback Model](../../integrations/providers/index.md#fallback-model). All three follow the same provider/model/base\_url pattern.

### Session Search Tuning[​](index.md#session-search-tuning "Direct link to Session Search Tuning")
...
### OpenRouter routing & Pareto Code for auxiliary tasks[​](index.md#openrouter-routing--pareto-code-for-auxiliary-tasks "Direct link to OpenRouter routing & Pareto Code for auxiliary tasks")

When an auxiliary task resolves to OpenRouter (either explicitly or via `provider: "main"` while your main agent is on OpenRouter), the main agent's `provider_routing` and `openrouter.min_coding_score` settings **do not propagate** — by design, each auxiliary task is independent. To set OpenRouter provider preferences or use the [Pareto Code router](../../integrations/providers/index.md#openrouter-pareto-code-router) for a specific aux task, set them per-task via `extra_body`:
...
The shape mirrors what OpenRouter accepts in the chat completions request body. Hermes forwards the entire `extra_body` verbatim, so any other OpenRouter request-body field documented at [openrouter.ai/docs](../../index.md) works the same way.

### Changing the Vision Model[​](index.md#changing-the-vision-model "Direct link to Changing the Vision Model")
...
### Provider Options[​](index.md#provider-options "Direct link to Provider Options")
...
### Common Setups[​](index.md#common-setups-1 "Direct link to Common Setups")
...
Run `hermes model` and select **MiniMax (OAuth)** to log in and set this automatically. For the China region, the base URL will be `https://api.minimaxi.com/anthropic`. See the [MiniMax OAuth guide](../../guides/minimax-oauth/index.md) for the full walkthrough.
...
### Environment Variables (legacy)[​](index.md#environment-variables-legacy "Direct link to Environment Variables (legacy)")
...
## Reasoning Effort[​](index.md#reasoning-effort "Direct link to Reasoning Effort")
...
## Tool-Use Enforcement[​](index.md#tool-use-enforcement "Direct link to Tool-Use Enforcement")
...
### What it injects[​](index.md#what-it-injects "Direct link to What it injects")
...
### When to turn it on[​](index.md#when-to-turn-it-on "Direct link to When to turn it on")
...
## TTS Configuration[​](index.md#tts-configuration "Direct link to TTS Configuration")
...
## Display Settings[​](index.md#display-settings "Direct link to Display Settings")
...
### File-mutation verifier[​](index.md#file-mutation-verifier "Direct link to File-mutation verifier")
...
### UI language for static messages[​](index.md#ui-language-for-static-messages "Direct link to UI language for static messages")
...
### Runtime-metadata footer (gateway only)[​](index.md#runtime-metadata-footer-gateway-only "Direct link to Runtime-metadata footer (gateway only)")
...
### Per-platform progress overrides[​](index.md#per-platform-progress-overrides "Direct link to Per-platform progress overrides")
...
## Privacy[​](index.md#privacy "Direct link to Privacy")
...
## Speech-to-Text (STT)[​](index.md#speech-to-text-stt "Direct link to Speech-to-Text (STT)")
...
## Voice Mode (CLI)[​](index.md#voice-mode-cli "Direct link to Voice Mode (CLI)")
...
Use `/voice on` in the CLI to enable microphone mode, `record_key` to start/stop recording, and `/voice tts` to toggle spoken replies. See [Voice Mode](../features/voice-mode/index.md) for end-to-end setup and platform-specific behavior.

## Streaming[​](index.md#streaming "Direct link to Streaming")

Stream tokens to the terminal or messaging platforms as they arrive, instead of waiting for the full response.

### CLI Streaming[​](index.md#cli-streaming "Direct link to CLI Streaming")
...
### Gateway Streaming (Telegram, Discord, Slack)[​](index.md#gateway-streaming-telegram-discord-slack "Direct link to Gateway Streaming (Telegram, Discord, Slack)")
...
## Group Chat Session Isolation[​](index.md#group-chat-session-isolation "Direct link to Group Chat Session Isolation")
...
For the behavior details and examples, see [Sessions](../sessions/index.md) and the [Discord guide](../messaging/discord/index.md).

## Unauthorized DM Behavior[​](index.md#unauthorized-dm-behavior "Direct link to Unauthorized DM Behavior")
...
## Quick Commands[​](index.md#quick-commands "Direct link to Quick Commands")
...
## Human Delay[​](index.md#human-delay "Direct link to Human Delay")
...
## Code Execution[​](index.md#code-execution "Direct link to Code Execution")
...
## Web Search Backends[​](index.md#web-search-backends "Direct link to Web Search Backends")
...
**SearXNG** is a free, self-hosted, privacy-respecting metasearch engine that queries 70+ search engines. No API key needed — just set `SEARXNG_URL` to your instance (e.g., `http://localhost:8080`). SearXNG is search-only; `web_extract` and `web_crawl` require a separate extract provider (set `web.extract_backend`). See the [Web Search setup guide](../features/web-search/index.md) for Docker setup instructions.
...
## Browser[​](index.md#browser "Direct link to Browser")
...
See the [browser feature page](../features/browser/index.md#browser_dialog) for the full dialog workflow.

The browser toolset supports multiple providers. See the [Browser feature page](../features/browser/index.md) for details on Browserbase, Browser Use, and local Chrome CDP setup.

## Timezone[​](index.md#timezone "Direct link to Timezone")
...
## Discord[​](index.md#discord "Direct link to Discord")
...
## Website Blocklist[​](index.md#website-blocklist "Direct link to Website Blocklist")
...
## Smart Approvals[​](index.md#smart-approvals "Direct link to Smart Approvals")
...
## Checkpoints[​](index.md#checkpoints "Direct link to Checkpoints")

Automatic filesystem snapshots before destructive file operations. See the [Checkpoints & Rollback](../checkpoints-and-rollback/index.md) for details.
...
## Delegation[​](index.md#delegation "Direct link to Delegation")
...
## Context Files (SOUL.md, AGENTS.md)[​](index.md#context-files-soulmd-agentsmd "Direct link to Context Files (SOUL.md, AGENTS.md)")
...
- [Personality & SOUL.md](../features/personality/index.md)
- [Context Files](../features/context-files/index.md)

## Working Directory[​](index.md#working-directory "Direct link to Working Directory")
...
- [Managing Configuration](index.md#managing-configuration)
- [Configuration Precedence](index.md#configuration-precedence)
- [Environment Variable Substitution](index.md#environment-variable-substitution)
  - [Provider Timeouts](index.md#provider-timeouts)
- [Terminal Backend Configuration](index.md#terminal-backend-configuration)
  - [Backend Overview](index.md#backend-overview)
  - [Local Backend](index.md#local-backend)
  - [Docker Backend](index.md#docker-backend)
  - [SSH Backend](index.md#ssh-backend)
  - [Modal Backend](index.md#modal-backend)
  - [Daytona Backend](index.md#daytona-backend)
  - [Vercel Sandbox Backend](index.md#vercel-sandbox-backend)
  - [Singularity/Apptainer Backend](index.md#singularityapptainer-backend)
  - [Common Terminal Backend Issues](index.md#common-terminal-backend-issues)
  - [Remote-to-Host File Sync on Teardown](index.md#remote-to-host-file-sync-on-teardown)
  - [Docker Volume Mounts](index.md#docker-volume-mounts)
  - [Docker Credential Forwarding](index.md#docker-credential-forwarding)
  - [Running the Container as Your Host User](index.md#running-the-container-as-your-host-user)
  - [Optional: Mount the Launch Directory into `/workspace`](index.md#optional-mount-the-launch-directory-into-workspace)
  - [Persistent Shell](index.md#persistent-shell)
- [Skill Settings](index.md#skill-settings)
  - [Guard on agent-created skill writes](index.md#guard-on-agent-created-skill-writes)
- [Memory Configuration](index.md#memory-configuration)
- [File Read Safety](index.md#file-read-safety)
- [Tool Output Truncation Limits](index.md#tool-output-truncation-limits)
- [Global Toolset Disable](index.md#global-toolset-disable)
- [Git Worktree Isolation](index.md#git-worktree-isolation)
- [Context Compression](index.md#context-compression)
  - [Full reference](index.md#full-reference)
  - [Common setups](index.md#common-setups)
  - [How the three knobs interact](index.md#how-the-three-knobs-interact)
- [Context Engine](index.md#context-engine)
- [Iteration Budget Pressure](index.md#iteration-budget-pressure)
  - [API Timeouts](index.md#api-timeouts)
- [Context Pressure Warnings](index.md#context-pressure-warnings)
- [Credential Pool Strategies](index.md#credential-pool-strategies)
- [Auxiliary Models](index.md#auxiliary-models)
  - [Configuring auxiliary models interactively](index.md#configuring-auxiliary-models-interactively)
  - [Video Tutorial](index.md#video-tutorial)
  - [The universal config pattern](index.md#the-universal-config-pattern)
  - [Full auxiliary config reference](index.md#full-auxiliary-config-reference)
  - [Session Search Tuning](index.md#session-search-tuning)
  - [OpenRouter routing & Pareto Code for auxiliary tasks](index.md#openrouter-routing--pareto-code-for-auxiliary-tasks)
  - [Changing the Vision Model](index.md#changing-the-vision-model)
  - [Provider Options](index.md#provider-options)
  - [Common Setups](index.md#common-setups-1)
  - [Environment Variables (legacy)](index.md#environment-variables-legacy)
- [Reasoning Effort](index.md#reasoning-effort)
- [Tool-Use Enforcement](index.md#tool-use-enforcement)
  - [What it injects](index.md#what-it-injects)
  - [When to turn it on](index.md#when-to-turn-it-on)
- [TTS Configuration](index.md#tts-configuration)
- [Display Settings](index.md#display-settings)
  - [File-mutation verifier](index.md#file-mutation-verifier)
  - [UI language for static messages](index.md#ui-language-for-static-messages)
  - [Runtime-metadata footer (gateway only)](index.md#runtime-metadata-footer-gateway-only)
  - [Per-platform progress overrides](index.md#per-platform-progress-overrides)
- [Privacy](index.md#privacy)
- [Speech-to-Text (STT)](index.md#speech-to-text-stt)
- [Voice Mode (CLI)](index.md#voice-mode-cli)
- [Streaming](index.md#streaming)
  - [CLI Streaming](index.md#cli-streaming)
  - [Gateway Streaming (Telegram, Discord, Slack)](index.md#gateway-streaming-telegram-discord-slack)
- [Group Chat Session Isolation](index.md#group-chat-session-isolation)
- [Unauthorized DM Behavior](index.md#unauthorized-dm-behavior)
- [Quick Commands](index.md#quick-commands)
- [Human Delay](index.md#human-delay)
- [Code Execution](index.md#code-execution)
- [Web Search Backends](index.md#web-search-backends)
- [Browser](index.md#browser)
- [Timezone](index.md#timezone)
- [Discord](index.md#discord)
- [Security](index.md#security)
- [Website Blocklist](index.md#website-blocklist)
- [Smart Approvals](index.md#smart-approvals)
- [Checkpoints](index.md#checkpoints)
- [Delegation](index.md#delegation)
- [Clarify](index.md#clarify)
- [Context Files (SOUL.md, AGENTS.md)](index.md#context-files-soulmd-agentsmd)
- [Working Directory](index.md#working-directory)
