...
## Overview[​](index.md#overview "Direct link to Overview")
...
## Dangerous Command Approval[​](index.md#dangerous-command-approval "Direct link to Dangerous Command Approval")
...
### Approval Modes[​](index.md#approval-modes "Direct link to Approval Modes")
...
### YOLO Mode[​](index.md#yolo-mode "Direct link to YOLO Mode")
...
### Hardline Blocklist (Always-On Floor)[​](index.md#hardline-blocklist-always-on-floor "Direct link to Hardline Blocklist (Always-On Floor)")
...
### Approval Timeout[​](index.md#approval-timeout "Direct link to Approval Timeout")
...
### What Triggers Approval[​](index.md#what-triggers-approval "Direct link to What Triggers Approval")
...
### Approval Flow (CLI)[​](index.md#approval-flow-cli "Direct link to Approval Flow (CLI)")
...
### Approval Flow (Gateway/Messaging)[​](index.md#approval-flow-gatewaymessaging "Direct link to Approval Flow (Gateway/Messaging)")
...
### Permanent Allowlist[​](index.md#permanent-allowlist "Direct link to Permanent Allowlist")
...
## User Authorization (Gateway)[​](index.md#user-authorization-gateway "Direct link to User Authorization (Gateway)")

When running the messaging gateway, Hermes controls who can interact with the bot through a layered authorization system.

### Authorization Check Order[​](index.md#authorization-check-order "Direct link to Authorization Check Order")
...
### Platform Allowlists[​](index.md#platform-allowlists "Direct link to Platform Allowlists")
...
### DM Pairing System[​](index.md#dm-pairing-system "Direct link to DM Pairing System")
...
## Container Isolation[​](index.md#container-isolation "Direct link to Container Isolation")

When using the `docker` terminal backend, Hermes applies strict security hardening to every container.

### Docker Security Flags[​](index.md#docker-security-flags "Direct link to Docker Security Flags")
...
### Resource Limits[​](index.md#resource-limits "Direct link to Resource Limits")
...
### Filesystem Persistence[​](index.md#filesystem-persistence "Direct link to Filesystem Persistence")
...
## Terminal Backend Security Comparison[​](index.md#terminal-backend-security-comparison "Direct link to Terminal Backend Security Comparison")
...
| **vercel\_sandbox** | Cloud microVM | ❌ Skipped | Cloud execution with snapshot persistence |

## Environment Variable Passthrough[​](index.md#environment-variable-passthrough "Direct link to Environment Variable Passthrough")
...
### Credential File Passthrough (OAuth tokens, etc.)[​](index.md#credential-file-passthrough "Direct link to Credential File Passthrough (OAuth tokens, etc.)")
...
### What Each Sandbox Filters[​](index.md#what-each-sandbox-filters "Direct link to What Each Sandbox Filters")
...
## MCP Credential Handling[​](index.md#mcp-credential-handling "Direct link to MCP Credential Handling")

MCP (Model Context Protocol) server subprocesses receive a **filtered environment** to prevent accidental credential leakage.

### Safe Environment Variables[​](index.md#safe-environment-variables "Direct link to Safe Environment Variables")
...
### Credential Redaction[​](index.md#credential-redaction "Direct link to Credential Redaction")
...
### Website Access Policy[​](index.md#website-access-policy "Direct link to Website Access Policy")
...
See [Website Blocklist](../configuration/index.md#website-blocklist) in the configuration guide for full details.

### SSRF Protection[​](index.md#ssrf-protection "Direct link to SSRF Protection")
...
#### Intentionally allowing private URLs[​](index.md#intentionally-allowing-private-urls "Direct link to Intentionally allowing private URLs")
...
### Tirith Pre-Exec Security Scanning[​](index.md#tirith-pre-exec-security-scanning "Direct link to Tirith Pre-Exec Security Scanning")
...
### Context File Injection Protection[​](index.md#context-file-injection-protection "Direct link to Context File Injection Protection")
...
## Best Practices for Production Deployment[​](index.md#best-practices-for-production-deployment "Direct link to Best Practices for Production Deployment")

### Gateway Deployment Checklist[​](index.md#gateway-deployment-checklist "Direct link to Gateway Deployment Checklist")
...
### Securing API Keys[​](index.md#securing-api-keys "Direct link to Securing API Keys")
...
### Network Isolation[​](index.md#network-isolation "Direct link to Network Isolation")
...
- [Dangerous Command Approval](index.md#dangerous-command-approval)
  - [Approval Modes](index.md#approval-modes)
  - [YOLO Mode](index.md#yolo-mode)
  - [Hardline Blocklist (Always-On Floor)](index.md#hardline-blocklist-always-on-floor)
  - [Approval Timeout](index.md#approval-timeout)
  - [What Triggers Approval](index.md#what-triggers-approval)
  - [Approval Flow (CLI)](index.md#approval-flow-cli)
  - [Approval Flow (Gateway/Messaging)](index.md#approval-flow-gatewaymessaging)
  - [Permanent Allowlist](index.md#permanent-allowlist)
- [User Authorization (Gateway)](index.md#user-authorization-gateway)
  - [Authorization Check Order](index.md#authorization-check-order)
  - [Platform Allowlists](index.md#platform-allowlists)
  - [DM Pairing System](index.md#dm-pairing-system)
- [Container Isolation](index.md#container-isolation)
  - [Docker Security Flags](index.md#docker-security-flags)
  - [Resource Limits](index.md#resource-limits)
  - [Filesystem Persistence](index.md#filesystem-persistence)
- [Terminal Backend Security Comparison](index.md#terminal-backend-security-comparison)
- [Environment Variable Passthrough](index.md#environment-variable-passthrough)
  - [How It Works](index.md#how-it-works)
  - [Credential File Passthrough (OAuth tokens, etc.)](index.md#credential-file-passthrough)
  - [What Each Sandbox Filters](index.md#what-each-sandbox-filters)
  - [Security Considerations](index.md#security-considerations)
- [MCP Credential Handling](index.md#mcp-credential-handling)
  - [Safe Environment Variables](index.md#safe-environment-variables)
  - [Credential Redaction](index.md#credential-redaction)
  - [Website Access Policy](index.md#website-access-policy)
  - [SSRF Protection](index.md#ssrf-protection)
  - [Tirith Pre-Exec Security Scanning](index.md#tirith-pre-exec-security-scanning)
  - [Context File Injection Protection](index.md#context-file-injection-protection)
- [Best Practices for Production Deployment](index.md#best-practices-for-production-deployment)
  - [Gateway Deployment Checklist](index.md#gateway-deployment-checklist)
  - [Securing API Keys](index.md#securing-api-keys)
  - [Network Isolation](index.md#network-isolation)
