...
### Session Model in Mattermost[​](index.md#session-model-in-mattermost "Direct link to Session Model in Mattermost")
...
## Step 1: Enable Bot Accounts[​](index.md#step-1-enable-bot-accounts "Direct link to Step 1: Enable Bot Accounts")
...
## Step 2: Create a Bot Account[​](index.md#step-2-create-a-bot-account "Direct link to Step 2: Create a Bot Account")
...
## Step 3: Add the Bot to Channels[​](index.md#step-3-add-the-bot-to-channels "Direct link to Step 3: Add the Bot to Channels")
...
## Step 4: Find Your Mattermost User ID[​](index.md#step-4-find-your-mattermost-user-id "Direct link to Step 4: Find Your Mattermost User ID")
...
## Step 5: Configure Hermes Agent[​](index.md#step-5-configure-hermes-agent "Direct link to Step 5: Configure Hermes Agent")
...
## Reply Mode[​](index.md#reply-mode "Direct link to Reply Mode")
...
## Mention Behavior[​](index.md#mention-behavior "Direct link to Mention Behavior")
...
| `MATTERMOST_FREE_RESPONSE_CHANNELS` | *(none)* | Comma-separated channel IDs where the bot responds without `@mention`, even when require\_mention is true. |
...
### WebSocket disconnects / reconnection loops[​](index.md#websocket-disconnects--reconnection-loops "Direct link to WebSocket disconnects / reconnection loops")
...
### "Failed to authenticate" on startup[​](index.md#failed-to-authenticate-on-startup "Direct link to \"Failed to authenticate\" on startup")
...
- [How Hermes Behaves](index.md#how-hermes-behaves)
  - [Session Model in Mattermost](index.md#session-model-in-mattermost)
- [Step 1: Enable Bot Accounts](index.md#step-1-enable-bot-accounts)
- [Step 2: Create a Bot Account](index.md#step-2-create-a-bot-account)
- [Step 3: Add the Bot to Channels](index.md#step-3-add-the-bot-to-channels)
- [Step 4: Find Your Mattermost User ID](index.md#step-4-find-your-mattermost-user-id)
- [Step 5: Configure Hermes Agent](index.md#step-5-configure-hermes-agent)
...
- [Reply Mode](index.md#reply-mode)
- [Mention Behavior](index.md#mention-behavior)
- [Troubleshooting](index.md#troubleshooting)
  ...
  - [WebSocket disconnects / reconnection loops](index.md#websocket-disconnects--reconnection-loops)
  - ["Failed to authenticate" on startup](index.md#failed-to-authenticate-on-startup)
