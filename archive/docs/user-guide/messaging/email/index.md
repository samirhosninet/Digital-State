...
### Gmail Setup[​](index.md#gmail-setup "Direct link to Gmail Setup")
...
### Outlook / Microsoft 365[​](index.md#outlook--microsoft-365 "Direct link to Outlook / Microsoft 365")
...
### Other Providers[​](index.md#other-providers "Direct link to Other Providers")
...
## Step 1: Configure Hermes[​](index.md#step-1-configure-hermes "Direct link to Step 1: Configure Hermes")
...
## Step 2: Start the Gateway[​](index.md#step-2-start-the-gateway "Direct link to Step 2: Start the Gateway")
...
### Receiving Messages[​](index.md#receiving-messages "Direct link to Receiving Messages")
...
### Sending Replies[​](index.md#sending-replies "Direct link to Sending Replies")
...
### File Attachments[​](index.md#file-attachments "Direct link to File Attachments")
...
### Skipping Attachments[​](index.md#skipping-attachments "Direct link to Skipping Attachments")
...
- [Prerequisites](index.md#prerequisites)
  - [Gmail Setup](index.md#gmail-setup)
  - [Outlook / Microsoft 365](index.md#outlook--microsoft-365)
  - [Other Providers](index.md#other-providers)
- [Step 1: Configure Hermes](index.md#step-1-configure-hermes)
  - [Manual Configuration](index.md#manual-configuration)
- [Step 2: Start the Gateway](index.md#step-2-start-the-gateway)
- [How It Works](index.md#how-it-works)
  - [Receiving Messages](index.md#receiving-messages)
  - [Sending Replies](index.md#sending-replies)
  - [File Attachments](index.md#file-attachments)
  - [Skipping Attachments](index.md#skipping-attachments)
