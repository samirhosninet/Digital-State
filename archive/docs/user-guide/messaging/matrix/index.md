...
### Session Model in Matrix[​](index.md#session-model-in-matrix "Direct link to Session Model in Matrix")
...
### Mention and Threading Configuration[​](index.md#mention-and-threading-configuration "Direct link to Mention and Threading Configuration")
...
## Step 1: Create a Bot Account[​](index.md#step-1-create-a-bot-account "Direct link to Step 1: Create a Bot Account")

You need a Matrix user account for the bot. There are several ways to do this:

### Option A: Register on Your Homeserver (Recommended)[​](index.md#option-a-register-on-your-homeserver-recommended "Direct link to Option A: Register on Your Homeserver (Recommended)")
...
### Option B: Use matrix.org or Another Public Homeserver[​](index.md#option-b-use-matrixorg-or-another-public-homeserver "Direct link to Option B: Use matrix.org or Another Public Homeserver")

1. Go to [Element Web](https://app.element.io) and create a new account.
2. Pick a username for your bot (e.g., `hermes-bot`).

### Option C: Use Your Own Account[​](index.md#option-c-use-your-own-account "Direct link to Option C: Use Your Own Account")

You can also run Hermes as your own user. This means the bot posts as you — useful for personal assistants.

## Step 2: Get an Access Token[​](index.md#step-2-get-an-access-token "Direct link to Step 2: Get an Access Token")

Hermes needs an access token to authenticate with the homeserver. You have two options:

### Option A: Access Token (Recommended)[​](index.md#option-a-access-token-recommended "Direct link to Option A: Access Token (Recommended)")
...
### Option B: Password Login[​](index.md#option-b-password-login "Direct link to Option B: Password Login")
...
## Step 3: Find Your Matrix User ID[​](index.md#step-3-find-your-matrix-user-id "Direct link to Step 3: Find Your Matrix User ID")
...
## Step 4: Configure Hermes Agent[​](index.md#step-4-configure-hermes-agent "Direct link to Step 4: Configure Hermes Agent")
...
## End-to-End Encryption (E2EE)[​](index.md#end-to-end-encryption-e2ee "Direct link to End-to-End Encryption (E2EE)")

Hermes supports Matrix end-to-end encryption, so you can chat with your bot in encrypted rooms.

### Requirements[​](index.md#requirements "Direct link to Requirements")
...
### Enable E2EE[​](index.md#enable-e2ee "Direct link to Enable E2EE")
...
### Cross-Signing Verification (Recommended)[​](index.md#cross-signing-verification-recommended "Direct link to Cross-Signing Verification (Recommended)")
...
## Home Room[​](index.md#home-room "Direct link to Home Room")
...
### Bot is not responding to messages[​](index.md#bot-is-not-responding-to-messages "Direct link to Bot is not responding to messages")
...
### "Failed to authenticate" / "whoami failed" on startup[​](index.md#failed-to-authenticate--whoami-failed-on-startup "Direct link to \"Failed to authenticate\" / \"whoami failed\" on startup")
...
### "mautrix not installed" error[​](index.md#mautrix-not-installed-error "Direct link to \"mautrix not installed\" error")
...
### Encryption errors / "could not decrypt event"[​](index.md#encryption-errors--could-not-decrypt-event "Direct link to Encryption errors / \"could not decrypt event\"")
...
### Upgrading from a previous version with E2EE[​](index.md#upgrading-from-a-previous-version-with-e2ee "Direct link to Upgrading from a previous version with E2EE")
...
## Proxy Mode (E2EE on macOS)[​](index.md#proxy-mode-e2ee-on-macos "Direct link to Proxy Mode (E2EE on macOS)")
...
### Step 1: Configure the Host (macOS)[​](index.md#step-1-configure-the-host-macos "Direct link to Step 1: Configure the Host (macOS)")
...
### Step 2: Configure the Docker Container (Linux VM)[​](index.md#step-2-configure-the-docker-container-linux-vm "Direct link to Step 2: Configure the Docker Container (Linux VM)")
...
### Step 3: Start Both[​](index.md#step-3-start-both "Direct link to Step 3: Start Both")
...
### Works for Any Platform[​](index.md#works-for-any-platform "Direct link to Works for Any Platform")
...
### Sync issues / bot falls behind[​](index.md#sync-issues--bot-falls-behind "Direct link to Sync issues / bot falls behind")
...
## Notes[​](index.md#notes "Direct link to Notes")
...
- [How Hermes Behaves](index.md#how-hermes-behaves)
  - [Session Model in Matrix](index.md#session-model-in-matrix)
  - [Mention and Threading Configuration](index.md#mention-and-threading-configuration)
- [Step 1: Create a Bot Account](index.md#step-1-create-a-bot-account)
  - [Option A: Register on Your Homeserver (Recommended)](index.md#option-a-register-on-your-homeserver-recommended)
  - [Option B: Use matrix.org or Another Public Homeserver](index.md#option-b-use-matrixorg-or-another-public-homeserver)
  - [Option C: Use Your Own Account](index.md#option-c-use-your-own-account)
- [Step 2: Get an Access Token](index.md#step-2-get-an-access-token)
  - [Option A: Access Token (Recommended)](index.md#option-a-access-token-recommended)
  - [Option B: Password Login](index.md#option-b-password-login)
- [Step 3: Find Your Matrix User ID](index.md#step-3-find-your-matrix-user-id)
- [Step 4: Configure Hermes Agent](index.md#step-4-configure-hermes-agent)
...
- [End-to-End Encryption (E2EE)](index.md#end-to-end-encryption-e2ee)
  - [Requirements](index.md#requirements)
  - [Enable E2EE](index.md#enable-e2ee)
  - [Cross-Signing Verification (Recommended)](index.md#cross-signing-verification-recommended)
- [Home Room](index.md#home-room)
...
- [Troubleshooting](index.md#troubleshooting)
  - [Bot is not responding to messages](index.md#bot-is-not-responding-to-messages)
  - ["Failed to authenticate" / "whoami failed" on startup](index.md#failed-to-authenticate--whoami-failed-on-startup)
  - ["mautrix not installed" error](index.md#mautrix-not-installed-error)
  - [Encryption errors / "could not decrypt event"](index.md#encryption-errors--could-not-decrypt-event)
  - [Upgrading from a previous version with E2EE](index.md#upgrading-from-a-previous-version-with-e2ee)
- [Proxy Mode (E2EE on macOS)](index.md#proxy-mode-e2ee-on-macos)
  - [How It Works](index.md#how-it-works)
  - [Step 1: Configure the Host (macOS)](index.md#step-1-configure-the-host-macos)
  - [Step 2: Configure the Docker Container (Linux VM)](index.md#step-2-configure-the-docker-container-linux-vm)
  - [Step 3: Start Both](index.md#step-3-start-both)
  - [Configuration Reference](index.md#configuration-reference)
  - [Works for Any Platform](index.md#works-for-any-platform)
  - [Sync issues / bot falls behind](index.md#sync-issues--bot-falls-behind)
