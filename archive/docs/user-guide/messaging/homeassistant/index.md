...
### 1. Create a Long-Lived Access Token[​](index.md#1-create-a-long-lived-access-token "Direct link to 1. Create a Long-Lived Access Token")
...
### 2. Configure Environment Variables[​](index.md#2-configure-environment-variables "Direct link to 2. Configure Environment Variables")
...
### 3. Start the Gateway[​](index.md#3-start-the-gateway "Direct link to 3. Start the Gateway")
...
### `ha_list_entities`[​](index.md#ha_list_entities "Direct link to ha_list_entities")
...
### `ha_get_state`[​](index.md#ha_get_state "Direct link to ha_get_state")
...
### `ha_list_services`[​](index.md#ha_list_services "Direct link to ha_list_services")
...
### `ha_call_service`[​](index.md#ha_call_service "Direct link to ha_call_service")
...
## Gateway Platform: Real-Time Events[​](index.md#gateway-platform-real-time-events "Direct link to Gateway Platform: Real-Time Events")
...
### Event Filtering[​](index.md#event-filtering "Direct link to Event Filtering")
...
### Event Formatting[​](index.md#event-formatting "Direct link to Event Formatting")
...
| `alarm_control_panel` | "alarm state changed from 'armed\_away' to 'triggered'" |
| *(other)* | "changed from 'old' to 'new'" |

### Agent Responses[​](index.md#agent-responses "Direct link to Agent Responses")
...
### Connection Management[​](index.md#connection-management "Direct link to Connection Management")
...
## Example Automations[​](index.md#example-automations "Direct link to Example Automations")

### Morning Routine[​](index.md#morning-routine "Direct link to Morning Routine")
...
### Security Check[​](index.md#security-check "Direct link to Security Check")
...
### Reactive Automation (via Gateway Events)[​](index.md#reactive-automation-via-gateway-events "Direct link to Reactive Automation (via Gateway Events)")
...
- [Setup](index.md#setup)
  - [1. Create a Long-Lived Access Token](index.md#1-create-a-long-lived-access-token)
  - [2. Configure Environment Variables](index.md#2-configure-environment-variables)
  - [3. Start the Gateway](index.md#3-start-the-gateway)
- [Available Tools](index.md#available-tools)
  - [`ha_list_entities`](index.md#ha_list_entities)
  - [`ha_get_state`](index.md#ha_get_state)
  - [`ha_list_services`](index.md#ha_list_services)
  - [`ha_call_service`](index.md#ha_call_service)
- [Gateway Platform: Real-Time Events](index.md#gateway-platform-real-time-events)
  - [Event Filtering](index.md#event-filtering)
  - [Event Formatting](index.md#event-formatting)
  - [Agent Responses](index.md#agent-responses)
  - [Connection Management](index.md#connection-management)
- [Security](index.md#security)
- [Example Automations](index.md#example-automations)
  - [Morning Routine](index.md#morning-routine)
  - [Security Check](index.md#security-check)
  - [Reactive Automation (via Gateway Events)](index.md#reactive-automation-via-gateway-events)
