...
## Step 1: Create a Bot via BotFather[​](index.md#step-1-create-a-bot-via-botfather "Direct link to Step 1: Create a Bot via BotFather")
...
## Step 2: Customize Your Bot (Optional)[​](index.md#step-2-customize-your-bot-optional "Direct link to Step 2: Customize Your Bot (Optional)")
...
## Step 3: Privacy Mode (Critical for Groups)[​](index.md#step-3-privacy-mode-critical-for-groups "Direct link to Step 3: Privacy Mode (Critical for Groups)")
...
### How to disable privacy mode[​](index.md#how-to-disable-privacy-mode "Direct link to How to disable privacy mode")
...
## Step 4: Find Your User ID[​](index.md#step-4-find-your-user-id "Direct link to Step 4: Find Your User ID")
...
## Step 5: Configure Hermes[​](index.md#step-5-configure-hermes "Direct link to Step 5: Configure Hermes")
...
### Start the Gateway[​](index.md#start-the-gateway "Direct link to Start the Gateway")
...
## Sending Generated Files from Docker-backed Terminals[​](index.md#sending-generated-files-from-docker-backed-terminals "Direct link to Sending Generated Files from Docker-backed Terminals")
...
### Supported `MEDIA:` file extensions[​](index.md#supported-media-file-extensions "Direct link to supported-media-file-extensions")
...
## Webhook Mode[​](index.md#webhook-mode "Direct link to Webhook Mode")
...
### Cloud deployment example (Fly.io)[​](index.md#cloud-deployment-example-flyio "Direct link to Cloud deployment example (Fly.io)")
...
## Proxy Support[​](index.md#proxy-support "Direct link to Proxy Support")
...
## Home Channel[​](index.md#home-channel "Direct link to Home Channel")
...
## Voice Messages[​](index.md#voice-messages "Direct link to Voice Messages")

### Incoming Voice (Speech-to-Text)[​](index.md#incoming-voice-speech-to-text "Direct link to Incoming Voice (Speech-to-Text)")
...
### Outgoing Voice (Text-to-Speech)[​](index.md#outgoing-voice-text-to-speech "Direct link to Outgoing Voice (Text-to-Speech)")
...
## Group Chat Usage[​](index.md#group-chat-usage "Direct link to Group Chat Usage")

Hermes Agent works in Telegram group chats with a few considerations:

- **Privacy mode** determines what messages the bot can see (see [Step 3](index.md#step-3-privacy-mode-critical-for-groups))
...
### Troubleshooting: works in DMs but not groups[​](index.md#troubleshooting-works-in-dms-but-not-groups "Direct link to Troubleshooting: works in DMs but not groups")
...
### Example group trigger configuration[​](index.md#example-group-trigger-configuration "Direct link to Example group trigger configuration")
...
### Notes on `mention_patterns`[​](index.md#notes-on-mention_patterns "Direct link to notes-on-mention_patterns")
...
## Private Chat Topics (Bot API 9.4)[​](index.md#private-chat-topics-bot-api-94 "Direct link to Private Chat Topics (Bot API 9.4)")
...
### Use case[​](index.md#use-case "Direct link to Use case")
...
### Configuration[​](index.md#configuration-1 "Direct link to Configuration")
...
### Skill binding[​](index.md#skill-binding "Direct link to Skill binding")
...
## Multi-session DM mode (`/topic`)[​](index.md#multi-session-dm-mode-topic "Direct link to multi-session-dm-mode-topic")
...
### `/topic` subcommands[​](index.md#topic-subcommands "Direct link to topic-subcommands")
...
### DM Topics vs Multi-session DM mode[​](index.md#dm-topics-vs-multi-session-dm-mode "Direct link to DM Topics vs Multi-session DM mode")
...
### Activation flow[​](index.md#activation-flow "Direct link to Activation flow")
...
### Creating a new topic (end-user flow)[​](index.md#creating-a-new-topic-end-user-flow "Direct link to Creating a new topic (end-user flow)")
...
### Auto-renamed topics[​](index.md#auto-renamed-topics "Direct link to Auto-renamed topics")
...
### `/new` inside a topic[​](index.md#new-inside-a-topic "Direct link to new-inside-a-topic")
...
### Restoring a previous session[​](index.md#restoring-a-previous-session "Direct link to Restoring a previous session")
...
### `/topic` inside a topic (no argument)[​](index.md#topic-inside-a-topic-no-argument "Direct link to topic-inside-a-topic-no-argument")

Shows the current topic's binding: session title, session ID, and hints for `/new` vs creating another topic.

### Under the hood[​](index.md#under-the-hood "Direct link to Under the hood")
...
### Disabling multi-session mode[​](index.md#disabling-multi-session-mode "Direct link to Disabling multi-session mode")
...
### Downgrading Hermes[​](index.md#downgrading-hermes "Direct link to Downgrading Hermes")
...
## Group Forum Topic Skill Binding[​](index.md#group-forum-topic-skill-binding "Direct link to Group Forum Topic Skill Binding")
...
### Use case[​](index.md#use-case-1 "Direct link to Use case")
...
### Configuration[​](index.md#configuration-2 "Direct link to Configuration")
...
### How it works[​](index.md#how-it-works-1 "Direct link to How it works")
...
### Differences from DM Topics[​](index.md#differences-from-dm-topics "Direct link to Differences from DM Topics")
...
## Recent Bot API Features[​](index.md#recent-bot-api-features "Direct link to Recent Bot API Features")

- **Bot API 9.4 (Feb 2026):** Private Chat Topics — bots can create forum topics in 1-on-1 DM chats via `createForumTopic`. Hermes uses this for two distinct features: operator-curated [Private Chat Topics](index.md#private-chat-topics-bot-api-94) (config-driven, fixed topic list) and user-driven [Multi-session DM mode](index.md#multi-session-dm-mode-topic) (activated by `/topic`, unlimited user-created topics).
...
### Streaming transport (`gateway.streaming.transport`)[​](index.md#streaming-transport-gatewaystreamingtransport "Direct link to streaming-transport-gatewaystreamingtransport")
...
## Rendering: Tables and Link Previews[​](index.md#rendering-tables-and-link-previews "Direct link to Rendering: Tables and Link Previews")
...
## Group Allowlisting[​](index.md#group-allowlisting "Direct link to Group Allowlisting")
...
### Migration from before PR #17686[​](index.md#migration-from-before-pr-17686 "Direct link to Migration from before PR #17686")
...
## Slash Command Access Control[​](index.md#slash-command-access-control "Direct link to Slash Command Access Control")
...
## Interactive Model Picker[​](index.md#interactive-model-picker "Direct link to Interactive Model Picker")
...
## DNS-over-HTTPS Fallback IPs[​](index.md#dns-over-https-fallback-ips "Direct link to DNS-over-HTTPS Fallback IPs")
...
### How it works[​](index.md#how-it-works-2 "Direct link to How it works")
...
### Configuration[​](index.md#configuration-3 "Direct link to Configuration")
...
## Proxy Support[​](index.md#proxy-support-1 "Direct link to Proxy Support")
...
### Supported variables[​](index.md#supported-variables "Direct link to Supported variables")
...
### Configuration[​](index.md#configuration-4 "Direct link to Configuration")
...
## Message Reactions[​](index.md#message-reactions "Direct link to Message Reactions")
...
## Per-Channel Prompts[​](index.md#per-channel-prompts "Direct link to Per-Channel Prompts")
...
## Exec Approval[​](index.md#exec-approval "Direct link to Exec Approval")
...
## Interactive Prompts (clarify)[​](index.md#interactive-prompts-clarify "Direct link to Interactive Prompts (clarify)")
...
For more details, see the [Security documentation](../../security/index.md). You can also use [DM pairing](../index.md#dm-pairing-alternative-to-allowlists) for a more dynamic approach to user authorization.

- [Step 1: Create a Bot via BotFather](index.md#step-1-create-a-bot-via-botfather)
- [Step 2: Customize Your Bot (Optional)](index.md#step-2-customize-your-bot-optional)
- [Step 3: Privacy Mode (Critical for Groups)](index.md#step-3-privacy-mode-critical-for-groups)
  - [How to disable privacy mode](index.md#how-to-disable-privacy-mode)
- [Step 4: Find Your User ID](index.md#step-4-find-your-user-id)
- [Step 5: Configure Hermes](index.md#step-5-configure-hermes)
  ...
  - [Start the Gateway](index.md#start-the-gateway)
- [Sending Generated Files from Docker-backed Terminals](index.md#sending-generated-files-from-docker-backed-terminals)
  - [Supported `MEDIA:` file extensions](index.md#supported-media-file-extensions)
- [Webhook Mode](index.md#webhook-mode)
  - [Configuration](index.md#configuration)
  - [Cloud deployment example (Fly.io)](index.md#cloud-deployment-example-flyio)
- [Proxy Support](index.md#proxy-support)
- [Home Channel](index.md#home-channel)
- [Voice Messages](index.md#voice-messages)
  - [Incoming Voice (Speech-to-Text)](index.md#incoming-voice-speech-to-text)
  - [Outgoing Voice (Text-to-Speech)](index.md#outgoing-voice-text-to-speech)
- [Group Chat Usage](index.md#group-chat-usage)
  - [Troubleshooting: works in DMs but not groups](index.md#troubleshooting-works-in-dms-but-not-groups)
  - [Example group trigger configuration](index.md#example-group-trigger-configuration)
  - [Notes on `mention_patterns`](index.md#notes-on-mention_patterns)
- [Private Chat Topics (Bot API 9.4)](index.md#private-chat-topics-bot-api-94)
  - [Use case](index.md#use-case)
  - [Configuration](index.md#configuration-1)
  - [How it works](index.md#how-it-works)
  - [Skill binding](index.md#skill-binding)
- [Multi-session DM mode (`/topic`)](index.md#multi-session-dm-mode-topic)
  - [`/topic` subcommands](index.md#topic-subcommands)
  - [DM Topics vs Multi-session DM mode](index.md#dm-topics-vs-multi-session-dm-mode)
  - [Prerequisites](index.md#prerequisites)
  - [Activation flow](index.md#activation-flow)
  - [Creating a new topic (end-user flow)](index.md#creating-a-new-topic-end-user-flow)
  - [Auto-renamed topics](index.md#auto-renamed-topics)
  - [`/new` inside a topic](index.md#new-inside-a-topic)
  - [Restoring a previous session](index.md#restoring-a-previous-session)
  - [`/topic` inside a topic (no argument)](index.md#topic-inside-a-topic-no-argument)
  - [Under the hood](index.md#under-the-hood)
  - [Disabling multi-session mode](index.md#disabling-multi-session-mode)
  - [Downgrading Hermes](index.md#downgrading-hermes)
- [Group Forum Topic Skill Binding](index.md#group-forum-topic-skill-binding)
  - [Use case](index.md#use-case-1)
  - [Configuration](index.md#configuration-2)
  - [How it works](index.md#how-it-works-1)
  - [Differences from DM Topics](index.md#differences-from-dm-topics)
- [Recent Bot API Features](index.md#recent-bot-api-features)
  - [Streaming transport (`gateway.streaming.transport`)](index.md#streaming-transport-gatewaystreamingtransport)
- [Rendering: Tables and Link Previews](index.md#rendering-tables-and-link-previews)
- [Group Allowlisting](index.md#group-allowlisting)
  - [Migration from before PR #17686](index.md#migration-from-before-pr-17686)
- [Slash Command Access Control](index.md#slash-command-access-control)
- [Interactive Model Picker](index.md#interactive-model-picker)
- [DNS-over-HTTPS Fallback IPs](index.md#dns-over-https-fallback-ips)
  - [How it works](index.md#how-it-works-2)
  - [Configuration](index.md#configuration-3)
- [Proxy Support](index.md#proxy-support-1)
  - [Supported variables](index.md#supported-variables)
  - [Configuration](index.md#configuration-4)
- [Message Reactions](index.md#message-reactions)
- [Per-Channel Prompts](index.md#per-channel-prompts)
- [Troubleshooting](index.md#troubleshooting)
- [Exec Approval](index.md#exec-approval)
- [Interactive Prompts (clarify)](index.md#interactive-prompts-clarify)
