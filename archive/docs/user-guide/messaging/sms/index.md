...
The SMS gateway shares credentials with the optional [telephony skill](../../../reference/skills-catalog/index.md). If you've already set up Twilio for voice calls or one-off SMS, the gateway works with the same `TWILIO_ACCOUNT_SID`, `TWILIO_AUTH_TOKEN`, and `TWILIO_PHONE_NUMBER`.
...
## Step 1: Get Your Twilio Credentials[​](index.md#step-1-get-your-twilio-credentials "Direct link to Step 1: Get Your Twilio Credentials")
...
## Step 2: Configure Hermes[​](index.md#step-2-configure-hermes "Direct link to Step 2: Configure Hermes")

### Interactive setup (recommended)[​](index.md#interactive-setup-recommended "Direct link to Interactive setup (recommended)")
...
### Manual setup[​](index.md#manual-setup "Direct link to Manual setup")
...
## Step 3: Configure Twilio Webhook[​](index.md#step-3-configure-twilio-webhook "Direct link to Step 3: Configure Twilio Webhook")
...
## Step 4: Start the Gateway[​](index.md#step-4-start-the-gateway "Direct link to Step 4: Start the Gateway")
...
## SMS-Specific Behavior[​](index.md#sms-specific-behavior "Direct link to SMS-Specific Behavior")
...
### Webhook signature validation[​](index.md#webhook-signature-validation "Direct link to Webhook signature validation")
...
### User allowlists[​](index.md#user-allowlists "Direct link to User allowlists")
...
### Messages not arriving[​](index.md#messages-not-arriving "Direct link to Messages not arriving")
...
### Replies not sending[​](index.md#replies-not-sending "Direct link to Replies not sending")
...
### Webhook port conflicts[​](index.md#webhook-port-conflicts "Direct link to Webhook port conflicts")
...
- [Step 1: Get Your Twilio Credentials](index.md#step-1-get-your-twilio-credentials)
- [Step 2: Configure Hermes](index.md#step-2-configure-hermes)
  - [Interactive setup (recommended)](index.md#interactive-setup-recommended)
  - [Manual setup](index.md#manual-setup)
- [Step 3: Configure Twilio Webhook](index.md#step-3-configure-twilio-webhook)
- [Step 4: Start the Gateway](index.md#step-4-start-the-gateway)
- [Environment Variables](index.md#environment-variables)
- [SMS-Specific Behavior](index.md#sms-specific-behavior)
- [Security](index.md#security)
  - [Webhook signature validation](index.md#webhook-signature-validation)
  - [User allowlists](index.md#user-allowlists)
- [Troubleshooting](index.md#troubleshooting)
  - [Messages not arriving](index.md#messages-not-arriving)
  - [Replies not sending](index.md#replies-not-sending)
  - [Webhook port conflicts](index.md#webhook-port-conflicts)
