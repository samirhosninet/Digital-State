...
## Step 1: Create a Slack App[​](index.md#step-1-create-a-slack-app "Direct link to Step 1: Create a Slack App")
...
### Option A: From a Hermes-generated manifest (recommended)[​](index.md#option-a-from-a-hermes-generated-manifest-recommended "Direct link to Option A: From a Hermes-generated manifest (recommended)")
...
### Option B: From scratch (manual)[​](index.md#option-b-from-scratch-manual "Direct link to Option B: From scratch (manual)")
...
## Step 2: Configure Bot Token Scopes[​](index.md#step-2-configure-bot-token-scopes "Direct link to Step 2: Configure Bot Token Scopes")
...
## Step 3: Enable Socket Mode[​](index.md#step-3-enable-socket-mode "Direct link to Step 3: Enable Socket Mode")
...
## Step 4: Subscribe to Events[​](index.md#step-4-subscribe-to-events "Direct link to Step 4: Subscribe to Events")
...
## Step 5: Enable the Messages Tab[​](index.md#step-5-enable-the-messages-tab "Direct link to Step 5: Enable the Messages Tab")
...
## Step 6: Install App to Workspace[​](index.md#step-6-install-app-to-workspace "Direct link to Step 6: Install App to Workspace")
...
## Step 7: Find User IDs for the Allowlist[​](index.md#step-7-find-user-ids-for-the-allowlist "Direct link to Step 7: Find User IDs for the Allowlist")
...
## Step 8: Configure Hermes[​](index.md#step-8-configure-hermes "Direct link to Step 8: Configure Hermes")
...
## Step 9: Invite the Bot to Channels[​](index.md#step-9-invite-the-bot-to-channels "Direct link to Step 9: Invite the Bot to Channels")
...
### Refreshing slash commands after updates[​](index.md#refreshing-slash-commands-after-updates "Direct link to Refreshing slash commands after updates")
...
### Legacy `/hermes <subcommand>` still works[​](index.md#legacy-hermes-subcommand-still-works "Direct link to legacy-hermes-subcommand-still-works")
...
### Advanced: emit only the slash-commands array[​](index.md#advanced-emit-only-the-slash-commands-array "Direct link to Advanced: emit only the slash-commands array")
...
## How the Bot Responds[​](index.md#how-the-bot-responds "Direct link to How the Bot Responds")
...
## Configuration Options[​](index.md#configuration-options "Direct link to Configuration Options")

Beyond the required environment variables from Step 8, you can customize Slack bot behavior through `~/.hermes/config.yaml`.

### Thread & Reply Behavior[​](index.md#thread--reply-behavior "Direct link to Thread & Reply Behavior")
...
### Session Isolation[​](index.md#session-isolation "Direct link to Session Isolation")
...
### Mention & Trigger Behavior[​](index.md#mention--trigger-behavior "Direct link to Mention & Trigger Behavior")
...
### Unauthorized User Handling[​](index.md#unauthorized-user-handling "Direct link to Unauthorized User Handling")
...
### Voice Transcription[​](index.md#voice-transcription "Direct link to Voice Transcription")
...
## Multi-Workspace Support[​](index.md#multi-workspace-support "Direct link to Multi-Workspace Support")
...
### OAuth Token File[​](index.md#oauth-token-file "Direct link to OAuth Token File")
...
## Per-Channel Skill Bindings[​](index.md#per-channel-skill-bindings "Direct link to Per-Channel Skill Bindings")
...
### Quick Checklist[​](index.md#quick-checklist "Direct link to Quick Checklist")
...
- [Step 1: Create a Slack App](index.md#step-1-create-a-slack-app)
  - [Option A: From a Hermes-generated manifest (recommended)](index.md#option-a-from-a-hermes-generated-manifest-recommended)
  - [Option B: From scratch (manual)](index.md#option-b-from-scratch-manual)
- [Step 2: Configure Bot Token Scopes](index.md#step-2-configure-bot-token-scopes)
- [Step 3: Enable Socket Mode](index.md#step-3-enable-socket-mode)
- [Step 4: Subscribe to Events](index.md#step-4-subscribe-to-events)
- [Step 5: Enable the Messages Tab](index.md#step-5-enable-the-messages-tab)
- [Step 6: Install App to Workspace](index.md#step-6-install-app-to-workspace)
- [Step 7: Find User IDs for the Allowlist](index.md#step-7-find-user-ids-for-the-allowlist)
- [Step 8: Configure Hermes](index.md#step-8-configure-hermes)
- [Step 9: Invite the Bot to Channels](index.md#step-9-invite-the-bot-to-channels)
- [Slash Commands](index.md#slash-commands)
  - [Refreshing slash commands after updates](index.md#refreshing-slash-commands-after-updates)
  - [Legacy `/hermes <subcommand>` still works](index.md#legacy-hermes-subcommand-still-works)
  - [Advanced: emit only the slash-commands array](index.md#advanced-emit-only-the-slash-commands-array)
- [How the Bot Responds](index.md#how-the-bot-responds)
- [Configuration Options](index.md#configuration-options)
  - [Thread & Reply Behavior](index.md#thread--reply-behavior)
  - [Session Isolation](index.md#session-isolation)
  - [Mention & Trigger Behavior](index.md#mention--trigger-behavior)
  - [Unauthorized User Handling](index.md#unauthorized-user-handling)
  - [Voice Transcription](index.md#voice-transcription)
  - [Full Example](index.md#full-example)
- [Home Channel](index.md#home-channel)
- [Multi-Workspace Support](index.md#multi-workspace-support)
  - [Configuration](index.md#configuration)
  - [OAuth Token File](index.md#oauth-token-file)
  - [How it works](index.md#how-it-works)
- [Voice Messages](index.md#voice-messages)
- [Per-Channel Prompts](index.md#per-channel-prompts)
- [Per-Channel Skill Bindings](index.md#per-channel-skill-bindings)
- [Troubleshooting](index.md#troubleshooting)
  - [Quick Checklist](index.md#quick-checklist)
