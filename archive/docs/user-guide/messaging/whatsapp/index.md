...
## Two Modes[​](index.md#two-modes "Direct link to Two Modes")
...
## Step 1: Run the Setup Wizard[​](index.md#step-1-run-the-setup-wizard "Direct link to Step 1: Run the Setup Wizard")
...
## Step 2: Getting a Second Phone Number (Bot Mode)[​](index.md#step-2-getting-a-second-phone-number-bot-mode "Direct link to Step 2: Getting a Second Phone Number (Bot Mode)")
...
This is consistent with [Signal group allowlists](../../../reference/environment-variables/index.md).
To use the pairing flow instead, remove both variables and rely on the
[DM pairing system](../../security/index.md#dm-pairing-system).
...
## Re-pairing[​](index.md#re-pairing "Direct link to Re-pairing")
...
## Message Formatting & Delivery[​](index.md#message-formatting--delivery "Direct link to Message Formatting & Delivery")

WhatsApp supports **streaming (progressive) responses** — the bot edits its message in real-time as the AI generates text, just like Discord and Telegram. Internally, WhatsApp is classified as a TIER\_MEDIUM platform for delivery capabilities.

### Chunking[​](index.md#chunking "Direct link to Chunking")
...
### WhatsApp-Compatible Markdown[​](index.md#whatsapp-compatible-markdown "Direct link to WhatsApp-Compatible Markdown")
...
### Tool Progress[​](index.md#tool-progress "Direct link to Tool Progress")
...
- [Step 1: Run the Setup Wizard](index.md#step-1-run-the-setup-wizard)
- [Step 2: Getting a Second Phone Number (Bot Mode)](index.md#step-2-getting-a-second-phone-number-bot-mode)
- [Step 3: Configure Hermes](index.md#step-3-configure-hermes)
- [Session Persistence](index.md#session-persistence)
- [Re-pairing](index.md#re-pairing)
- [Voice Messages](index.md#voice-messages)
- [Message Formatting & Delivery](index.md#message-formatting--delivery)
  - [Chunking](index.md#chunking)
  - [WhatsApp-Compatible Markdown](index.md#whatsapp-compatible-markdown)
  - [Tool Progress](index.md#tool-progress)
