...
## How Hermes Behaves[​](index.md#how-hermes-behaves "Direct link to How Hermes Behaves")
...
### Discord Gateway Model[​](index.md#discord-gateway-model "Direct link to Discord Gateway Model")
...
### Session Model in Discord[​](index.md#session-model-in-discord "Direct link to Session Model in Discord")
...
### Interrupts and Concurrency[​](index.md#interrupts-and-concurrency "Direct link to Interrupts and Concurrency")
...
## Step 1: Create a Discord Application[​](index.md#step-1-create-a-discord-application "Direct link to Step 1: Create a Discord Application")
...
## Step 2: Create the Bot[​](index.md#step-2-create-the-bot "Direct link to Step 2: Create the Bot")
...
## Step 3: Enable Privileged Gateway Intents[​](index.md#step-3-enable-privileged-gateway-intents "Direct link to Step 3: Enable Privileged Gateway Intents")
...
## Step 4: Get the Bot Token[​](index.md#step-4-get-the-bot-token "Direct link to Step 4: Get the Bot Token")
...
## Step 5: Generate the Invite URL[​](index.md#step-5-generate-the-invite-url "Direct link to Step 5: Generate the Invite URL")

You need an OAuth2 URL to invite the bot to your server. There are two ways to do this:

### Option A: Using the Installation Tab (Recommended)[​](index.md#option-a-using-the-installation-tab-recommended "Direct link to Option A: Using the Installation Tab (Recommended)")
...
### Option B: Manual URL[​](index.md#option-b-manual-url "Direct link to Option B: Manual URL")
...
### Required Permissions[​](index.md#required-permissions "Direct link to Required Permissions")
...
### Recommended Additional Permissions[​](index.md#recommended-additional-permissions "Direct link to Recommended Additional Permissions")

- **Send Messages in Threads** — respond in thread conversations
- **Add Reactions** — react to messages for acknowledgment

### Permission Integers[​](index.md#permission-integers "Direct link to Permission Integers")
...
## Step 6: Invite to Your Server[​](index.md#step-6-invite-to-your-server "Direct link to Step 6: Invite to Your Server")
...
## Step 7: Find Your Discord User ID[​](index.md#step-7-find-your-discord-user-id "Direct link to Step 7: Find Your Discord User ID")
...
## Step 8: Configure Hermes Agent[​](index.md#step-8-configure-hermes-agent "Direct link to Step 8: Configure Hermes Agent")
...
## Configuration Reference[​](index.md#configuration-reference "Direct link to Configuration Reference")
...
### Environment Variables (`.env`)[​](index.md#environment-variables-env "Direct link to environment-variables-env")
...
| `DISCORD_ALLOW_MENTION_EVERYONE` | No | `false` | When `false` (default), the bot cannot ping `@everyone` or `@here` even if its response contains those tokens. Set to `true` to opt back in. See [Mention Control](index.md#mention-control) below. |
...
### Config File (`config.yaml`)[​](index.md#config-file-configyaml "Direct link to config-file-configyaml")
...
#### `discord.require_mention`[​](index.md#discordrequire_mention "Direct link to discordrequire_mention")
...
#### `discord.free_response_channels`[​](index.md#discordfree_response_channels "Direct link to discordfree_response_channels")
...
#### `discord.auto_thread`[​](index.md#discordauto_thread "Direct link to discordauto_thread")
...
#### `discord.reactions`[​](index.md#discordreactions "Direct link to discordreactions")
...
#### `discord.ignored_channels`[​](index.md#discordignored_channels "Direct link to discordignored_channels")
...
#### `discord.no_thread_channels`[​](index.md#discordno_thread_channels "Direct link to discordno_thread_channels")
...
#### `discord.channel_prompts`[​](index.md#discordchannel_prompts "Direct link to discordchannel_prompts")
...
#### `group_sessions_per_user`[​](index.md#group_sessions_per_user "Direct link to group_sessions_per_user")
...
See the [Session Model](index.md#session-model-in-discord) section above for the full implications of each mode.

#### `display.tool_progress`[​](index.md#displaytool_progress "Direct link to displaytool_progress")
...
#### `display.tool_progress_command`[​](index.md#displaytool_progress_command "Direct link to displaytool_progress_command")
...
## Native Slash Commands for Skills[​](index.md#native-slash-commands-for-skills "Direct link to Native Slash Commands for Skills")
...
### Disabling Slash Command Registration[​](index.md#disabling-slash-command-registration "Direct link to Disabling Slash Command Registration")
...
## Sending Media (`send_message` + `MEDIA:` tags)[​](index.md#sending-media-send_message--media-tags "Direct link to sending-media-send_message--media-tags")
...
### Using the Slash Command[​](index.md#using-the-slash-command "Direct link to Using the Slash Command")

Type `/sethome` in any Discord channel where the bot is present. That channel becomes the home channel.

### Manual Configuration[​](index.md#manual-configuration "Direct link to Manual Configuration")
...
- [Voice Mode](../../features/voice-mode/index.md)
- [Use Voice Mode with Hermes](../../../guides/use-voice-mode-with-hermes/index.md)

## Forum Channels[​](index.md#forum-channels "Direct link to Forum Channels")
...
### Bot is online but not responding to messages[​](index.md#bot-is-online-but-not-responding-to-messages "Direct link to Bot is online but not responding to messages")
...
### "Disallowed Intents" error on startup[​](index.md#disallowed-intents-error-on-startup "Direct link to \"Disallowed Intents\" error on startup")
...
### Bot can't see messages in a specific channel[​](index.md#bot-cant-see-messages-in-a-specific-channel "Direct link to Bot can't see messages in a specific channel")
...
### 403 Forbidden errors[​](index.md#403-forbidden-errors "Direct link to 403 Forbidden errors")
...
### Bot is offline[​](index.md#bot-is-offline "Direct link to Bot is offline")
...
### "User not allowed" / Bot ignores you[​](index.md#user-not-allowed--bot-ignores-you "Direct link to \"User not allowed\" / Bot ignores you")
...
### People in the same channel are sharing context unexpectedly[​](index.md#people-in-the-same-channel-are-sharing-context-unexpectedly "Direct link to People in the same channel are sharing context unexpectedly")
...
### Role-Based Access Control[​](index.md#role-based-access-control "Direct link to Role-Based Access Control")
...
### Mention Control[​](index.md#mention-control "Direct link to Mention Control")
...
For more information on securing your Hermes Agent deployment, see the [Security Guide](../../security/index.md).

- [How Hermes Behaves](index.md#how-hermes-behaves)
  - [Discord Gateway Model](index.md#discord-gateway-model)
  - [Session Model in Discord](index.md#session-model-in-discord)
  - [Interrupts and Concurrency](index.md#interrupts-and-concurrency)
- [Step 1: Create a Discord Application](index.md#step-1-create-a-discord-application)
- [Step 2: Create the Bot](index.md#step-2-create-the-bot)
- [Step 3: Enable Privileged Gateway Intents](index.md#step-3-enable-privileged-gateway-intents)
- [Step 4: Get the Bot Token](index.md#step-4-get-the-bot-token)
- [Step 5: Generate the Invite URL](index.md#step-5-generate-the-invite-url)
  - [Option A: Using the Installation Tab (Recommended)](index.md#option-a-using-the-installation-tab-recommended)
  - [Option B: Manual URL](index.md#option-b-manual-url)
  - [Required Permissions](index.md#required-permissions)
  - [Recommended Additional Permissions](index.md#recommended-additional-permissions)
  - [Permission Integers](index.md#permission-integers)
- [Step 6: Invite to Your Server](index.md#step-6-invite-to-your-server)
- [Step 7: Find Your Discord User ID](index.md#step-7-find-your-discord-user-id)
- [Step 8: Configure Hermes Agent](index.md#step-8-configure-hermes-agent)
...
- [Configuration Reference](index.md#configuration-reference)
  - [Environment Variables (`.env`)](index.md#environment-variables-env)
  - [Config File (`config.yaml`)](index.md#config-file-configyaml)
...
- [Native Slash Commands for Skills](index.md#native-slash-commands-for-skills)
  - [Disabling Slash Command Registration](index.md#disabling-slash-command-registration)
- [Sending Media (`send_message` + `MEDIA:` tags)](index.md#sending-media-send_message--media-tags)
- [Home Channel](index.md#home-channel)
  - [Using the Slash Command](index.md#using-the-slash-command)
  - [Manual Configuration](index.md#manual-configuration)
- [Voice Messages](index.md#voice-messages)
- [Forum Channels](index.md#forum-channels)
- [Troubleshooting](index.md#troubleshooting)
  - [Bot is online but not responding to messages](index.md#bot-is-online-but-not-responding-to-messages)
  - ["Disallowed Intents" error on startup](index.md#disallowed-intents-error-on-startup)
  - [Bot can't see messages in a specific channel](index.md#bot-cant-see-messages-in-a-specific-channel)
  - [403 Forbidden errors](index.md#403-forbidden-errors)
  - [Bot is offline](index.md#bot-is-offline)
  - ["User not allowed" / Bot ignores you](index.md#user-not-allowed--bot-ignores-you)
  - [People in the same channel are sharing context unexpectedly](index.md#people-in-the-same-channel-are-sharing-context-unexpectedly)
- [Security](index.md#security)
  - [Role-Based Access Control](index.md#role-based-access-control)
  - [Mention Control](index.md#mention-control)
