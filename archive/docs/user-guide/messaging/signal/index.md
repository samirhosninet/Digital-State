...
### Installing signal-cli[​](index.md#installing-signal-cli "Direct link to Installing signal-cli")
...
## Step 1: Link Your Signal Account[​](index.md#step-1-link-your-signal-account "Direct link to Step 1: Link Your Signal Account")
...
## Step 2: Start the signal-cli Daemon[​](index.md#step-2-start-the-signal-cli-daemon "Direct link to Step 2: Start the signal-cli Daemon")
...
## Step 3: Configure Hermes[​](index.md#step-3-configure-hermes "Direct link to Step 3: Configure Hermes")
...
### DM Access[​](index.md#dm-access "Direct link to DM Access")
...
### Group Access[​](index.md#group-access "Direct link to Group Access")
...
## Features[​](index.md#features "Direct link to Features")

### Attachments[​](index.md#attachments "Direct link to Attachments")
...
### Native Formatting, Reply Quotes, and Reactions[​](index.md#native-formatting-reply-quotes-and-reactions "Direct link to Native Formatting, Reply Quotes, and Reactions")
...
### Typing Indicators[​](index.md#typing-indicators "Direct link to Typing Indicators")

The bot sends typing indicators while processing messages, refreshing every 8 seconds.

### Phone Number Redaction[​](index.md#phone-number-redaction "Direct link to Phone Number Redaction")
...
### Note to Self (Single-Number Setup)[​](index.md#note-to-self-single-number-setup "Direct link to Note to Self (Single-Number Setup)")
...
### Health Monitoring[​](index.md#health-monitoring "Direct link to Health Monitoring")
...
## Environment Variables Reference[​](index.md#environment-variables-reference "Direct link to Environment Variables Reference")
...
- [Prerequisites](index.md#prerequisites)
  - [Installing signal-cli](index.md#installing-signal-cli)
- [Step 1: Link Your Signal Account](index.md#step-1-link-your-signal-account)
- [Step 2: Start the signal-cli Daemon](index.md#step-2-start-the-signal-cli-daemon)
- [Step 3: Configure Hermes](index.md#step-3-configure-hermes)
  - [Manual Configuration](index.md#manual-configuration)
- [Access Control](index.md#access-control)
  - [DM Access](index.md#dm-access)
  - [Group Access](index.md#group-access)
- [Features](index.md#features)
  - [Attachments](index.md#attachments)
  - [Native Formatting, Reply Quotes, and Reactions](index.md#native-formatting-reply-quotes-and-reactions)
  - [Typing Indicators](index.md#typing-indicators)
  - [Phone Number Redaction](index.md#phone-number-redaction)
  - [Note to Self (Single-Number Setup)](index.md#note-to-self-single-number-setup)
  - [Health Monitoring](index.md#health-monitoring)
- [Troubleshooting](index.md#troubleshooting)
- [Security](index.md#security)
- [Environment Variables Reference](index.md#environment-variables-reference)
