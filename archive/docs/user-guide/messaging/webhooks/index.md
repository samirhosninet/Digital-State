...
## Setup[​](index.md#setup "Direct link to Setup")

There are two ways to enable the webhook adapter.

### Via setup wizard[​](index.md#via-setup-wizard "Direct link to Via setup wizard")
...
### Via environment variables[​](index.md#via-environment-variables "Direct link to Via environment variables")
...
### Verify the server[​](index.md#verify-the-server "Direct link to Verify the server")
...
## Configuring Routes[​](index.md#configuring-routes "Direct link to Configuring Routes")
...
### Route properties[​](index.md#route-properties "Direct link to Route properties")
...
| `deliver_only` | No | If `true`, skip the agent entirely — the rendered `prompt` template becomes the literal message that gets delivered. Zero LLM cost, sub-second delivery. See [Direct Delivery Mode](index.md#direct-delivery-mode) for use cases. Requires `deliver` to be a real target (not `log`). |
...
### Prompt Templates[​](index.md#prompt-templates "Direct link to Prompt Templates")
...
### Forum Topic Delivery[​](index.md#forum-topic-delivery "Direct link to Forum Topic Delivery")
...
## GitHub PR Review (Step by Step)[​](index.md#github-pr-review "Direct link to GitHub PR Review (Step by Step)")

This walkthrough sets up automatic code review on every pull request.

### 1. Create the webhook in GitHub[​](index.md#1-create-the-webhook-in-github "Direct link to 1. Create the webhook in GitHub")
...
### 2. Add the route config[​](index.md#2-add-the-route-config "Direct link to 2. Add the route config")

Add the `github-pr` route to your `~/.hermes/config.yaml` as shown in the example above.

### 3. Ensure `gh` CLI is authenticated[​](index.md#3-ensure-gh-cli-is-authenticated "Direct link to 3-ensure-gh-cli-is-authenticated")
...
### 4. Test it[​](index.md#4-test-it "Direct link to 4. Test it")

Open a pull request on the repository. The webhook fires, Hermes processes the event, and posts a review comment on the PR.

---

## GitLab Webhook Setup[​](index.md#gitlab-webhook-setup "Direct link to GitLab Webhook Setup")
...
### 1. Create the webhook in GitLab[​](index.md#1-create-the-webhook-in-gitlab "Direct link to 1. Create the webhook in GitLab")
...
### 2. Add the route config[​](index.md#2-add-the-route-config-1 "Direct link to 2. Add the route config")
...
## Delivery Options[​](index.md#delivery-options "Direct link to Delivery Options")
...
## Direct Delivery Mode[​](index.md#direct-delivery-mode "Direct link to Direct Delivery Mode")
...
### When to use direct delivery[​](index.md#when-to-use-direct-delivery "Direct link to When to use direct delivery")
...
### Example: Telegram push from Supabase[​](index.md#example-telegram-push-from-supabase "Direct link to Example: Telegram push from Supabase")
...
### Example: Dynamic subscription via CLI[​](index.md#example-dynamic-subscription-via-cli "Direct link to Example: Dynamic subscription via CLI")
...
### Response codes[​](index.md#response-codes "Direct link to Response codes")
...
### Configuration gotchas[​](index.md#configuration-gotchas "Direct link to Configuration gotchas")
...
## Dynamic Subscriptions (CLI)[​](index.md#dynamic-subscriptions "Direct link to Dynamic Subscriptions (CLI)")
...
### Create a subscription[​](index.md#create-a-subscription "Direct link to Create a subscription")
...
### List subscriptions[​](index.md#list-subscriptions "Direct link to List subscriptions")

```
hermes webhook list
```

### Remove a subscription[​](index.md#remove-a-subscription "Direct link to Remove a subscription")

```
hermes webhook remove github-issues
```

### Test a subscription[​](index.md#test-a-subscription "Direct link to Test a subscription")
...
### How dynamic subscriptions work[​](index.md#how-dynamic-subscriptions-work "Direct link to How dynamic subscriptions work")
...
### Agent-driven subscriptions[​](index.md#agent-driven-subscriptions "Direct link to Agent-driven subscriptions")
...
### HMAC signature validation[​](index.md#hmac-signature-validation "Direct link to HMAC signature validation")
...
### Secret is required[​](index.md#secret-is-required "Direct link to Secret is required")
...
### Rate limiting[​](index.md#rate-limiting "Direct link to Rate limiting")
...
### Idempotency[​](index.md#idempotency "Direct link to Idempotency")
...
### Body size limits[​](index.md#body-size-limits "Direct link to Body size limits")
...
### Prompt injection risk[​](index.md#prompt-injection-risk "Direct link to Prompt injection risk")
...
### Webhook not arriving[​](index.md#webhook-not-arriving "Direct link to Webhook not arriving")
...
### Signature validation failing[​](index.md#signature-validation-failing "Direct link to Signature validation failing")
...
### Event being ignored[​](index.md#event-being-ignored "Direct link to Event being ignored")
...
### Agent not responding[​](index.md#agent-not-responding "Direct link to Agent not responding")
...
### Duplicate responses[​](index.md#duplicate-responses "Direct link to Duplicate responses")
...
### `gh` CLI errors (GitHub comment delivery)[​](index.md#gh-cli-errors-github-comment-delivery "Direct link to gh-cli-errors-github-comment-delivery")
...
- [Setup](index.md#setup)
  - [Via setup wizard](index.md#via-setup-wizard)
  - [Via environment variables](index.md#via-environment-variables)
  - [Verify the server](index.md#verify-the-server)
- [Configuring Routes](index.md#configuring-routes)
  - [Route properties](index.md#route-properties)
  - [Full example](index.md#full-example)
  - [Prompt Templates](index.md#prompt-templates)
  - [Forum Topic Delivery](index.md#forum-topic-delivery)
- [GitHub PR Review (Step by Step)](index.md#github-pr-review)
  - [1. Create the webhook in GitHub](index.md#1-create-the-webhook-in-github)
  - [2. Add the route config](index.md#2-add-the-route-config)
  - [3. Ensure `gh` CLI is authenticated](index.md#3-ensure-gh-cli-is-authenticated)
  - [4. Test it](index.md#4-test-it)
- [GitLab Webhook Setup](index.md#gitlab-webhook-setup)
  - [1. Create the webhook in GitLab](index.md#1-create-the-webhook-in-gitlab)
  - [2. Add the route config](index.md#2-add-the-route-config-1)
- [Delivery Options](index.md#delivery-options)
- [Direct Delivery Mode](index.md#direct-delivery-mode)
  - [When to use direct delivery](index.md#when-to-use-direct-delivery)
  - [Example: Telegram push from Supabase](index.md#example-telegram-push-from-supabase)
  - [Example: Dynamic subscription via CLI](index.md#example-dynamic-subscription-via-cli)
  - [Response codes](index.md#response-codes)
  - [Configuration gotchas](index.md#configuration-gotchas)
- [Dynamic Subscriptions (CLI)](index.md#dynamic-subscriptions)
  - [Create a subscription](index.md#create-a-subscription)
  - [List subscriptions](index.md#list-subscriptions)
  - [Remove a subscription](index.md#remove-a-subscription)
  - [Test a subscription](index.md#test-a-subscription)
  - [How dynamic subscriptions work](index.md#how-dynamic-subscriptions-work)
  - [Agent-driven subscriptions](index.md#agent-driven-subscriptions)
- [Security](index.md#security)
  - [HMAC signature validation](index.md#hmac-signature-validation)
  - [Secret is required](index.md#secret-is-required)
  - [Rate limiting](index.md#rate-limiting)
  - [Idempotency](index.md#idempotency)
  - [Body size limits](index.md#body-size-limits)
  - [Prompt injection risk](index.md#prompt-injection-risk)
- [Troubleshooting](index.md#troubleshooting)
  - [Webhook not arriving](index.md#webhook-not-arriving)
  - [Signature validation failing](index.md#signature-validation-failing)
  - [Event being ignored](index.md#event-being-ignored)
  - [Agent not responding](index.md#agent-not-responding)
  - [Duplicate responses](index.md#duplicate-responses)
  - [`gh` CLI errors (GitHub comment delivery)](index.md#gh-cli-errors-github-comment-delivery)
