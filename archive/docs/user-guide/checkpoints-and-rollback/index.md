...
title: Checkpoints and /rollback | Hermes Agent
...
## What Triggers a Checkpoint[​](index.md#what-triggers-a-checkpoint "Direct link to What Triggers a Checkpoint")
...
## How Checkpoints Work[​](index.md#how-checkpoints-work "Direct link to How Checkpoints Work")
...
## Listing Checkpoints[​](index.md#listing-checkpoints "Direct link to Listing Checkpoints")
...
## Inspecting the Store from the Shell[​](index.md#inspecting-the-store-from-the-shell "Direct link to Inspecting the Store from the Shell")
...
## Previewing Changes with `/rollback diff`[​](index.md#previewing-changes-with-rollback-diff "Direct link to previewing-changes-with-rollback-diff")
...
## Restoring with `/rollback`[​](index.md#restoring-with-rollback "Direct link to restoring-with-rollback")
...
## Single-File Restore[​](index.md#single-file-restore "Direct link to Single-File Restore")
...
## Safety and Performance Guards[​](index.md#safety-and-performance-guards "Direct link to Safety and Performance Guards")
...
## Where Checkpoints Live[​](index.md#where-checkpoints-live "Direct link to Where Checkpoints Live")
...
### Migration from v1[​](index.md#migration-from-v1 "Direct link to Migration from v1")
...
## Best Practices[​](index.md#best-practices "Direct link to Best Practices")
...
For running multiple agents in parallel on the same repo, see the guide on [Git worktrees](../git-worktrees/index.md).

- [What Triggers a Checkpoint](index.md#what-triggers-a-checkpoint)
- [Quick Reference](index.md#quick-reference)
- [How Checkpoints Work](index.md#how-checkpoints-work)
- [Configuration](index.md#configuration)
- [Listing Checkpoints](index.md#listing-checkpoints)
- [Inspecting the Store from the Shell](index.md#inspecting-the-store-from-the-shell)
- [Previewing Changes with `/rollback diff`](index.md#previewing-changes-with-rollback-diff)
- [Restoring with `/rollback`](index.md#restoring-with-rollback)
- [Single-File Restore](index.md#single-file-restore)
- [Safety and Performance Guards](index.md#safety-and-performance-guards)
- [Where Checkpoints Live](index.md#where-checkpoints-live)
  - [Migration from v1](index.md#migration-from-v1)
