...
title: Git Worktrees | Hermes Agent
...
## Why Use Worktrees with Hermes?[​](index.md#why-use-worktrees-with-hermes "Direct link to Why Use Worktrees with Hermes?")
...
See also: [Checkpoints and /rollback](../checkpoints-and-rollback/index.md).

## Quick Start: Creating a Worktree[​](index.md#quick-start-creating-a-worktree "Direct link to Quick Start: Creating a Worktree")
...
## Running Multiple Agents in Parallel[​](index.md#running-multiple-agents-in-parallel "Direct link to Running Multiple Agents in Parallel")
...
## Cleaning Up Worktrees Safely[​](index.md#cleaning-up-worktrees-safely "Direct link to Cleaning Up Worktrees Safely")
...
- **Commit frequently**
  ...
  - Use [checkpoints and /rollback](../checkpoints-and-rollback/index.md) as a safety net for tool‑driven edits in between.
...
## Using `hermes -w` (Automatic Worktree Mode)[​](index.md#using-hermes--w-automatic-worktree-mode "Direct link to using-hermes--w-automatic-worktree-mode")
...
## Putting It All Together[​](index.md#putting-it-all-together "Direct link to Putting It All Together")
...
- [Why Use Worktrees with Hermes?](index.md#why-use-worktrees-with-hermes)
- [Quick Start: Creating a Worktree](index.md#quick-start-creating-a-worktree)
- [Running Multiple Agents in Parallel](index.md#running-multiple-agents-in-parallel)
- [Cleaning Up Worktrees Safely](index.md#cleaning-up-worktrees-safely)
- [Best Practices](index.md#best-practices)
- [Using `hermes -w` (Automatic Worktree Mode)](index.md#using-hermes--w-automatic-worktree-mode)
- [Putting It All Together](index.md#putting-it-all-together)
