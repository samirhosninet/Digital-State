...
The TUI is the modern front-end for Hermes — a terminal UI backed by the same Python runtime as the [Classic CLI](../cli/index.md). Same agent, same sessions, same slash commands; a cleaner, more responsive surface for interacting with them.

It's the recommended way to run Hermes interactively.

## Launch[​](index.md#launch "Direct link to Launch")
...
The classic CLI remains available as the default. Anything documented in [CLI Interface](../cli/index.md) — slash commands, quick commands, skill preloading, personalities, multi-line input, interrupts — works in the TUI identically.

## Why the TUI[​](index.md#why-the-tui "Direct link to Why the TUI")
...
Same [skins](../features/skins/index.md) and [personalities](../features/personality/index.md) apply. Switch mid-session with `/skin ares`, `/personality pirate`, and the UI repaints live. See [Skins & Themes](../features/skins/index.md) for the full list of customizable keys and which ones apply to classic vs TUI — the TUI honors the banner palette, UI colors, prompt glyph/color, session display, completion menu, selection bg, `tool_prefix`, and `help_header`.
...
### External prebuild[​](index.md#external-prebuild "Direct link to External prebuild")
...
## Keybindings[​](index.md#keybindings "Direct link to Keybindings")

Keybindings match the [Classic CLI](../cli/index.md#keybindings) exactly. The only behavioral differences:
...
Every other slash command (including installed skills, quick commands, and personality toggles) works identically to the classic CLI. See [Slash Commands Reference](../../reference/slash-commands/index.md).

## LaTeX math rendering[​](index.md#latex-math-rendering "Direct link to LaTeX math rendering")
...
## Light-terminal detection[​](index.md#light-terminal-detection "Direct link to Light-terminal detection")
...
## Busy indicator styles[​](index.md#busy-indicator-styles "Direct link to Busy indicator styles")
...
## Auto-resume[​](index.md#auto-resume "Direct link to Auto-resume")
...
## Status line[​](index.md#status-line "Direct link to Status line")
...
The per-skin status-bar colors and thresholds are shared with the classic CLI — see [Skins](../features/skins/index.md) for customization.
...
## Sessions[​](index.md#sessions "Direct link to Sessions")
...
See [Sessions](../sessions/index.md) for lifecycle, search, compression, and export.

## Reverting to the classic CLI[​](index.md#reverting-to-the-classic-cli "Direct link to Reverting to the classic CLI")
...
- [CLI Interface](../cli/index.md) — full slash command and keybinding reference (shared)
- [Sessions](../sessions/index.md) — resume, branch, and history
- [Skins & Themes](../features/skins/index.md) — theme the banner, status bar, and overlays
- [Voice Mode](../features/voice-mode/index.md) — works in both interfaces
- [Configuration](../configuration/index.md) — all config keys

- [Launch](index.md#launch)
- [Why the TUI](index.md#why-the-tui)
- [Requirements](index.md#requirements)
  - [External prebuild](index.md#external-prebuild)
- [Keybindings](index.md#keybindings)
- [Slash commands](index.md#slash-commands)
- [LaTeX math rendering](index.md#latex-math-rendering)
- [Light-terminal detection](index.md#light-terminal-detection)
- [Busy indicator styles](index.md#busy-indicator-styles)
- [Auto-resume](index.md#auto-resume)
- [Status line](index.md#status-line)
- [Configuration](index.md#configuration)
- [Sessions](index.md#sessions)
- [Reverting to the classic CLI](index.md#reverting-to-the-classic-cli)
