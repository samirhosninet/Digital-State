...
title: Configuring Models | Hermes Agent
...
This page covers configuring both from the dashboard. If you prefer config files or the CLI, jump to [Alternative methods](index.md#alternative-methods) at the bottom.

## The Models page[​](index.md#the-models-page "Direct link to The Models page")
...
![Models page overview](../../../assets/docs/assets/images/overview-7ea6bbb1b2b6a12e2ff92ae07084c434.png)
...
## Setting the main model[​](index.md#setting-the-main-model "Direct link to Setting the main model")

Click **Change** on the Main model row:

![Model picker dialog](../../../assets/docs/assets/images/picker-dialog-6fa8d5ea35b1ebcbad9b1e862822bf91.png)
...
## Setting auxiliary models[​](index.md#setting-auxiliary-models "Direct link to Setting auxiliary models")

Click **Show auxiliary** to reveal the eight task slots:

![Auxiliary panel expanded](../../../assets/docs/assets/images/auxiliary-expanded-bc717f35df24e9d19ca45d5086688b56.png)
...
### Common override patterns[​](index.md#common-override-patterns "Direct link to Common override patterns")
...
| **Session Search** | When recall queries fan out — default max\_concurrency is 3. A cheap model keeps the bill predictable. |
...
### Per-task override[​](index.md#per-task-override "Direct link to Per-task override")
...
### Reset all to auto[​](index.md#reset-all-to-auto "Direct link to Reset all to auto")
...
## The "Use as" shortcut[​](index.md#the-use-as-shortcut "Direct link to The \"Use as\" shortcut")
...
![Use as dropdown](../../../assets/docs/assets/images/use-as-dropdown-6795915e52daf2b74eb099fe11fde7ac.png)
...
## What gets written to `config.yaml`[​](index.md#what-gets-written-to-configyaml "Direct link to what-gets-written-to-configyaml")
...
## When does it take effect?[​](index.md#when-does-it-take-effect "Direct link to When does it take effect?")
...
### "No authenticated providers" in the picker[​](index.md#no-authenticated-providers-in-the-picker "Direct link to \"No authenticated providers\" in the picker")
...
### Main model didn't change in my running chat[​](index.md#main-model-didnt-change-in-my-running-chat "Direct link to Main model didn't change in my running chat")
...
### Auxiliary override "didn't take effect"[​](index.md#auxiliary-override-didnt-take-effect "Direct link to Auxiliary override \"didn't take effect\"")
...
### I picked a model but Hermes switched providers on me[​](index.md#i-picked-a-model-but-hermes-switched-providers-on-me "Direct link to I picked a model but Hermes switched providers on me")
...
## Alternative methods[​](index.md#alternative-methods "Direct link to Alternative methods")

### CLI slash command[​](index.md#cli-slash-command "Direct link to CLI slash command")
...
### Custom aliases[​](index.md#custom-aliases "Direct link to Custom aliases")
...
Then `/model fav` or `/model grok` in chat. User aliases shadow built-in short names (`sonnet`, `kimi`, `opus`, etc.). See [Custom model aliases](../../reference/slash-commands/index.md#custom-model-aliases) for the full reference.

### `hermes model` subcommand[​](index.md#hermes-model-subcommand "Direct link to hermes-model-subcommand")
...
### Direct config edit[​](index.md#direct-config-edit "Direct link to Direct config edit")

Edit `~/.hermes/config.yaml` and restart whatever reads it. See the [Configuration reference](../configuration/index.md) for the full schema.

### REST API[​](index.md#rest-api "Direct link to REST API")
...
- [The Models page](index.md#the-models-page)
- [Setting the main model](index.md#setting-the-main-model)
- [Setting auxiliary models](index.md#setting-auxiliary-models)
  - [Common override patterns](index.md#common-override-patterns)
  - [Per-task override](index.md#per-task-override)
  - [Reset all to auto](index.md#reset-all-to-auto)
- [The "Use as" shortcut](index.md#the-use-as-shortcut)
- [What gets written to `config.yaml`](index.md#what-gets-written-to-configyaml)
- [When does it take effect?](index.md#when-does-it-take-effect)
- [Troubleshooting](index.md#troubleshooting)
  - ["No authenticated providers" in the picker](index.md#no-authenticated-providers-in-the-picker)
  - [Main model didn't change in my running chat](index.md#main-model-didnt-change-in-my-running-chat)
  - [Auxiliary override "didn't take effect"](index.md#auxiliary-override-didnt-take-effect)
  - [I picked a model but Hermes switched providers on me](index.md#i-picked-a-model-but-hermes-switched-providers-on-me)
- [Alternative methods](index.md#alternative-methods)
  - [CLI slash command](index.md#cli-slash-command)
  - [Custom aliases](index.md#custom-aliases)
  - [`hermes model` subcommand](index.md#hermes-model-subcommand)
  - [Direct config edit](index.md#direct-config-edit)
  - [REST API](index.md#rest-api)
