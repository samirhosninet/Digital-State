...
1. **[Credential pools](../credential-pools/index.md)** — rotate across multiple API keys for the *same* provider (tried first)
...
## Primary Model Fallback[​](index.md#primary-model-fallback "Direct link to Primary Model Fallback")
...
### Supported Providers[​](index.md#supported-providers "Direct link to Supported Providers")
...
### Custom Endpoint Fallback[​](index.md#custom-endpoint-fallback "Direct link to Custom Endpoint Fallback")
...
### When Fallback Triggers[​](index.md#when-fallback-triggers "Direct link to When Fallback Triggers")
...
### Where Fallback Works[​](index.md#where-fallback-works "Direct link to Where Fallback Works")
...
## Auxiliary Task Fallback[​](index.md#auxiliary-task-fallback "Direct link to Auxiliary Task Fallback")
...
### Tasks with Independent Provider Resolution[​](index.md#tasks-with-independent-provider-resolution "Direct link to Tasks with Independent Provider Resolution")
...
### Auto-Detection Chain[​](index.md#auto-detection-chain "Direct link to Auto-Detection Chain")
...
### Configuring Auxiliary Providers[​](index.md#configuring-auxiliary-providers "Direct link to Configuring Auxiliary Providers")
...
### Provider Options for Auxiliary Tasks[​](index.md#provider-options-for-auxiliary-tasks "Direct link to Provider Options for Auxiliary Tasks")

These options apply to `auxiliary:`, `compression:`, and `fallback_model:` configs only — `"main"` is **not** a valid value for your top-level `model.provider`. For custom endpoints, use `provider: custom` in your `model:` section (see [AI Providers](../../../integrations/providers/index.md)).
...
### Direct Endpoint Override[​](index.md#direct-endpoint-override "Direct link to Direct Endpoint Override")
...
## Context Compression Fallback[​](index.md#context-compression-fallback "Direct link to Context Compression Fallback")
...
## Delegation Provider Override[​](index.md#delegation-provider-override "Direct link to Delegation Provider Override")
...
See [Subagent Delegation](../delegation/index.md) for full configuration details.

---

## Cron Job Providers[​](index.md#cron-job-providers "Direct link to Cron Job Providers")
...
See [Scheduled Tasks (Cron)](../cron/index.md) for full configuration details.

---

## Summary[​](index.md#summary "Direct link to Summary")
...
- [Primary Model Fallback](index.md#primary-model-fallback)
  - [Configuration](index.md#configuration)
  - [Supported Providers](index.md#supported-providers)
  - [Custom Endpoint Fallback](index.md#custom-endpoint-fallback)
  - [When Fallback Triggers](index.md#when-fallback-triggers)
  - [Examples](index.md#examples)
  - [Where Fallback Works](index.md#where-fallback-works)
- [Auxiliary Task Fallback](index.md#auxiliary-task-fallback)
  - [Tasks with Independent Provider Resolution](index.md#tasks-with-independent-provider-resolution)
  - [Auto-Detection Chain](index.md#auto-detection-chain)
  - [Configuring Auxiliary Providers](index.md#configuring-auxiliary-providers)
  - [Provider Options for Auxiliary Tasks](index.md#provider-options-for-auxiliary-tasks)
  - [Direct Endpoint Override](index.md#direct-endpoint-override)
- [Context Compression Fallback](index.md#context-compression-fallback)
- [Delegation Provider Override](index.md#delegation-provider-override)
- [Cron Job Providers](index.md#cron-job-providers)
