...
## How it runs[​](index.md#how-it-runs "Direct link to How it runs")
...
Pinned skills are off-limits to both the curator's auto-transitions and the agent's own `skill_manage` tool. See [Pinning a skill](index.md#pinning-a-skill) below.
...
### Running the review on a cheaper aux model[​](index.md#running-the-review-on-a-cheaper-aux-model "Direct link to Running the review on a cheaper aux model")
...
## Backups and rollback[​](index.md#backups-and-rollback "Direct link to Backups and rollback")
...
## What "agent-created" means[​](index.md#what-agent-created-means "Direct link to What \"agent-created\" means")
...
Your hand-written skills look the same as agent-saved ones
...
## Pinning a skill[​](index.md#pinning-a-skill "Direct link to Pinning a skill")
...
## Usage telemetry[​](index.md#usage-telemetry "Direct link to Usage telemetry")
...
## Per-run reports[​](index.md#per-run-reports "Direct link to Per-run reports")
...
## Restoring an archived skill[​](index.md#restoring-an-archived-skill "Direct link to Restoring an archived skill")
...
## Disabling per environment[​](index.md#disabling-per-environment "Direct link to Disabling per environment")
...
- [Skills System](../skills/index.md) — how skills work in general and the self-improvement loop that creates them
- [Memory](../memory/index.md) — a parallel background review that maintains long-term memory
...
- [How it runs](index.md#how-it-runs)
- [Configuration](index.md#configuration)
  - [Running the review on a cheaper aux model](index.md#running-the-review-on-a-cheaper-aux-model)
- [CLI](index.md#cli)
- [Backups and rollback](index.md#backups-and-rollback)
- [What "agent-created" means](index.md#what-agent-created-means)
- [Pinning a skill](index.md#pinning-a-skill)
- [Usage telemetry](index.md#usage-telemetry)
- [Per-run reports](index.md#per-run-reports)
- [Restoring an archived skill](index.md#restoring-an-archived-skill)
- [Disabling per environment](index.md#disabling-per-environment)
