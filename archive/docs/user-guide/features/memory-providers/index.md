...
## Available Providers[​](index.md#available-providers "Direct link to Available Providers")

### Honcho[​](index.md#honcho "Direct link to Honcho")
...
### New profile, fresh Honcho peer[​](index.md#new-profile-fresh-honcho-peer "Direct link to New profile, fresh Honcho peer")
...
### Existing profiles, backfill Honcho peers[​](index.md#existing-profiles-backfill-honcho-peers "Direct link to Existing profiles, backfill Honcho peers")
...
### Per-profile observation[​](index.md#per-profile-observation "Direct link to Per-profile observation")
...
See the [Honcho page](../honcho/index.md#observation-directional-vs-unified) for the full observation reference.
...
### OpenViking[​](index.md#openviking "Direct link to OpenViking")
...
### Mem0[​](index.md#mem0 "Direct link to Mem0")
...
### Hindsight[​](index.md#hindsight "Direct link to Hindsight")
...
### Holographic[​](index.md#holographic "Direct link to Holographic")
...
### RetainDB[​](index.md#retaindb "Direct link to RetainDB")
...
### ByteRover[​](index.md#byterover "Direct link to ByteRover")
...
### Supermemory[​](index.md#supermemory "Direct link to Supermemory")
...
## Provider Comparison[​](index.md#provider-comparison "Direct link to Provider Comparison")
...
## Profile Isolation[​](index.md#profile-isolation "Direct link to Profile Isolation")

Each provider's data is isolated per [profile](../../profiles/index.md):
...
## Building a Memory Provider[​](index.md#building-a-memory-provider "Direct link to Building a Memory Provider")

See the [Developer Guide: Memory Provider Plugins](../../../developer-guide/memory-provider-plugin/index.md) for how to create your own.

- [Quick Start](index.md#quick-start)
- [How It Works](index.md#how-it-works)
- [Available Providers](index.md#available-providers)
  - [Honcho](index.md#honcho)
  - [New profile, fresh Honcho peer](index.md#new-profile-fresh-honcho-peer)
  - [Existing profiles, backfill Honcho peers](index.md#existing-profiles-backfill-honcho-peers)
  - [Per-profile observation](index.md#per-profile-observation)
  - [OpenViking](index.md#openviking)
  - [Mem0](index.md#mem0)
  - [Hindsight](index.md#hindsight)
  - [Holographic](index.md#holographic)
  - [RetainDB](index.md#retaindb)
  - [ByteRover](index.md#byterover)
  - [Supermemory](index.md#supermemory)
- [Provider Comparison](index.md#provider-comparison)
- [Profile Isolation](index.md#profile-isolation)
- [Building a Memory Provider](index.md#building-a-memory-provider)
