...
If you want a practical setup walkthrough with recommended configurations and real usage patterns, see [Use Voice Mode with Hermes](../../../guides/use-voice-mode-with-hermes/index.md).

## Prerequisites[​](index.md#prerequisites "Direct link to Prerequisites")

Before using voice features, make sure you have:

1. **Hermes Agent installed** — `pip install hermes-agent` (see [Installation](../../../getting-started/installation/index.md))
...
### Python Packages[​](index.md#python-packages "Direct link to Python Packages")
...
### System Dependencies[​](index.md#system-dependencies "Direct link to System Dependencies")
...
### API Keys[​](index.md#api-keys "Direct link to API Keys")
...
## CLI Voice Mode[​](index.md#cli-voice-mode "Direct link to CLI Voice Mode")
...
### Silence Detection[​](index.md#silence-detection "Direct link to Silence Detection")
...
### Streaming TTS[​](index.md#streaming-tts "Direct link to Streaming TTS")
...
### Hallucination Filter[​](index.md#hallucination-filter "Direct link to Hallucination Filter")
...
## Gateway Voice Reply (Telegram & Discord)[​](index.md#gateway-voice-reply-telegram--discord "Direct link to Gateway Voice Reply (Telegram & Discord)")

If you haven't set up your messaging bots yet, see the platform-specific guides:

- [Telegram Setup Guide](../../messaging/telegram/index.md)
- [Discord Setup Guide](../../messaging/discord/index.md)
...
### Discord: Channels vs DMs[​](index.md#discord-channels-vs-dms "Direct link to Discord: Channels vs DMs")
...
### Commands[​](index.md#commands "Direct link to Commands")
...
### Platform Delivery[​](index.md#platform-delivery "Direct link to Platform Delivery")
...
## Discord Voice Channels[​](index.md#discord-voice-channels "Direct link to Discord Voice Channels")
...
#### 1. Discord Bot Permissions[​](index.md#1-discord-bot-permissions "Direct link to 1. Discord Bot Permissions")

If you already have a Discord bot set up for text (see [Discord Setup Guide](../../messaging/discord/index.md)), you need to add voice permissions.
...
#### 2. Privileged Gateway Intents[​](index.md#2-privileged-gateway-intents "Direct link to 2. Privileged Gateway Intents")
...
**Message Content Intent** is required. **Server Members Intent** is only needed if your `DISCORD_ALLOWED_USERS` list uses usernames — if you use numeric user IDs, you can leave it OFF. Voice-channel SSRC → user\_id mapping comes from Discord's SPEAKING opcode on the voice websocket and does **not** require the Server Members Intent.

#### 3. Opus Codec[​](index.md#3-opus-codec "Direct link to 3. Opus Codec")
...
#### 4. Environment Variables[​](index.md#4-environment-variables "Direct link to 4. Environment Variables")
...
### Commands[​](index.md#commands-1 "Direct link to Commands")
...
### Text Channel Integration[​](index.md#text-channel-integration "Direct link to Text Channel Integration")
...
### Echo Prevention[​](index.md#echo-prevention "Direct link to Echo Prevention")
...
### Access Control[​](index.md#access-control "Direct link to Access Control")
...
### STT Provider Comparison[​](index.md#stt-provider-comparison "Direct link to STT Provider Comparison")
...
### TTS Provider Comparison[​](index.md#tts-provider-comparison "Direct link to TTS Provider Comparison")
...
### "No audio device found" (CLI)[​](index.md#no-audio-device-found-cli "Direct link to \"No audio device found\" (CLI)")
...
### Bot doesn't respond in Discord server channels[​](index.md#bot-doesnt-respond-in-discord-server-channels "Direct link to Bot doesn't respond in Discord server channels")
...
### Bot joins VC but doesn't hear me[​](index.md#bot-joins-vc-but-doesnt-hear-me "Direct link to Bot joins VC but doesn't hear me")
...
### Bot hears me but doesn't respond[​](index.md#bot-hears-me-but-doesnt-respond "Direct link to Bot hears me but doesn't respond")
...
### Bot responds in text but not in voice channel[​](index.md#bot-responds-in-text-but-not-in-voice-channel "Direct link to Bot responds in text but not in voice channel")

- TTS provider may be failing — check API key and quota
- Edge TTS (free, no key) is the default fallback
- Check logs for TTS errors

### Whisper returns garbage text[​](index.md#whisper-returns-garbage-text "Direct link to Whisper returns garbage text")
...
- [Requirements](index.md#requirements)
  - [Python Packages](index.md#python-packages)
  - [System Dependencies](index.md#system-dependencies)
  - [API Keys](index.md#api-keys)
- [CLI Voice Mode](index.md#cli-voice-mode)
  - [Quick Start](index.md#quick-start)
  - [How It Works](index.md#how-it-works)
  - [Silence Detection](index.md#silence-detection)
  - [Streaming TTS](index.md#streaming-tts)
  - [Hallucination Filter](index.md#hallucination-filter)
- [Gateway Voice Reply (Telegram & Discord)](index.md#gateway-voice-reply-telegram--discord)
  - [Discord: Channels vs DMs](index.md#discord-channels-vs-dms)
  - [Commands](index.md#commands)
  - [Modes](index.md#modes)
  - [Platform Delivery](index.md#platform-delivery)
- [Discord Voice Channels](index.md#discord-voice-channels)
  - [Setup](index.md#setup)
  - [Start the Gateway](index.md#start-the-gateway)
  - [Commands](index.md#commands-1)
  - [How It Works](index.md#how-it-works-1)
  - [Text Channel Integration](index.md#text-channel-integration)
  - [Echo Prevention](index.md#echo-prevention)
...
- [Configuration Reference](index.md#configuration-reference)
  ...
  - [STT Provider Comparison](index.md#stt-provider-comparison)
  - [TTS Provider Comparison](index.md#tts-provider-comparison)
- [Troubleshooting](index.md#troubleshooting)
  - ["No audio device found" (CLI)](index.md#no-audio-device-found-cli)
  - [Bot doesn't respond in Discord server channels](index.md#bot-doesnt-respond-in-discord-server-channels)
  - [Bot joins VC but doesn't hear me](index.md#bot-joins-vc-but-doesnt-hear-me)
  - [Bot hears me but doesn't respond](index.md#bot-hears-me-but-doesnt-respond)
  - [Bot responds in text but not in voice channel](index.md#bot-responds-in-text-but-not-in-voice-channel)
  - [Whisper returns garbage text](index.md#whisper-returns-garbage-text)
