...
## What cron can do now[​](index.md#what-cron-can-do-now "Direct link to What cron can do now")
...
- run in **no-agent mode** — a script on a schedule, its stdout delivered verbatim, zero LLM involvement (see the [no-agent mode](index.md#no-agent-mode-script-only-jobs) section below)
...
## Creating scheduled tasks[​](index.md#creating-scheduled-tasks "Direct link to Creating scheduled tasks")

### In chat with `/cron`[​](index.md#in-chat-with-cron "Direct link to in-chat-with-cron")
...
### From the standalone CLI[​](index.md#from-the-standalone-cli "Direct link to From the standalone CLI")
...
### Through natural conversation[​](index.md#through-natural-conversation "Direct link to Through natural conversation")
...
## Skill-backed cron jobs[​](index.md#skill-backed-cron-jobs "Direct link to Skill-backed cron jobs")

A cron job can load one or more skills before it runs the prompt.

### Single skill[​](index.md#single-skill "Direct link to Single skill")
...
### Multiple skills[​](index.md#multiple-skills "Direct link to Multiple skills")
...
## Running a job inside a project directory[​](index.md#running-a-job-inside-a-project-directory "Direct link to Running a job inside a project directory")
...
## Editing jobs[​](index.md#editing-jobs "Direct link to Editing jobs")

You do not need to delete and recreate jobs just to change them.

### Chat[​](index.md#chat "Direct link to Chat")
...
### Standalone CLI[​](index.md#standalone-cli "Direct link to Standalone CLI")
...
## Lifecycle actions[​](index.md#lifecycle-actions "Direct link to Lifecycle actions")

Cron jobs now have a fuller lifecycle than just create/remove.

### Chat[​](index.md#chat-1 "Direct link to Chat")
...
### Standalone CLI[​](index.md#standalone-cli-1 "Direct link to Standalone CLI")
...
### Gateway scheduler behavior[​](index.md#gateway-scheduler-behavior "Direct link to Gateway scheduler behavior")
...
### Routing intent (`all`)[​](index.md#routing-intent-all "Direct link to routing-intent-all")
...
### Response wrapping[​](index.md#response-wrapping "Direct link to Response wrapping")
...
### Silent suppression[​](index.md#silent-suppression "Direct link to Silent suppression")
...
## Script timeout[​](index.md#script-timeout "Direct link to Script timeout")
...
## No-agent mode (script-only jobs)[​](index.md#no-agent-mode-script-only-jobs "Direct link to No-agent mode (script-only jobs)")
...
### The agent sets these up for you[​](index.md#the-agent-sets-these-up-for-you "Direct link to The agent sets these up for you")
...
See the [Script-Only Cron Jobs guide](../../../guides/cron-script-only/index.md) for worked examples.

## Chaining jobs with `context_from`[​](index.md#chaining-jobs-with-context_from "Direct link to chaining-jobs-with-context_from")
...
## Provider recovery[​](index.md#provider-recovery "Direct link to Provider recovery")
...
- **Rotate to the next credential** in your [credential pool](../../configuration/index.md#credential-pool-strategies) for the same provider

This means cron jobs that run at high frequency or during peak hours are more resilient — a single rate-limited key won't fail the entire run.

## Schedule formats[​](index.md#schedule-formats "Direct link to Schedule formats")
...
### Relative delays (one-shot)[​](index.md#relative-delays-one-shot "Direct link to Relative delays (one-shot)")
...
### Intervals (recurring)[​](index.md#intervals-recurring "Direct link to Intervals (recurring)")
...
### Cron expressions[​](index.md#cron-expressions "Direct link to Cron expressions")
...
### ISO timestamps[​](index.md#iso-timestamps "Direct link to ISO timestamps")

```
2026-03-15T09:00:00    → One-time at March 15, 2026 9:00 AM
```

## Repeat behavior[​](index.md#repeat-behavior "Direct link to Repeat behavior")
...
## Managing jobs programmatically[​](index.md#managing-jobs-programmatically "Direct link to Managing jobs programmatically")
...
## Toolsets available to cron jobs[​](index.md#toolsets-available-to-cron-jobs "Direct link to Toolsets available to cron jobs")
...
### Skipping the agent entirely: `wakeAgent`[​](index.md#skipping-the-agent-entirely-wakeagent "Direct link to skipping-the-agent-entirely-wakeagent")
...
### Chaining jobs: `context_from`[​](index.md#chaining-jobs-context_from "Direct link to chaining-jobs-context_from")
...
## Job storage[​](index.md#job-storage "Direct link to Job storage")
...
## Self-contained prompts still matter[​](index.md#self-contained-prompts-still-matter "Direct link to Self-contained prompts still matter")
...
- [What cron can do now](index.md#what-cron-can-do-now)
- [Creating scheduled tasks](index.md#creating-scheduled-tasks)
  - [In chat with `/cron`](index.md#in-chat-with-cron)
  - [From the standalone CLI](index.md#from-the-standalone-cli)
  - [Through natural conversation](index.md#through-natural-conversation)
- [Skill-backed cron jobs](index.md#skill-backed-cron-jobs)
  - [Single skill](index.md#single-skill)
  - [Multiple skills](index.md#multiple-skills)
- [Running a job inside a project directory](index.md#running-a-job-inside-a-project-directory)
- [Editing jobs](index.md#editing-jobs)
  - [Chat](index.md#chat)
  - [Standalone CLI](index.md#standalone-cli)
- [Lifecycle actions](index.md#lifecycle-actions)
  - [Chat](index.md#chat-1)
  - [Standalone CLI](index.md#standalone-cli-1)
- [How it works](index.md#how-it-works)
  - [Gateway scheduler behavior](index.md#gateway-scheduler-behavior)
- [Delivery options](index.md#delivery-options)
  - [Routing intent (`all`)](index.md#routing-intent-all)
  - [Response wrapping](index.md#response-wrapping)
  - [Silent suppression](index.md#silent-suppression)
- [Script timeout](index.md#script-timeout)
- [No-agent mode (script-only jobs)](index.md#no-agent-mode-script-only-jobs)
  - [The agent sets these up for you](index.md#the-agent-sets-these-up-for-you)
- [Chaining jobs with `context_from`](index.md#chaining-jobs-with-context_from)
- [Provider recovery](index.md#provider-recovery)
- [Schedule formats](index.md#schedule-formats)
  - [Relative delays (one-shot)](index.md#relative-delays-one-shot)
  - [Intervals (recurring)](index.md#intervals-recurring)
  - [Cron expressions](index.md#cron-expressions)
  - [ISO timestamps](index.md#iso-timestamps)
- [Repeat behavior](index.md#repeat-behavior)
- [Managing jobs programmatically](index.md#managing-jobs-programmatically)
- [Toolsets available to cron jobs](index.md#toolsets-available-to-cron-jobs)
  - [Skipping the agent entirely: `wakeAgent`](index.md#skipping-the-agent-entirely-wakeagent)
  - [Chaining jobs: `context_from`](index.md#chaining-jobs-context_from)
- [Job storage](index.md#job-storage)
- [Self-contained prompts still matter](index.md#self-contained-prompts-still-matter)
