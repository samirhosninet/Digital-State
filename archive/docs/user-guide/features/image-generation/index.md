...
If you have a paid [Nous Portal](https://portal.nousresearch.com) subscription, you can use image generation through the **[Tool Gateway](../tool-gateway/index.md)** without a FAL API key. Your model selection persists across both paths.
...
### Get a FAL API Key[​](index.md#get-a-fal-api-key "Direct link to Get a FAL API Key")

1. Sign up at [fal.ai](https://fal.ai/)
2. Generate an API key from your dashboard

### Configure and Pick a Model[​](index.md#configure-and-pick-a-model "Direct link to Configure and Pick a Model")
...
### GPT-Image Quality[​](index.md#gpt-image-quality "Direct link to GPT-Image Quality")
...
## Usage[​](index.md#usage "Direct link to Usage")
...
## Aspect Ratios[​](index.md#aspect-ratios "Direct link to Aspect Ratios")
...
## Automatic Upscaling[​](index.md#automatic-upscaling "Direct link to Automatic Upscaling")
...
## Debugging[​](index.md#debugging "Direct link to Debugging")
...
- [Setup](index.md#setup)
  - [Get a FAL API Key](index.md#get-a-fal-api-key)
  - [Configure and Pick a Model](index.md#configure-and-pick-a-model)
  - [GPT-Image Quality](index.md#gpt-image-quality)
- [Usage](index.md#usage)
- [Aspect Ratios](index.md#aspect-ratios)
- [Automatic Upscaling](index.md#automatic-upscaling)
