...
## Supported Context Files[​](index.md#supported-context-files "Direct link to Supported Context Files")
...
### Progressive Subdirectory Discovery[​](index.md#progressive-subdirectory-discovery "Direct link to Progressive Subdirectory Discovery")
...
Subdirectory context files go through the same [security scan](index.md#security-prompt-injection-protection) as startup context files. Malicious files are blocked.

### Example AGENTS.md[​](index.md#example-agentsmd "Direct link to Example AGENTS.md")
...
`SOUL.md` controls the agent's personality, tone, and communication style. See the [Personality](../personality/index.md) page for full details.
...
## .cursorrules[​](index.md#cursorrules "Direct link to .cursorrules")
...
## How Context Files Are Loaded[​](index.md#how-context-files-are-loaded "Direct link to How Context Files Are Loaded")

### At startup (system prompt)[​](index.md#at-startup-system-prompt "Direct link to At startup (system prompt)")
...
### During the session (progressive discovery)[​](index.md#during-the-session-progressive-discovery "Direct link to During the session (progressive discovery)")
...
## Security: Prompt Injection Protection[​](index.md#security-prompt-injection-protection "Direct link to Security: Prompt Injection Protection")
...
## Tips for Effective Context Files[​](index.md#tips-for-effective-context-files "Direct link to Tips for Effective Context Files")
...
### Per-Subdirectory Context[​](index.md#per-subdirectory-context "Direct link to Per-Subdirectory Context")
...
- [Supported Context Files](index.md#supported-context-files)
- [AGENTS.md](index.md#agentsmd)
  - [Progressive Subdirectory Discovery](index.md#progressive-subdirectory-discovery)
  - [Example AGENTS.md](index.md#example-agentsmd)
- [SOUL.md](index.md#soulmd)
- [.cursorrules](index.md#cursorrules)
- [How Context Files Are Loaded](index.md#how-context-files-are-loaded)
  - [At startup (system prompt)](index.md#at-startup-system-prompt)
  - [During the session (progressive discovery)](index.md#during-the-session-progressive-discovery)
- [Security: Prompt Injection Protection](index.md#security-prompt-injection-protection)
- [Size Limits](index.md#size-limits)
- [Tips for Effective Context Files](index.md#tips-for-effective-context-files)
  - [Per-Subdirectory Context](index.md#per-subdirectory-context)
