...
## How Memory Appears in the System Prompt[​](index.md#how-memory-appears-in-the-system-prompt "Direct link to How Memory Appears in the System Prompt")
...
## Memory Tool Actions[​](index.md#memory-tool-actions "Direct link to Memory Tool Actions")
...
### Substring Matching[​](index.md#substring-matching "Direct link to Substring Matching")
...
## Two Targets Explained[​](index.md#two-targets-explained "Direct link to Two Targets Explained")

### `memory` — Agent's Personal Notes[​](index.md#memory--agents-personal-notes "Direct link to memory--agents-personal-notes")
...
### `user` — User Profile[​](index.md#user--user-profile "Direct link to user--user-profile")
...
## What to Save vs Skip[​](index.md#what-to-save-vs-skip "Direct link to What to Save vs Skip")

### Save These (Proactively)[​](index.md#save-these-proactively "Direct link to Save These (Proactively)")
...
### Skip These[​](index.md#skip-these "Direct link to Skip These")
...
## Capacity Management[​](index.md#capacity-management "Direct link to Capacity Management")
...
### What Happens When Memory is Full[​](index.md#what-happens-when-memory-is-full "Direct link to What Happens When Memory is Full")
...
### Practical Examples of Good Memory Entries[​](index.md#practical-examples-of-good-memory-entries "Direct link to Practical Examples of Good Memory Entries")
...
## Duplicate Prevention[​](index.md#duplicate-prevention "Direct link to Duplicate Prevention")
...
## Session Search[​](index.md#session-search "Direct link to Session Search")
...
### session\_search vs memory[​](index.md#session_search-vs-memory "Direct link to session_search vs memory")
...
## External Memory Providers[​](index.md#external-memory-providers "Direct link to External Memory Providers")
...
See the [Memory Providers](../memory-providers/index.md) guide for full details on each provider, setup instructions, and comparison.

- [How It Works](index.md#how-it-works)
- [How Memory Appears in the System Prompt](index.md#how-memory-appears-in-the-system-prompt)
- [Memory Tool Actions](index.md#memory-tool-actions)
  - [Substring Matching](index.md#substring-matching)
- [Two Targets Explained](index.md#two-targets-explained)
  - [`memory` — Agent's Personal Notes](index.md#memory--agents-personal-notes)
  - [`user` — User Profile](index.md#user--user-profile)
- [What to Save vs Skip](index.md#what-to-save-vs-skip)
  - [Save These (Proactively)](index.md#save-these-proactively)
  - [Skip These](index.md#skip-these)
- [Capacity Management](index.md#capacity-management)
  - [What Happens When Memory is Full](index.md#what-happens-when-memory-is-full)
  - [Practical Examples of Good Memory Entries](index.md#practical-examples-of-good-memory-entries)
- [Duplicate Prevention](index.md#duplicate-prevention)
- [Security Scanning](index.md#security-scanning)
- [Session Search](index.md#session-search)
  - [session\_search vs memory](index.md#session_search-vs-memory)
- [Configuration](index.md#configuration)
- [External Memory Providers](index.md#external-memory-providers)
