...
## How SOUL.md works now[​](index.md#how-soulmd-works-now "Direct link to How SOUL.md works now")
...
### Important behavior[​](index.md#important-behavior "Direct link to Important behavior")
...
## Why this design[​](index.md#why-this-design "Direct link to Why this design")
...
## Where to edit it[​](index.md#where-to-edit-it "Direct link to Where to edit it")
...
## What should go in SOUL.md?[​](index.md#what-should-go-in-soulmd "Direct link to What should go in SOUL.md?")
...
## Good SOUL.md content[​](index.md#good-soulmd-content "Direct link to Good SOUL.md content")
...
## What Hermes injects into the prompt[​](index.md#what-hermes-injects-into-the-prompt "Direct link to What Hermes injects into the prompt")
...
## Security scanning[​](index.md#security-scanning "Direct link to Security scanning")
...
### SOUL.md[​](index.md#soulmd "Direct link to SOUL.md")
...
### AGENTS.md[​](index.md#agentsmd "Direct link to AGENTS.md")
...
## SOUL.md vs `/personality`[​](index.md#soulmd-vs-personality "Direct link to soulmd-vs-personality")
...
## Built-in personalities[​](index.md#built-in-personalities "Direct link to Built-in personalities")
...
## Switching personalities with commands[​](index.md#switching-personalities-with-commands "Direct link to Switching personalities with commands")

### CLI[​](index.md#cli "Direct link to CLI")
...
## Custom personalities in config[​](index.md#custom-personalities-in-config "Direct link to Custom personalities in config")
...
## Recommended workflow[​](index.md#recommended-workflow "Direct link to Recommended workflow")
...
## How personality interacts with the full prompt[​](index.md#how-personality-interacts-with-the-full-prompt "Direct link to How personality interacts with the full prompt")
...
- [Context Files](../context-files/index.md)
- [Configuration](../../configuration/index.md)
- [Tips & Best Practices](../../../guides/tips/index.md)
- [SOUL.md Guide](../../../guides/use-soul-with-hermes/index.md)

## CLI appearance vs conversational personality[​](index.md#cli-appearance-vs-conversational-personality "Direct link to CLI appearance vs conversational personality")
...
For terminal appearance, see [Skins & Themes](../skins/index.md).

- [How SOUL.md works now](index.md#how-soulmd-works-now)
  - [Important behavior](index.md#important-behavior)
- [Why this design](index.md#why-this-design)
- [Where to edit it](index.md#where-to-edit-it)
- [What should go in SOUL.md?](index.md#what-should-go-in-soulmd)
- [Good SOUL.md content](index.md#good-soulmd-content)
  - [Example](index.md#example)
- [What Hermes injects into the prompt](index.md#what-hermes-injects-into-the-prompt)
- [Security scanning](index.md#security-scanning)
- [SOUL.md vs AGENTS.md](index.md#soulmd-vs-agentsmd)
  - [SOUL.md](index.md#soulmd)
  - [AGENTS.md](index.md#agentsmd)
- [SOUL.md vs `/personality`](index.md#soulmd-vs-personality)
- [Built-in personalities](index.md#built-in-personalities)
- [Switching personalities with commands](index.md#switching-personalities-with-commands)
  - [CLI](index.md#cli)
  - [Messaging platforms](index.md#messaging-platforms)
- [Custom personalities in config](index.md#custom-personalities-in-config)
- [Recommended workflow](index.md#recommended-workflow)
- [How personality interacts with the full prompt](index.md#how-personality-interacts-with-the-full-prompt)
- [Related docs](index.md#related-docs)
- [CLI appearance vs conversational personality](index.md#cli-appearance-vs-conversational-personality)
