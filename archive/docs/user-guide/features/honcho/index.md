...
Honcho is integrated into the [Memory Providers](../memory-providers/index.md) system. All features below are available through the unified memory provider interface.

## What Honcho Adds[​](index.md#what-honcho-adds "Direct link to What Honcho Adds")
...
### Two-Layer Context Injection[​](index.md#two-layer-context-injection "Direct link to Two-Layer Context Injection")
...
### Cold/Warm Prompt Selection[​](index.md#coldwarm-prompt-selection "Direct link to Cold/Warm Prompt Selection")
...
### Three Orthogonal Config Knobs[​](index.md#three-orthogonal-config-knobs "Direct link to Three Orthogonal Config Knobs")
...
### Dialectic Depth (Multi-Pass)[​](index.md#dialectic-depth-multi-pass "Direct link to Dialectic Depth (Multi-Pass)")
...
### Session-Start Prewarm[​](index.md#session-start-prewarm "Direct link to Session-Start Prewarm")
...
### Query-Adaptive Reasoning Level[​](index.md#query-adaptive-reasoning-level "Direct link to Query-Adaptive Reasoning Level")
...
### Full Config Reference[​](index.md#full-config-reference "Direct link to Full Config Reference")
...
## Observation (Directional vs. Unified)[​](index.md#observation-directional-vs-unified "Direct link to Observation (Directional vs. Unified)")
...
## Tools[​](index.md#tools "Direct link to Tools")
...
## CLI Commands[​](index.md#cli-commands "Direct link to CLI Commands")
...
## Migrating from `hermes honcho`[​](index.md#migrating-from-hermes-honcho "Direct link to migrating-from-hermes-honcho")
...
## Full Documentation[​](index.md#full-documentation "Direct link to Full Documentation")

See [Memory Providers — Honcho](../memory-providers/index.md#honcho) for the complete reference.

- [What Honcho Adds](index.md#what-honcho-adds)
- [Setup](index.md#setup)
- [Architecture](index.md#architecture)
  - [Two-Layer Context Injection](index.md#two-layer-context-injection)
  - [Cold/Warm Prompt Selection](index.md#coldwarm-prompt-selection)
  - [Three Orthogonal Config Knobs](index.md#three-orthogonal-config-knobs)
  - [Dialectic Depth (Multi-Pass)](index.md#dialectic-depth-multi-pass)
  - [Session-Start Prewarm](index.md#session-start-prewarm)
  - [Query-Adaptive Reasoning Level](index.md#query-adaptive-reasoning-level)
- [Configuration Options](index.md#configuration-options)
  - [Full Config Reference](index.md#full-config-reference)
- [Observation (Directional vs. Unified)](index.md#observation-directional-vs-unified)
- [Tools](index.md#tools)
- [CLI Commands](index.md#cli-commands)
- [Migrating from `hermes honcho`](index.md#migrating-from-hermes-honcho)
- [Full Documentation](index.md#full-documentation)
