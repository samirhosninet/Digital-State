...
**Honcho cross-session memory** is available as a memory provider plugin (`plugins/memory/honcho/`), not as a built-in toolset. See [Plugins](../plugins/index.md) for installation.
...
For the authoritative code-derived registry, see [Built-in Tools Reference](../../../reference/tools-reference/index.md) and [Toolsets Reference](../../../reference/toolsets-reference/index.md).

Nous Tool Gateway

Paid [Nous Portal](https://portal.nousresearch.com) subscribers can use web search, image generation, TTS, and browser automation through the **[Tool Gateway](../tool-gateway/index.md)** — no separate API keys needed. Run `hermes model` to enable it, or configure individual tools with `hermes tools`.

## Using Toolsets[​](index.md#using-toolsets "Direct link to Using Toolsets")
...
See [Toolsets Reference](../../../reference/toolsets-reference/index.md) for the full set, including platform presets such as `hermes-cli`, `hermes-telegram`, and dynamic MCP toolsets like `mcp-<server>`.

## Terminal Backends[​](index.md#terminal-backends "Direct link to Terminal Backends")
...
This means the Docker backend behaves like a persistent sandbox VM, not a fresh container per command. If you `pip install foo` once, it's there for the rest of the session. If you `cd /workspace/project`, subsequent `ls` calls see that directory. See [Configuration → Docker Backend](../../configuration/index.md#docker-backend) for the full lifecycle details and the `container_persistent` flag that controls whether `/workspace` and `/root` survive across Hermes restarts.
...
### Singularity/Apptainer[​](index.md#singularityapptainer "Direct link to Singularity/Apptainer")
...
### Modal (Serverless Cloud)[​](index.md#modal-serverless-cloud "Direct link to Modal (Serverless Cloud)")
...
### Vercel Sandbox[​](index.md#vercel-sandbox "Direct link to Vercel Sandbox")
...
### Container Resources[​](index.md#container-resources "Direct link to Container Resources")
...
### Container Security[​](index.md#container-security "Direct link to Container Security")
...
## Background Process Management[​](index.md#background-process-management "Direct link to Background Process Management")
...
## Sudo Support[​](index.md#sudo-support "Direct link to Sudo Support")
...
- [Using Toolsets](index.md#using-toolsets)
- [Terminal Backends](index.md#terminal-backends)
  - [Configuration](index.md#configuration)
  - [Docker Backend](index.md#docker-backend)
  - [SSH Backend](index.md#ssh-backend)
  - [Singularity/Apptainer](index.md#singularityapptainer)
  - [Modal (Serverless Cloud)](index.md#modal-serverless-cloud)
  - [Vercel Sandbox](index.md#vercel-sandbox)
  - [Container Resources](index.md#container-resources)
  - [Container Security](index.md#container-security)
- [Background Process Management](index.md#background-process-management)
