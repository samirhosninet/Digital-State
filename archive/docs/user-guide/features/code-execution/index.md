...
title: Code Execution | Hermes Agent
...
## When the Agent Uses This[​](index.md#when-the-agent-uses-this "Direct link to When the Agent Uses This")
...
### Data Processing Pipeline[​](index.md#data-processing-pipeline "Direct link to Data Processing Pipeline")
...
### Multi-Step Web Research[​](index.md#multi-step-web-research "Direct link to Multi-Step Web Research")
...
### Bulk File Refactoring[​](index.md#bulk-file-refactoring "Direct link to Bulk File Refactoring")
...
### Build and Test Pipeline[​](index.md#build-and-test-pipeline "Direct link to Build and Test Pipeline")
...
## Execution Mode[​](index.md#execution-mode "Direct link to Execution Mode")
...
## How Tool Calls Work Inside Scripts[​](index.md#how-tool-calls-work-inside-scripts "Direct link to How Tool Calls Work Inside Scripts")
...
### Skill Environment Variable Passthrough[​](index.md#skill-environment-variable-passthrough "Direct link to Skill Environment Variable Passthrough")
...
See the [Security guide](../../security/index.md#environment-variable-passthrough) for full details.
...
## execute\_code vs terminal[​](index.md#execute_code-vs-terminal "Direct link to execute_code vs terminal")

| Use Case | execute\_code | terminal |
| --- | --- | --- |
...
| Needs API keys in environment | ⚠️ Only via [passthrough](../../security/index.md#environment-variable-passthrough) | ✅ (most pass through) |
...
## Platform Support[​](index.md#platform-support "Direct link to Platform Support")
...
- [When the Agent Uses This](index.md#when-the-agent-uses-this)
- [Practical Examples](index.md#practical-examples)
  - [Data Processing Pipeline](index.md#data-processing-pipeline)
  - [Multi-Step Web Research](index.md#multi-step-web-research)
  - [Bulk File Refactoring](index.md#bulk-file-refactoring)
  - [Build and Test Pipeline](index.md#build-and-test-pipeline)
- [Execution Mode](index.md#execution-mode)
- [Resource Limits](index.md#resource-limits)
- [How Tool Calls Work Inside Scripts](index.md#how-tool-calls-work-inside-scripts)
- [Error Handling](index.md#error-handling)
- [Security](index.md#security)
  - [Skill Environment Variable Passthrough](index.md#skill-environment-variable-passthrough)
- [execute\_code vs terminal](index.md#execute_code-vs-terminal)
- [Platform Support](index.md#platform-support)
