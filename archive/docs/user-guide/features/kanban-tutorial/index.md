...
title: Kanban tutorial | Hermes Agent
archived_at: 2026-05-13T02:40:25Z
---

A walkthrough of the four use-cases the Hermes Kanban system was designed for, with the dashboard open in a browser. If you haven't read the [Kanban overview](../kanban/index.md) yet, start there — this assumes you know what a task, run, assignee, and dispatcher are.
...
## The board at a glance[​](index.md#the-board-at-a-glance "Direct link to The board at a glance")

![Kanban board overview](../../../../assets/docs/assets/images/01-board-overview-dd98ac39283d95534d6df59f90df98b0.png)
...
### Flat view[​](index.md#flat-view "Direct link to Flat view")
...
![Board with lanes by profile off](../../../../assets/docs/assets/images/02-board-flat-019a7cf4f943c0ff4d95ffa7d579bf25.png)

## Story 1 — Solo dev shipping a feature[​](index.md#story-1--solo-dev-shipping-a-feature "Direct link to Story 1 — Solo dev shipping a feature")
...
![Solo dev — completed schema task drawer](../../../../assets/docs/assets/images/03-drawer-schema-task-217f2993df9ebe7c0f2a678df97d934e.png)
...
## Story 2 — Fleet farming[​](index.md#story-2--fleet-farming "Direct link to Story 2 — Fleet farming")
...
![Fleet view filtered to transcribe tasks](../../../../assets/docs/assets/images/07-fleet-transcribes-cf7345a3270df63f9336252cada8da61.png)
...
## Story 3 — Role pipeline with retry[​](index.md#story-3--role-pipeline-with-retry "Direct link to Story 3 — Role pipeline with retry")
...
![Pipeline view for a multi-role feature](../../../../assets/docs/assets/images/08-pipeline-auth-2dc4dcc631cf371f649ad70ab1e71611.png)
...
![Implementation task with two runs — blocked then completed](../../../../assets/docs/assets/images/04b-drawer-retry-history-scrolled-356e4195a55572cfc522c5236f02c594.png)
...
![Reviewer&#39;s drawer view of the pipeline](../../../../assets/docs/assets/images/09-drawer-pipeline-review-12ea45e97703570d5e889812347a0778.png)
...
## Story 4 — Circuit breaker and crash recovery[​](index.md#story-4--circuit-breaker-and-crash-recovery "Direct link to Story 4 — Circuit breaker and crash recovery")
...
### Circuit breaker — permanent-looking failure[​](index.md#circuit-breaker--permanent-looking-failure "Direct link to Circuit breaker — permanent-looking failure")
...
![Circuit breaker — 2 spawn_failed + 1 gave_up](../../../../assets/docs/assets/images/11-drawer-gave-up-04cdec442b239748a9904b8651efde1d.png)
...
### Crash recovery — worker dies mid-flight[​](index.md#crash-recovery--worker-dies-mid-flight "Direct link to Crash recovery — worker dies mid-flight")
...
![Crash and recovery — 1 crashed + 1 completed](../../../../assets/docs/assets/images/06-drawer-crash-recovery-17edcbea131d965bb8dc7283e5622e35.png)
...
## Structured handoff — why `summary` and `metadata` matter[​](index.md#structured-handoff--why-summary-and-metadata-matter "Direct link to structured-handoff--why-summary-and-metadata-matter")
...
## Inspecting a task currently running[​](index.md#inspecting-a-task-currently-running "Direct link to Inspecting a task currently running")
...
![Claimed, in-flight task](../../../../assets/docs/assets/images/10-drawer-in-flight-0b6c924e986c7862439f00d776e432f4.png)
...
- [Kanban overview](../kanban/index.md) — the full data model, event vocabulary, and CLI reference.
...
- [The board at a glance](index.md#the-board-at-a-glance)
  - [Flat view](index.md#flat-view)
- [Story 1 — Solo dev shipping a feature](index.md#story-1--solo-dev-shipping-a-feature)
- [Story 2 — Fleet farming](index.md#story-2--fleet-farming)
- [Story 3 — Role pipeline with retry](index.md#story-3--role-pipeline-with-retry)
- [Story 4 — Circuit breaker and crash recovery](index.md#story-4--circuit-breaker-and-crash-recovery)
  - [Circuit breaker — permanent-looking failure](index.md#circuit-breaker--permanent-looking-failure)
  - [Crash recovery — worker dies mid-flight](index.md#crash-recovery--worker-dies-mid-flight)
- [Structured handoff — why `summary` and `metadata` matter](index.md#structured-handoff--why-summary-and-metadata-matter)
- [Inspecting a task currently running](index.md#inspecting-a-task-currently-running)
