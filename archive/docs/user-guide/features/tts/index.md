...
If you have a paid [Nous Portal](https://portal.nousresearch.com) subscription, OpenAI TTS is available through the **[Tool Gateway](../tool-gateway/index.md)** without a separate OpenAI API key. Run `hermes model` or `hermes tools` to enable it.
...
### Input length limits[​](index.md#input-length-limits "Direct link to Input length limits")
...
### Telegram Voice Bubbles & ffmpeg[​](index.md#telegram-voice-bubbles--ffmpeg "Direct link to Telegram Voice Bubbles & ffmpeg")
...
### xAI Custom Voices (voice cloning)[​](index.md#xai-custom-voices-voice-cloning "Direct link to xAI Custom Voices (voice cloning)")
...
### Piper (local, 44 languages)[​](index.md#piper-local-44-languages "Direct link to Piper (local, 44 languages)")
...
### Custom command providers[​](index.md#custom-command-providers "Direct link to Custom command providers")
...
#### Example: Doubao (Chinese seed-tts-2.0)[​](index.md#example-doubao-chinese-seed-tts-20 "Direct link to Example: Doubao (Chinese seed-tts-2.0)")
...
Credentials come from your shell environment (`VOLCENGINE_APP_ID` / `VOLCENGINE_ACCESS_TOKEN`) or `~/.doubao-speech/config.yaml`. Pick a voice by adding `--voice zh-female-warm` (or any other alias from `doubao-speech list-voices`) to the command. `doubao-speech` also bundles streaming ASR — see the [STT section below](index.md#example-doubao--volcengine-asr) for Hermes integration. Source and full docs: [github.com/Hypnus-Yuan/doubao-speech](https://github.com/Hypnus-Yuan/doubao-speech).

#### Placeholders[​](index.md#placeholders "Direct link to Placeholders")
...
#### Optional keys[​](index.md#optional-keys "Direct link to Optional keys")
...
#### Behavior notes[​](index.md#behavior-notes "Direct link to Behavior notes")
...
## Voice Message Transcription (STT)[​](index.md#voice-message-transcription-stt "Direct link to Voice Message Transcription (STT)")
...
### Provider Details[​](index.md#provider-details "Direct link to Provider Details")
...
#### Example: Doubao / Volcengine ASR[​](index.md#example-doubao--volcengine-asr "Direct link to Example: Doubao / Volcengine ASR")

If you use [`doubao-speech`](https://pypi.org/project/doubao-speech/) for Doubao TTS (see [above](index.md#example-doubao-chinese-seed-tts-20)), the same package handles speech-to-text via the local-command STT surface:
...
### Fallback Behavior[​](index.md#fallback-behavior "Direct link to Fallback Behavior")
...
- [Text-to-Speech](index.md#text-to-speech)
  - [Platform Delivery](index.md#platform-delivery)
  - [Configuration](index.md#configuration)
  - [Input length limits](index.md#input-length-limits)
  - [Telegram Voice Bubbles & ffmpeg](index.md#telegram-voice-bubbles--ffmpeg)
  - [xAI Custom Voices (voice cloning)](index.md#xai-custom-voices-voice-cloning)
  - [Piper (local, 44 languages)](index.md#piper-local-44-languages)
  - [Custom command providers](index.md#custom-command-providers)
- [Voice Message Transcription (STT)](index.md#voice-message-transcription-stt)
  - [Configuration](index.md#configuration-1)
  - [Provider Details](index.md#provider-details)
  - [Fallback Behavior](index.md#fallback-behavior)
