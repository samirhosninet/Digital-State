...
See the [Plugins](../plugins/index.md) page for the general plugin system, and [Build a Hermes Plugin](../../../guides/build-a-hermes-plugin/index.md) to write your own.

## How discovery works[​](index.md#how-discovery-works "Direct link to How discovery works")
...
## Bundled plugins are opt-in[​](index.md#bundled-plugins-are-opt-in "Direct link to Bundled plugins are opt-in")
...
## Currently shipped[​](index.md#currently-shipped "Direct link to Currently shipped")
...
| `kanban/dashboard` | dashboard tab | Kanban board UI for the multi-agent dispatcher — tasks, comments, fan-out, board switching. See [Kanban Multi-Agent](../kanban/index.md). |

Memory providers (`plugins/memory/*`) and context engines (`plugins/context_engine/*`) are listed separately on [Memory Providers](../memory-providers/index.md) — they're managed through `hermes memory` and `hermes plugins` respectively. The full per-plugin detail for the two long-running hooks-based plugins follows.

### disk-cleanup[​](index.md#disk-cleanup "Direct link to disk-cleanup")
...
| empty dirs under HERMES\_HOME | always | Never |
...
### observability/langfuse[​](index.md#observabilitylangfuse "Direct link to observability/langfuse")
...
### google\_meet[​](index.md#google_meet "Direct link to google_meet")
...
### hermes-achievements[​](index.md#hermes-achievements "Direct link to hermes-achievements")
...
## Adding a bundled plugin[​](index.md#adding-a-bundled-plugin "Direct link to Adding a bundled plugin")

Bundled plugins are written exactly like any other Hermes plugin — see [Build a Hermes Plugin](../../../guides/build-a-hermes-plugin/index.md). The only differences are:
...
- [How discovery works](index.md#how-discovery-works)
- [Bundled plugins are opt-in](index.md#bundled-plugins-are-opt-in)
- [Currently shipped](index.md#currently-shipped)
  - [disk-cleanup](index.md#disk-cleanup)
  - [observability/langfuse](index.md#observabilitylangfuse)
  - [google\_meet](index.md#google_meet)
  - [hermes-achievements](index.md#hermes-achievements)
- [Adding a bundled plugin](index.md#adding-a-bundled-plugin)
