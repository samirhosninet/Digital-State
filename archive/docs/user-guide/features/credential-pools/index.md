...
title: Credential Pools | Hermes Agent
...
This is different from [fallback providers](../fallback-providers/index.md), which switch to a *different* provider entirely. Credential pools are same-provider rotation; fallback providers are cross-provider failover. Pools are tried first — if all pool keys are exhausted, *then* the fallback provider activates.
...
## Rotation Strategies[​](index.md#rotation-strategies "Direct link to Rotation Strategies")
...
## Error Recovery[​](index.md#error-recovery "Direct link to Error Recovery")
...
## Custom Endpoint Pools[​](index.md#custom-endpoint-pools "Direct link to Custom Endpoint Pools")
...
## Auto-Discovery[​](index.md#auto-discovery "Direct link to Auto-Discovery")
...
## Delegation & Subagent Sharing[​](index.md#delegation--subagent-sharing "Direct link to Delegation & Subagent Sharing")
...
## Thread Safety[​](index.md#thread-safety "Direct link to Thread Safety")
...
## Storage[​](index.md#storage "Direct link to Storage")
...
- [Rotation Strategies](index.md#rotation-strategies)
- [Error Recovery](index.md#error-recovery)
- [Custom Endpoint Pools](index.md#custom-endpoint-pools)
- [Auto-Discovery](index.md#auto-discovery)
- [Delegation & Subagent Sharing](index.md#delegation--subagent-sharing)
- [Thread Safety](index.md#thread-safety)
