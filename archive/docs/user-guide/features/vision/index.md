...
## Paste Methods[​](index.md#paste-methods "Direct link to Paste Methods")

How you attach an image depends on your terminal environment. Not all methods work everywhere — here's the full breakdown:

### `/paste` Command[​](index.md#paste-command "Direct link to paste-command")
...
### Ctrl+V / Cmd+V[​](index.md#ctrlv--cmdv "Direct link to Ctrl+V / Cmd+V")
...
### `/terminal-setup` for VS Code / Cursor / Windsurf[​](index.md#terminal-setup-for-vs-code--cursor--windsurf "Direct link to terminal-setup-for-vs-code--cursor--windsurf")
...
## Platform Compatibility[​](index.md#platform-compatibility "Direct link to Platform Compatibility")
...
² See [SSH & Remote Sessions](index.md#ssh--remote-sessions) below
³ The command writes local IDE keybindings and should not be run from the remote host

## Platform-Specific Setup[​](index.md#platform-specific-setup "Direct link to Platform-Specific Setup")
...
### Linux (X11)[​](index.md#linux-x11 "Direct link to Linux (X11)")
...
### Linux (Wayland)[​](index.md#linux-wayland "Direct link to Linux (Wayland)")
...
### WSL2[​](index.md#wsl2 "Direct link to WSL2")
...
#### Verify WSL2 clipboard access[​](index.md#verify-wsl2-clipboard-access "Direct link to Verify WSL2 clipboard access")
...
## SSH & Remote Sessions[​](index.md#ssh--remote-sessions "Direct link to SSH & Remote Sessions")
...
### Workarounds for SSH[​](index.md#workarounds-for-ssh "Direct link to Workarounds for SSH")
...
## Why Terminals Can't Paste Images[​](index.md#why-terminals-cant-paste-images "Direct link to Why Terminals Can't Paste Images")
...
## Supported Models[​](index.md#supported-models "Direct link to Supported Models")
...
## Image Routing (Vision-Capable vs Text-Only Models)[​](index.md#image-routing-vision-capable-vs-text-only-models "Direct link to Image Routing (Vision-Capable vs Text-Only Models)")
...
Which auxiliary model handles the text-description path is configurable under `auxiliary.vision` — see [Auxiliary Models](../../configuration/index.md#auxiliary-models).

- [How It Works](index.md#how-it-works)
- [Paste Methods](index.md#paste-methods)
  - [`/paste` Command](index.md#paste-command)
  - [Ctrl+V / Cmd+V](index.md#ctrlv--cmdv)
  - [`/terminal-setup` for VS Code / Cursor / Windsurf](index.md#terminal-setup-for-vs-code--cursor--windsurf)
- [Platform Compatibility](index.md#platform-compatibility)
- [Platform-Specific Setup](index.md#platform-specific-setup)
  - [macOS](index.md#macos)
  - [Linux (X11)](index.md#linux-x11)
  - [Linux (Wayland)](index.md#linux-wayland)
  - [WSL2](index.md#wsl2)
- [SSH & Remote Sessions](index.md#ssh--remote-sessions)
  - [Workarounds for SSH](index.md#workarounds-for-ssh)
- [Why Terminals Can't Paste Images](index.md#why-terminals-cant-paste-images)
- [Supported Models](index.md#supported-models)
- [Image Routing (Vision-Capable vs Text-Only Models)](index.md#image-routing-vision-capable-vs-text-only-models)
