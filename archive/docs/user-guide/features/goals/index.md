...
title: Persistent Goals | Hermes Agent
...
## When to use it[​](index.md#when-to-use-it "Direct link to When to use it")
...
## Behavior details[​](index.md#behavior-details "Direct link to Behavior details")

### The judge[​](index.md#the-judge "Direct link to The judge")
...
### Fail-open semantics[​](index.md#fail-open-semantics "Direct link to Fail-open semantics")
...
### Turn budget[​](index.md#turn-budget "Direct link to Turn budget")
...
### User messages always preempt[​](index.md#user-messages-always-preempt "Direct link to User messages always preempt")
...
### Mid-run safety (gateway)[​](index.md#mid-run-safety-gateway "Direct link to Mid-run safety (gateway)")
...
### Persistence[​](index.md#persistence "Direct link to Persistence")
...
### Prompt cache[​](index.md#prompt-cache "Direct link to Prompt cache")
...
### Choosing the judge model[​](index.md#choosing-the-judge-model "Direct link to Choosing the judge model")

The judge uses the `goal_judge` auxiliary task. By default it resolves to your main model (see [Auxiliary Models](../../configuration/index.md#auxiliary-models)). If you want to route the judge to a cheap fast model to keep costs down, add an override:
...
## Example walkthrough[​](index.md#example-walkthrough "Direct link to Example walkthrough")
...
## When the judge gets it wrong[​](index.md#when-the-judge-gets-it-wrong "Direct link to When the judge gets it wrong")
...
## Attribution[​](index.md#attribution "Direct link to Attribution")
...
- [When to use it](index.md#when-to-use-it)
- [Quick start](index.md#quick-start)
- [Commands](index.md#commands)
- [Behavior details](index.md#behavior-details)
  - [The judge](index.md#the-judge)
  - [Fail-open semantics](index.md#fail-open-semantics)
  - [Turn budget](index.md#turn-budget)
  - [User messages always preempt](index.md#user-messages-always-preempt)
  - [Mid-run safety (gateway)](index.md#mid-run-safety-gateway)
  - [Persistence](index.md#persistence)
  - [Prompt cache](index.md#prompt-cache)
- [Configuration](index.md#configuration)
  - [Choosing the judge model](index.md#choosing-the-judge-model)
- [Example walkthrough](index.md#example-walkthrough)
- [When the judge gets it wrong](index.md#when-the-judge-gets-it-wrong)
- [Attribution](index.md#attribution)
