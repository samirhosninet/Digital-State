...
## Dataset Format[​](index.md#dataset-format "Direct link to Dataset Format")
...
### Provider Routing (OpenRouter)[​](index.md#provider-routing-openrouter "Direct link to Provider Routing (OpenRouter)")
...
### Reasoning Control[​](index.md#reasoning-control "Direct link to Reasoning Control")
...
### Advanced Options[​](index.md#advanced-options "Direct link to Advanced Options")
...
## Toolset Distributions[​](index.md#toolset-distributions "Direct link to Toolset Distributions")
...
## Output Format[​](index.md#output-format "Direct link to Output Format")
...
### Trajectory Format[​](index.md#trajectory-format "Direct link to Trajectory Format")
...
## Checkpointing[​](index.md#checkpointing "Direct link to Checkpointing")
...
### How Resume Works[​](index.md#how-resume-works "Direct link to How Resume Works")
...
## Quality Filtering[​](index.md#quality-filtering "Direct link to Quality Filtering")
...
## Statistics[​](index.md#statistics "Direct link to Statistics")
...
## Use Cases[​](index.md#use-cases "Direct link to Use Cases")

### Training Data Generation[​](index.md#training-data-generation "Direct link to Training Data Generation")
...
### Model Evaluation[​](index.md#model-evaluation "Direct link to Model Evaluation")
...
### Per-Prompt Container Images[​](index.md#per-prompt-container-images "Direct link to Per-Prompt Container Images")
...
- [Dataset Format](index.md#dataset-format)
- [Configuration Options](index.md#configuration-options)
  - [Provider Routing (OpenRouter)](index.md#provider-routing-openrouter)
  - [Reasoning Control](index.md#reasoning-control)
  - [Advanced Options](index.md#advanced-options)
- [Toolset Distributions](index.md#toolset-distributions)
- [Output Format](index.md#output-format)
  - [Trajectory Format](index.md#trajectory-format)
- [Checkpointing](index.md#checkpointing)
  - [How Resume Works](index.md#how-resume-works)
- [Quality Filtering](index.md#quality-filtering)
- [Statistics](index.md#statistics)
- [Use Cases](index.md#use-cases)
  - [Training Data Generation](index.md#training-data-generation)
  - [Model Evaluation](index.md#model-evaluation)
  - [Per-Prompt Container Images](index.md#per-prompt-container-images)
