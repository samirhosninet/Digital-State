...
If you have a paid [Nous Portal](https://portal.nousresearch.com) subscription, you can use browser automation through the **[Tool Gateway](../tool-gateway/index.md)** without any separate API keys. Run `hermes model` or `hermes tools` to enable it.

### Browserbase cloud mode[​](index.md#browserbase-cloud-mode "Direct link to Browserbase cloud mode")
...
### Browser Use cloud mode[​](index.md#browser-use-cloud-mode "Direct link to Browser Use cloud mode")
...
### Firecrawl cloud mode[​](index.md#firecrawl-cloud-mode "Direct link to Firecrawl cloud mode")
...
### Hybrid routing: cloud for public URLs, local for LAN/localhost[​](index.md#hybrid-routing-cloud-for-public-urls-local-for-lanlocalhost "Direct link to Hybrid routing: cloud for public URLs, local for LAN/localhost")
...
### Camofox local mode[​](index.md#camofox-local-mode "Direct link to Camofox local mode")
...
#### Persistent browser sessions[​](index.md#persistent-browser-sessions "Direct link to Persistent browser sessions")
...
##### What Hermes does[​](index.md#what-hermes-does "Direct link to What Hermes does")
...
##### What Hermes does not do[​](index.md#what-hermes-does-not-do "Direct link to What Hermes does not do")
...
##### Verify it's working[​](index.md#verify-its-working "Direct link to Verify it's working")
...
##### Where state lives[​](index.md#where-state-lives "Direct link to Where state lives")
...
#### Externally managed Camofox sessions[​](index.md#externally-managed-camofox-sessions "Direct link to Externally managed Camofox sessions")
...
#### VNC live view[​](index.md#vnc-live-view "Direct link to VNC live view")
...
### Local Chrome via CDP (`/browser connect`)[​](index.md#local-chrome-via-cdp-browser-connect "Direct link to local-chrome-via-cdp-browser-connect")
...
### WSL2 + Windows Chrome: prefer MCP over `/browser connect`[​](index.md#wsl2--windows-chrome-prefer-mcp-over-browser-connect "Direct link to wsl2--windows-chrome-prefer-mcp-over-browser-connect")
...
### Local browser mode[​](index.md#local-browser-mode "Direct link to Local browser mode")
...
### Optional Environment Variables[​](index.md#optional-environment-variables "Direct link to Optional Environment Variables")
...
### Install agent-browser CLI[​](index.md#install-agent-browser-cli "Direct link to Install agent-browser CLI")
...
### `browser_navigate`[​](index.md#browser_navigate "Direct link to browser_navigate")
...
### `browser_snapshot`[​](index.md#browser_snapshot "Direct link to browser_snapshot")
...
### `browser_click`[​](index.md#browser_click "Direct link to browser_click")
...
### `browser_type`[​](index.md#browser_type "Direct link to browser_type")
...
### `browser_scroll`[​](index.md#browser_scroll "Direct link to browser_scroll")
...
### `browser_press`[​](index.md#browser_press "Direct link to browser_press")
...
### `browser_back`[​](index.md#browser_back "Direct link to browser_back")

Navigate back to the previous page in browser history.

### `browser_get_images`[​](index.md#browser_get_images "Direct link to browser_get_images")

List all images on the current page with their URLs and alt text. Useful for finding images to analyze.

### `browser_vision`[​](index.md#browser_vision "Direct link to browser_vision")
...
### `browser_console`[​](index.md#browser_console "Direct link to browser_console")
...
### `browser_cdp`[​](index.md#browser_cdp "Direct link to browser_cdp")
...
### `browser_dialog`[​](index.md#browser_dialog "Direct link to browser_dialog")
...
### Filling Out a Web Form[​](index.md#filling-out-a-web-form "Direct link to Filling Out a Web Form")
...
### Researching Dynamic Content[​](index.md#researching-dynamic-content "Direct link to Researching Dynamic Content")
...
## Session Recording[​](index.md#session-recording "Direct link to Session Recording")
...
## Stealth Features[​](index.md#stealth-features "Direct link to Stealth Features")
...
## Session Management[​](index.md#session-management "Direct link to Session Management")
...
- [Setup](index.md#setup)
  - [Browserbase cloud mode](index.md#browserbase-cloud-mode)
  - [Browser Use cloud mode](index.md#browser-use-cloud-mode)
  - [Firecrawl cloud mode](index.md#firecrawl-cloud-mode)
  - [Hybrid routing: cloud for public URLs, local for LAN/localhost](index.md#hybrid-routing-cloud-for-public-urls-local-for-lanlocalhost)
  - [Camofox local mode](index.md#camofox-local-mode)
  - [Local Chrome via CDP (`/browser connect`)](index.md#local-chrome-via-cdp-browser-connect)
  - [WSL2 + Windows Chrome: prefer MCP over `/browser connect`](index.md#wsl2--windows-chrome-prefer-mcp-over-browser-connect)
  - [Local browser mode](index.md#local-browser-mode)
  - [Optional Environment Variables](index.md#optional-environment-variables)
  - [Install agent-browser CLI](index.md#install-agent-browser-cli)
- [Available Tools](index.md#available-tools)
  - [`browser_navigate`](index.md#browser_navigate)
  - [`browser_snapshot`](index.md#browser_snapshot)
  - [`browser_click`](index.md#browser_click)
  - [`browser_type`](index.md#browser_type)
  - [`browser_scroll`](index.md#browser_scroll)
  - [`browser_press`](index.md#browser_press)
  - [`browser_back`](index.md#browser_back)
  - [`browser_get_images`](index.md#browser_get_images)
  - [`browser_vision`](index.md#browser_vision)
  - [`browser_console`](index.md#browser_console)
  - [`browser_cdp`](index.md#browser_cdp)
  - [`browser_dialog`](index.md#browser_dialog)
- [Practical Examples](index.md#practical-examples)
  - [Filling Out a Web Form](index.md#filling-out-a-web-form)
  - [Researching Dynamic Content](index.md#researching-dynamic-content)
- [Session Recording](index.md#session-recording)
- [Stealth Features](index.md#stealth-features)
