...
## Single Task[​](index.md#single-task "Direct link to Single Task")
...
## Parallel Batch[​](index.md#parallel-batch "Direct link to Parallel Batch")
...
## How Subagent Context Works[​](index.md#how-subagent-context-works "Direct link to How Subagent Context Works")
...
### Parallel Research[​](index.md#parallel-research "Direct link to Parallel Research")
...
### Code Review + Fix[​](index.md#code-review--fix "Direct link to Code Review + Fix")
...
### Multi-File Refactoring[​](index.md#multi-file-refactoring "Direct link to Multi-File Refactoring")
...
## Batch Mode Details[​](index.md#batch-mode-details "Direct link to Batch Mode Details")
...
## Model Override[​](index.md#model-override "Direct link to Model Override")
...
## Toolset Selection Tips[​](index.md#toolset-selection-tips "Direct link to Toolset Selection Tips")
...
- `delegation` — blocked for leaf subagents (the default). Retained for `role="orchestrator"` children, bounded by `max_spawn_depth` — see [Depth Limit and Nested Orchestration](index.md#depth-limit-and-nested-orchestration) below.
...
## Max Iterations[​](index.md#max-iterations "Direct link to Max Iterations")
...
## Child Timeout[​](index.md#child-timeout "Direct link to Child Timeout")
...
## Monitoring Running Subagents (`/agents`)[​](index.md#monitoring-running-subagents-agents "Direct link to monitoring-running-subagents-agents")
...
The classic CLI just prints `/agents` as a text summary; the TUI is where the overlay shines. See [TUI — Slash commands](../../tui/index.md#slash-commands).

## Depth Limit and Nested Orchestration[​](index.md#depth-limit-and-nested-orchestration "Direct link to Depth Limit and Nested Orchestration")
...
## Lifetime and Durability[​](index.md#lifetime-and-durability "Direct link to Lifetime and Durability")
...
## Key Properties[​](index.md#key-properties "Direct link to Key Properties")
...
## Delegation vs execute\_code[​](index.md#delegation-vs-execute_code "Direct link to Delegation vs execute_code")
...
- [Single Task](index.md#single-task)
- [Parallel Batch](index.md#parallel-batch)
- [How Subagent Context Works](index.md#how-subagent-context-works)
- [Practical Examples](index.md#practical-examples)
  - [Parallel Research](index.md#parallel-research)
  - [Code Review + Fix](index.md#code-review--fix)
  - [Multi-File Refactoring](index.md#multi-file-refactoring)
- [Batch Mode Details](index.md#batch-mode-details)
- [Model Override](index.md#model-override)
- [Toolset Selection Tips](index.md#toolset-selection-tips)
- [Max Iterations](index.md#max-iterations)
- [Child Timeout](index.md#child-timeout)
- [Monitoring Running Subagents (`/agents`)](index.md#monitoring-running-subagents-agents)
- [Depth Limit and Nested Orchestration](index.md#depth-limit-and-nested-orchestration)
- [Lifetime and Durability](index.md#lifetime-and-durability)
- [Key Properties](index.md#key-properties)
- [Delegation vs execute\_code](index.md#delegation-vs-execute_code)
