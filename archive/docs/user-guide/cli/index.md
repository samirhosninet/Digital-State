...
Hermes also ships a modern TUI with modal overlays, mouse selection, and non-blocking input. Launch it with `hermes --tui` — see the [TUI](../tui/index.md) guide.

## Running the CLI[​](index.md#running-the-cli "Direct link to Running the CLI")
...
## Interface Layout[​](index.md#interface-layout "Direct link to Interface Layout")
...
### Status Bar[​](index.md#status-bar "Direct link to Status Bar")
...
### Session Resume Display[​](index.md#session-resume-display "Direct link to Session Resume Display")
...
## Preloading Skills at Launch[​](index.md#preloading-skills-at-launch "Direct link to Preloading Skills at Launch")
...
## Skill Slash Commands[​](index.md#skill-slash-commands "Direct link to Skill Slash Commands")
...
## Personalities[​](index.md#personalities "Direct link to Personalities")
...
### Shift+Enter compatibility[​](index.md#shiftenter-compatibility "Direct link to Shift+Enter compatibility")
...
## Interrupting the Agent[​](index.md#interrupting-the-agent "Direct link to Interrupting the Agent")
...
### Busy Input Mode[​](index.md#busy-input-mode "Direct link to Busy Input Mode")
...
### Suspending to Background[​](index.md#suspending-to-background "Direct link to Suspending to Background")
...
## Tool Progress Display[​](index.md#tool-progress-display "Direct link to Tool Progress Display")
...
Cycle through display modes with `/verbose`: `off → new → all → verbose`. This command can also be enabled for messaging platforms — see [configuration](../configuration/index.md#display-settings).

### Tool Preview Length[​](index.md#tool-preview-length "Direct link to Tool Preview Length")
...
### Resuming Sessions[​](index.md#resuming-sessions "Direct link to Resuming Sessions")
...
### Session Storage[​](index.md#session-storage "Direct link to Session Storage")
...
## Background Sessions[​](index.md#background-sessions "Direct link to Background Sessions")
...
## Quiet Mode[​](index.md#quiet-mode "Direct link to Quiet Mode")
