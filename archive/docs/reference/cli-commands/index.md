...
For in-chat slash commands, see [Slash Commands Reference](../slash-commands/index.md).

## Global entrypoint[​](index.md#global-entrypoint "Direct link to Global entrypoint")

```
hermes [global-options] <command> [subcommand/options]
```

### Global options[​](index.md#global-options "Direct link to Global options")
...
| `--tui` | Launch the [TUI](../../user-guide/tui/index.md) instead of the classic CLI. Equivalent to `HERMES_TUI=1`. |
| `--dev` | With `--tui`: run the TypeScript sources directly via `tsx` instead of the prebuilt bundle (for TUI contributors). |

## Top-level commands[​](index.md#top-level-commands "Direct link to Top-level commands")
...
| `hermes lsp` | Manage Language Server Protocol integration (semantic diagnostics for write\_file/patch). |
...
| `hermes curator` | Background skill maintenance — status, run, pause, pin. See [Curator](../../user-guide/features/curator/index.md). |
...
## `hermes chat`[​](index.md#hermes-chat "Direct link to hermes-chat")
...
### `hermes -z <prompt>` — scripted one-shot[​](index.md#hermes--z-prompt--scripted-one-shot "Direct link to hermes--z-prompt--scripted-one-shot")
...
## `hermes model`[​](index.md#hermes-model "Direct link to hermes-model")
...
### `/model` slash command (mid-session)[​](index.md#model-slash-command-mid-session "Direct link to model-slash-command-mid-session")
...
## `hermes gateway`[​](index.md#hermes-gateway "Direct link to hermes-gateway")
...
Use `hermes gateway run` instead of `hermes gateway start` — WSL's systemd support is unreliable. Wrap it in tmux for persistence: `tmux new -s hermes 'hermes gateway run'`. See [WSL FAQ](../faq/index.md#wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails) for details.

## `hermes lsp`[​](index.md#hermes-lsp "Direct link to hermes-lsp")
...
See [LSP — Semantic Diagnostics](../../user-guide/features/lsp/index.md) for
the full guide, supported languages, and configuration knobs.

## `hermes setup`[​](index.md#hermes-setup "Direct link to hermes-setup")
...
## `hermes whatsapp`[​](index.md#hermes-whatsapp "Direct link to hermes-whatsapp")
...
## `hermes slack`[​](index.md#hermes-slack "Direct link to hermes-slack")
...
## `hermes login` / `hermes logout` *(Deprecated)*[​](index.md#hermes-login--hermes-logout-deprecated "Direct link to hermes-login--hermes-logout-deprecated")
...
## `hermes auth`[​](index.md#hermes-auth "Direct link to hermes-auth")

Manage credential pools for same-provider key rotation. See [Credential Pools](../../user-guide/features/credential-pools/index.md) for full documentation.
...
## `hermes status`[​](index.md#hermes-status "Direct link to hermes-status")
...
## `hermes cron`[​](index.md#hermes-cron "Direct link to hermes-cron")
...
## `hermes kanban`[​](index.md#hermes-kanban "Direct link to hermes-kanban")
...
For the full design — comparison with Cline Kanban / Paperclip / NanoClaw / Gemini Enterprise, eight collaboration patterns, four user stories, concurrency correctness proof — see `docs/hermes-kanban-v1-spec.pdf` in the repository or the [Kanban user guide](../../user-guide/features/kanban/index.md).

## `hermes webhook`[​](index.md#hermes-webhook "Direct link to hermes-webhook")
...
### `hermes webhook subscribe`[​](index.md#hermes-webhook-subscribe "Direct link to hermes-webhook-subscribe")
...
## `hermes doctor`[​](index.md#hermes-doctor "Direct link to hermes-doctor")
...
## `hermes dump`[​](index.md#hermes-dump "Direct link to hermes-dump")
...
### What it includes[​](index.md#what-it-includes "Direct link to What it includes")

| Section | Details |
| --- | --- |
| **Header** | Hermes version, release date, git commit hash |
| **Environment** | OS, Python version, OpenAI SDK version |
| **Identity** | Active profile name, HERMES\_HOME path |
...
### Example output[​](index.md#example-output "Direct link to Example output")
...
### When to use[​](index.md#when-to-use "Direct link to When to use")
...
## `hermes debug`[​](index.md#hermes-debug "Direct link to hermes-debug")
...
## `hermes backup`[​](index.md#hermes-backup "Direct link to hermes-backup")
...
### Examples[​](index.md#examples-1 "Direct link to Examples")
...
## `hermes checkpoints`[​](index.md#hermes-checkpoints "Direct link to hermes-checkpoints")
...
### Examples[​](index.md#examples-2 "Direct link to Examples")
...
See [Checkpoints and `/rollback`](../../user-guide/checkpoints-and-rollback/index.md) for the full architecture and the in-session commands.

## `hermes import`[​](index.md#hermes-import "Direct link to hermes-import")
...
### Examples[​](index.md#examples-3 "Direct link to Examples")
...
## `hermes logs`[​](index.md#hermes-logs "Direct link to hermes-logs")
...
### Log files[​](index.md#log-files "Direct link to Log files")
...
### Options[​](index.md#options-1 "Direct link to Options")
...
### Examples[​](index.md#examples-4 "Direct link to Examples")
...
### Filtering[​](index.md#filtering "Direct link to Filtering")
...
### Log rotation[​](index.md#log-rotation "Direct link to Log rotation")
...
## `hermes config`[​](index.md#hermes-config "Direct link to hermes-config")
...
## `hermes pairing`[​](index.md#hermes-pairing "Direct link to hermes-pairing")
...
## `hermes skills`[​](index.md#hermes-skills "Direct link to hermes-skills")
...
## `hermes curator`[​](index.md#hermes-curator "Direct link to hermes-curator")
...
See [Curator](../../user-guide/features/curator/index.md) for behavior and config.

## `hermes fallback`[​](index.md#hermes-fallback "Direct link to hermes-fallback")
...
See [Fallback Providers](../../user-guide/features/fallback-providers/index.md).

## `hermes hooks`[​](index.md#hermes-hooks "Direct link to hermes-hooks")
...
See [Hooks](../../user-guide/features/hooks/index.md) for event signatures and payload shapes.

## `hermes memory`[​](index.md#hermes-memory "Direct link to hermes-memory")
...
## `hermes acp`[​](index.md#hermes-acp "Direct link to hermes-acp")
...
See [ACP Editor Integration](../../user-guide/features/acp/index.md) and [ACP Internals](../../developer-guide/acp-internals/index.md).

## `hermes mcp`[​](index.md#hermes-mcp "Direct link to hermes-mcp")
...
See [MCP Config Reference](../mcp-config-reference/index.md), [Use MCP with Hermes](../../guides/use-mcp-with-hermes/index.md), and [MCP Server Mode](../../user-guide/features/mcp/index.md#running-hermes-as-an-mcp-server).

## `hermes plugins`[​](index.md#hermes-plugins "Direct link to hermes-plugins")
...
See [Plugins](../../user-guide/features/plugins/index.md) and [Build a Hermes Plugin](../../guides/build-a-hermes-plugin/index.md).

## `hermes tools`[​](index.md#hermes-tools "Direct link to hermes-tools")
...
## `hermes computer-use`[​](index.md#hermes-computer-use "Direct link to hermes-computer-use")
...
## `hermes sessions`[​](index.md#hermes-sessions "Direct link to hermes-sessions")
...
## `hermes insights`[​](index.md#hermes-insights "Direct link to hermes-insights")
...
## `hermes claw`[​](index.md#hermes-claw "Direct link to hermes-claw")
...
### What gets migrated[​](index.md#what-gets-migrated "Direct link to What gets migrated")
...
For the complete config key mapping, SecretRef handling details, and post-migration checklist, see the **[full migration guide](../../guides/migrate-from-openclaw/index.md)**.

### Examples[​](index.md#examples-5 "Direct link to Examples")
...
## `hermes dashboard`[​](index.md#hermes-dashboard "Direct link to hermes-dashboard")

```
hermes dashboard [options]
```

Launch the web dashboard — a browser-based UI for managing configuration, API keys, and monitoring sessions. Requires `pip install hermes-agent[web]` (FastAPI + Uvicorn). See [Web Dashboard](../../user-guide/features/web-dashboard/index.md) for full documentation.
...
## `hermes profile`[​](index.md#hermes-profile "Direct link to hermes-profile")
...
## `hermes completion`[​](index.md#hermes-completion "Direct link to hermes-completion")
...
## `hermes update`[​](index.md#hermes-update "Direct link to hermes-update")
...
## Maintenance commands[​](index.md#maintenance-commands "Direct link to Maintenance commands")
...
- [CLI Interface](../../user-guide/cli/index.md)
- [Sessions](../../user-guide/sessions/index.md)
- [Skills System](../../user-guide/features/skills/index.md)
- [Skins & Themes](../../user-guide/features/skins/index.md)

- [Global entrypoint](index.md#global-entrypoint)
  - [Global options](index.md#global-options)
- [Top-level commands](index.md#top-level-commands)
- [`hermes chat`](index.md#hermes-chat)
  - [`hermes -z <prompt>` — scripted one-shot](index.md#hermes--z-prompt--scripted-one-shot)
- [`hermes model`](index.md#hermes-model)
  - [`/model` slash command (mid-session)](index.md#model-slash-command-mid-session)
- [`hermes gateway`](index.md#hermes-gateway)
- [`hermes lsp`](index.md#hermes-lsp)
- [`hermes setup`](index.md#hermes-setup)
- [`hermes whatsapp`](index.md#hermes-whatsapp)
- [`hermes slack`](index.md#hermes-slack)
- [`hermes login` / `hermes logout` *(Deprecated)*](index.md#hermes-login--hermes-logout-deprecated)
- [`hermes auth`](index.md#hermes-auth)
- [`hermes status`](index.md#hermes-status)
- [`hermes cron`](index.md#hermes-cron)
- [`hermes kanban`](index.md#hermes-kanban)
- [`hermes webhook`](index.md#hermes-webhook)
  - [`hermes webhook subscribe`](index.md#hermes-webhook-subscribe)
- [`hermes doctor`](index.md#hermes-doctor)
- [`hermes dump`](index.md#hermes-dump)
  - [What it includes](index.md#what-it-includes)
  - [Example output](index.md#example-output)
  - [When to use](index.md#when-to-use)
- [`hermes debug`](index.md#hermes-debug)
  - [Examples](index.md#examples)
- [`hermes backup`](index.md#hermes-backup)
  - [Examples](index.md#examples-1)
- [`hermes checkpoints`](index.md#hermes-checkpoints)
  - [Options](index.md#options)
  - [Examples](index.md#examples-2)
- [`hermes import`](index.md#hermes-import)
  - [Examples](index.md#examples-3)
- [`hermes logs`](index.md#hermes-logs)
  - [Log files](index.md#log-files)
  - [Options](index.md#options-1)
  - [Examples](index.md#examples-4)
  - [Filtering](index.md#filtering)
  - [Log rotation](index.md#log-rotation)
- [`hermes config`](index.md#hermes-config)
- [`hermes pairing`](index.md#hermes-pairing)
- [`hermes skills`](index.md#hermes-skills)
- [`hermes curator`](index.md#hermes-curator)
- [`hermes fallback`](index.md#hermes-fallback)
- [`hermes hooks`](index.md#hermes-hooks)
- [`hermes memory`](index.md#hermes-memory)
- [`hermes acp`](index.md#hermes-acp)
- [`hermes mcp`](index.md#hermes-mcp)
- [`hermes plugins`](index.md#hermes-plugins)
- [`hermes tools`](index.md#hermes-tools)
- [`hermes computer-use`](index.md#hermes-computer-use)
- [`hermes sessions`](index.md#hermes-sessions)
- [`hermes insights`](index.md#hermes-insights)
- [`hermes claw`](index.md#hermes-claw)
  - [What gets migrated](index.md#what-gets-migrated)
  - [Examples](index.md#examples-5)
- [`hermes dashboard`](index.md#hermes-dashboard)
- [`hermes profile`](index.md#hermes-profile)
- [`hermes completion`](index.md#hermes-completion)
- [`hermes update`](index.md#hermes-update)
- [Maintenance commands](index.md#maintenance-commands)
