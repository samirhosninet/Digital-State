...
## How Toolsets Work[​](index.md#how-toolsets-work "Direct link to How Toolsets Work")
...
## Configuring Toolsets[​](index.md#configuring-toolsets "Direct link to Configuring Toolsets")

### Per-session (CLI)[​](index.md#per-session-cli "Direct link to Per-session (CLI)")
...
### Per-platform (config.yaml)[​](index.md#per-platform-configyaml "Direct link to Per-platform (config.yaml)")
...
### Interactive management[​](index.md#interactive-management "Direct link to Interactive management")
...
## Core Toolsets[​](index.md#core-toolsets "Direct link to Core Toolsets")
...
## Platform Toolsets[​](index.md#platform-toolsets "Direct link to Platform Toolsets")
...
| --- | --- |
| `hermes-cli` | Full toolset — the default for interactive CLI sessions. Includes file, terminal, web, browser, memory, skills, vision, image\_gen, todo, tts, delegation, code\_execution, cronjob, session\_search, clarify, and `safe` (read-only) bundles plus the standard messaging tools. |
...
## Dynamic Toolsets[​](index.md#dynamic-toolsets "Direct link to Dynamic Toolsets")

### MCP server toolsets[​](index.md#mcp-server-toolsets "Direct link to MCP server toolsets")
...
### Plugin toolsets[​](index.md#plugin-toolsets "Direct link to Plugin toolsets")
...
### Custom toolsets[​](index.md#custom-toolsets "Direct link to Custom toolsets")
...
### Wildcards[​](index.md#wildcards "Direct link to Wildcards")

- `all` or `*` — expands to every registered toolset (built-in + dynamic + plugin)

## Relationship to `hermes tools`[​](index.md#relationship-to-hermes-tools "Direct link to relationship-to-hermes-tools")
...
See also: [Tools Reference](../tools-reference/index.md) for the complete list of individual tools and their parameters.

- [How Toolsets Work](index.md#how-toolsets-work)
- [Configuring Toolsets](index.md#configuring-toolsets)
  - [Per-session (CLI)](index.md#per-session-cli)
  - [Per-platform (config.yaml)](index.md#per-platform-configyaml)
  - [Interactive management](index.md#interactive-management)
- [Core Toolsets](index.md#core-toolsets)
- [Platform Toolsets](index.md#platform-toolsets)
- [Dynamic Toolsets](index.md#dynamic-toolsets)
  - [MCP server toolsets](index.md#mcp-server-toolsets)
  - [Plugin toolsets](index.md#plugin-toolsets)
  - [Custom toolsets](index.md#custom-toolsets)
  - [Wildcards](index.md#wildcards)
- [Relationship to `hermes tools`](index.md#relationship-to-hermes-tools)
