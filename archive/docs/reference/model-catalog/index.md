...
## Live manifest URL[​](index.md#live-manifest-url "Direct link to Live manifest URL")
...
## Schema[​](index.md#schema "Direct link to Schema")
...
## Fetch behavior[​](index.md#fetch-behavior "Direct link to Fetch behavior")
...
## Config[​](index.md#config "Direct link to Config")
...
### Per-provider override URLs[​](index.md#per-provider-override-urls "Direct link to Per-provider override URLs")
...
## Updating the manifest[​](index.md#updating-the-manifest "Direct link to Updating the manifest")
...
- [Live manifest URL](index.md#live-manifest-url)
- [Schema](index.md#schema)
- [Fetch behavior](index.md#fetch-behavior)
- [Config](index.md#config)
  - [Per-provider override URLs](index.md#per-provider-override-urls)
- [Updating the manifest](index.md#updating-the-manifest)
