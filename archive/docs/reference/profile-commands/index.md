...
title: Profile Commands Reference | Hermes Agent
archived_at: 2026-05-13T02:40:25Z
---

This page covers all commands related to [Hermes profiles](../../user-guide/profiles/index.md). For general CLI commands, see [CLI Commands Reference](../cli-commands/index.md).
...
| `install` | Install a profile distribution from a git URL or local directory. See [Profile Distributions](../../user-guide/profile-distributions/index.md). |
...
## `hermes profile list`[​](index.md#hermes-profile-list "Direct link to hermes-profile-list")
...
## `hermes profile use`[​](index.md#hermes-profile-use "Direct link to hermes-profile-use")
...
## `hermes profile create`[​](index.md#hermes-profile-create "Direct link to hermes-profile-create")
...
## `hermes profile delete`[​](index.md#hermes-profile-delete "Direct link to hermes-profile-delete")
...
## `hermes profile show`[​](index.md#hermes-profile-show "Direct link to hermes-profile-show")
...
## `hermes profile alias`[​](index.md#hermes-profile-alias "Direct link to hermes-profile-alias")
...
## `hermes profile rename`[​](index.md#hermes-profile-rename "Direct link to hermes-profile-rename")
...
## `hermes profile export`[​](index.md#hermes-profile-export "Direct link to hermes-profile-export")
...
## `hermes profile import`[​](index.md#hermes-profile-import "Direct link to hermes-profile-import")
...
## Distribution commands[​](index.md#distribution-commands "Direct link to Distribution commands")

tip

**New to distributions?** Start with the [Profile Distributions user guide](../../user-guide/profile-distributions/index.md) — it covers the why, when, and how with full examples. The sections below are a dry CLI reference for when you know what you want.
...
### `hermes profile install`[​](index.md#hermes-profile-install "Direct link to hermes-profile-install")
...
### `hermes profile update`[​](index.md#hermes-profile-update "Direct link to hermes-profile-update")
...
### `hermes profile info`[​](index.md#hermes-profile-info "Direct link to hermes-profile-info")
...
### Private distributions[​](index.md#private-distributions "Direct link to Private distributions")
...
### Distribution manifest (`distribution.yaml`)[​](index.md#distribution-manifest-distributionyaml "Direct link to distribution-manifest-distributionyaml")
...
### Publishing a distribution[​](index.md#publishing-a-distribution "Direct link to Publishing a distribution")
...
## `hermes -p` / `hermes --profile`[​](index.md#hermes--p--hermes---profile "Direct link to hermes--p--hermes---profile")
...
- [Profiles User Guide](../../user-guide/profiles/index.md)
- [CLI Commands Reference](../cli-commands/index.md)
- [FAQ — Profiles section](../faq/index.md#profiles)

- [`hermes profile`](index.md#hermes-profile)
- [`hermes profile list`](index.md#hermes-profile-list)
- [`hermes profile use`](index.md#hermes-profile-use)
- [`hermes profile create`](index.md#hermes-profile-create)
- [`hermes profile delete`](index.md#hermes-profile-delete)
- [`hermes profile show`](index.md#hermes-profile-show)
- [`hermes profile alias`](index.md#hermes-profile-alias)
- [`hermes profile rename`](index.md#hermes-profile-rename)
- [`hermes profile export`](index.md#hermes-profile-export)
- [`hermes profile import`](index.md#hermes-profile-import)
- [Distribution commands](index.md#distribution-commands)
  - [`hermes profile install`](index.md#hermes-profile-install)
  - [`hermes profile update`](index.md#hermes-profile-update)
  - [`hermes profile info`](index.md#hermes-profile-info)
  - [Private distributions](index.md#private-distributions)
  - [Distribution manifest (`distribution.yaml`)](index.md#distribution-manifest-distributionyaml)
  - [Publishing a distribution](index.md#publishing-a-distribution)
- [`hermes -p` / `hermes --profile`](index.md#hermes--p--hermes---profile)
