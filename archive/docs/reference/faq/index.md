...
title: FAQ & Troubleshooting | Hermes Agent
...
## Frequently Asked Questions[​](index.md#frequently-asked-questions "Direct link to Frequently Asked Questions")

### What LLM providers work with Hermes?[​](index.md#what-llm-providers-work-with-hermes "Direct link to What LLM providers work with Hermes?")
...
Set your provider with `hermes model` or by editing `~/.hermes/.env`. See the [Environment Variables](../environment-variables/index.md) reference for all provider keys.

### Does it work on Windows?[​](index.md#does-it-work-on-windows "Direct link to Does it work on Windows?")
...
### I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?[​](index.md#i-run-hermes-in-wsl2-whats-the-best-way-to-control-my-normal-windows-chrome "Direct link to I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?")
...
- [Use MCP with Hermes](../../guides/use-mcp-with-hermes/index.md#wsl2-bridge-hermes-in-wsl-to-windows-chrome)
- [Browser Automation](../../user-guide/features/browser/index.md#wsl2--windows-chrome-prefer-mcp-over-browser-connect)

### Does it work on Android / Termux?[​](index.md#does-it-work-on-android--termux "Direct link to Does it work on Android / Termux?")
...
For the fully explicit manual steps, supported extras, and current limitations, see the [Termux guide](../../getting-started/termux/index.md).
...
### Is my data sent anywhere?[​](index.md#is-my-data-sent-anywhere "Direct link to Is my data sent anywhere?")
...
### Can I use it offline / with local models?[​](index.md#can-i-use-it-offline--with-local-models "Direct link to Can I use it offline / with local models?")
...
This works with Ollama, vLLM, llama.cpp server, SGLang, LocalAI, and others. See the [Configuration guide](../../user-guide/configuration/index.md) for details.
...
### Can multiple people use one instance?[​](index.md#can-multiple-people-use-one-instance "Direct link to Can multiple people use one instance?")
...
### What's the difference between memory and skills?[​](index.md#whats-the-difference-between-memory-and-skills "Direct link to What's the difference between memory and skills?")
...
Both persist across sessions. See [Memory](../../user-guide/features/memory/index.md) and [Skills](../../user-guide/features/skills/index.md) for details.

### Can I use it in my own Python project?[​](index.md#can-i-use-it-in-my-own-python-project "Direct link to Can I use it in my own Python project?")
...
See the [Python Library guide](../../user-guide/features/code-execution/index.md) for full API usage.

---

## Troubleshooting[​](index.md#troubleshooting "Direct link to Troubleshooting")

### Installation Issues[​](index.md#installation-issues "Direct link to Installation Issues")

#### `hermes: command not found` after installation[​](index.md#hermes-command-not-found-after-installation "Direct link to hermes-command-not-found-after-installation")
...
#### Python version too old[​](index.md#python-version-too-old "Direct link to Python version too old")
...
#### Terminal commands say `node: command not found` (or `nvm`, `pyenv`, `asdf`, …)[​](index.md#terminal-commands-say-node-command-not-found-or-nvm-pyenv-asdf- "Direct link to terminal-commands-say-node-command-not-found-or-nvm-pyenv-asdf-")
...
#### `uv: command not found`[​](index.md#uv-command-not-found "Direct link to uv-command-not-found")
...
#### Permission denied errors during install[​](index.md#permission-denied-errors-during-install "Direct link to Permission denied errors during install")
...
### Provider & Model Issues[​](index.md#provider--model-issues "Direct link to Provider & Model Issues")

#### `/model` only shows one provider / can't switch providers[​](index.md#model-only-shows-one-provider--cant-switch-providers "Direct link to model-only-shows-one-provider--cant-switch-providers")
...
#### API key not working[​](index.md#api-key-not-working "Direct link to API key not working")
...
#### Model not available / model not found[​](index.md#model-not-available--model-not-found "Direct link to Model not available / model not found")
...
#### Rate limiting (429 errors)[​](index.md#rate-limiting-429-errors "Direct link to Rate limiting (429 errors)")
...
#### Context length exceeded[​](index.md#context-length-exceeded "Direct link to Context length exceeded")
...
See [Context Length Detection](../../integrations/providers/index.md#context-length-detection) for how auto-detection works and all override options.

---

### Terminal Issues[​](index.md#terminal-issues "Direct link to Terminal Issues")

#### Command blocked as dangerous[​](index.md#command-blocked-as-dangerous "Direct link to Command blocked as dangerous")
...
- See the full list of dangerous patterns in the [Security docs](../../user-guide/security/index.md)
...
#### `sudo` not working via messaging gateway[​](index.md#sudo-not-working-via-messaging-gateway "Direct link to sudo-not-working-via-messaging-gateway")
...
#### Docker backend not connecting[​](index.md#docker-backend-not-connecting "Direct link to Docker backend not connecting")
...
### Messaging Issues[​](index.md#messaging-issues "Direct link to Messaging Issues")

#### Bot not responding to messages[​](index.md#bot-not-responding-to-messages "Direct link to Bot not responding to messages")
...
#### Messages not delivering[​](index.md#messages-not-delivering "Direct link to Messages not delivering")
...
#### Allowlist confusion — who can talk to the bot?[​](index.md#allowlist-confusion--who-can-talk-to-the-bot "Direct link to Allowlist confusion — who can talk to the bot?")
...
#### Gateway won't start[​](index.md#gateway-wont-start "Direct link to Gateway won't start")
...
#### WSL: Gateway keeps disconnecting or `hermes gateway start` fails[​](index.md#wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails "Direct link to wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails")
...
#### macOS: Node.js / ffmpeg / other tools not found by gateway[​](index.md#macos-nodejs--ffmpeg--other-tools-not-found-by-gateway "Direct link to macOS: Node.js / ffmpeg / other tools not found by gateway")
...
### Performance Issues[​](index.md#performance-issues "Direct link to Performance Issues")

#### Slow responses[​](index.md#slow-responses "Direct link to Slow responses")
...
#### High token usage[​](index.md#high-token-usage "Direct link to High token usage")
...
#### Session getting too long[​](index.md#session-getting-too-long "Direct link to Session getting too long")
...
### MCP Issues[​](index.md#mcp-issues "Direct link to MCP Issues")
...
#### Tools not showing up from MCP server[​](index.md#tools-not-showing-up-from-mcp-server "Direct link to Tools not showing up from MCP server")
...
- [MCP Config Reference](../mcp-config-reference/index.md)

#### MCP timeout errors[​](index.md#mcp-timeout-errors "Direct link to MCP timeout errors")
...
## Profiles[​](index.md#profiles "Direct link to Profiles")

### How do profiles differ from just setting HERMES\_HOME?[​](index.md#how-do-profiles-differ-from-just-setting-hermes_home "Direct link to How do profiles differ from just setting HERMES_HOME?")
...
### Can two profiles share the same bot token?[​](index.md#can-two-profiles-share-the-same-bot-token "Direct link to Can two profiles share the same bot token?")
...
### Do profiles share memory or sessions?[​](index.md#do-profiles-share-memory-or-sessions "Direct link to Do profiles share memory or sessions?")
...
### What happens when I run `hermes update`?[​](index.md#what-happens-when-i-run-hermes-update "Direct link to what-happens-when-i-run-hermes-update")
...
### How many profiles can I run?[​](index.md#how-many-profiles-can-i-run "Direct link to How many profiles can I run?")
...
## Workflows & Patterns[​](index.md#workflows--patterns "Direct link to Workflows & Patterns")

### Using different models for different tasks (multi-model workflows)[​](index.md#using-different-models-for-different-tasks-multi-model-workflows "Direct link to Using different models for different tasks (multi-model workflows)")
...
See [Subagent Delegation](../../user-guide/features/delegation/index.md) for more on how delegation works.

### Running multiple agents on one WhatsApp number (per-chat binding)[​](index.md#running-multiple-agents-on-one-whatsapp-number-per-chat-binding "Direct link to Running multiple agents on one WhatsApp number (per-chat binding)")
...
See [Profiles](../../user-guide/profiles/index.md) and [WhatsApp setup](../../user-guide/messaging/whatsapp/index.md) for more details.

### Controlling what shows up in Telegram (hiding logs and reasoning)[​](index.md#controlling-what-shows-up-in-telegram-hiding-logs-and-reasoning "Direct link to Controlling what shows up in Telegram (hiding logs and reasoning)")
...
### Managing skills on Telegram (slash command limit)[​](index.md#managing-skills-on-telegram-slash-command-limit "Direct link to Managing skills on Telegram (slash command limit)")
...
### Shared thread sessions (multiple users, one conversation)[​](index.md#shared-thread-sessions-multiple-users-one-conversation "Direct link to Shared thread sessions (multiple users, one conversation)")
...
### Exporting Hermes to another machine[​](index.md#exporting-hermes-to-another-machine "Direct link to Exporting Hermes to another machine")
...
### Moving a single profile to another machine[​](index.md#moving-a-single-profile-to-another-machine "Direct link to Moving a single profile to another machine")
...
### `hermes backup` vs `hermes profile export`[​](index.md#hermes-backup-vs-hermes-profile-export "Direct link to hermes-backup-vs-hermes-profile-export")
...
### Permission denied when reloading shell after install[​](index.md#permission-denied-when-reloading-shell-after-install "Direct link to Permission denied when reloading shell after install")
...
### Error 400 on first agent run[​](index.md#error-400-on-first-agent-run "Direct link to Error 400 on first agent run")
...
## Still Stuck?[​](index.md#still-stuck "Direct link to Still Stuck?")
...
- [Frequently Asked Questions](index.md#frequently-asked-questions)
  - [What LLM providers work with Hermes?](index.md#what-llm-providers-work-with-hermes)
  - [Does it work on Windows?](index.md#does-it-work-on-windows)
  - [I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?](index.md#i-run-hermes-in-wsl2-whats-the-best-way-to-control-my-normal-windows-chrome)
  - [Does it work on Android / Termux?](index.md#does-it-work-on-android--termux)
  - [Is my data sent anywhere?](index.md#is-my-data-sent-anywhere)
  - [Can I use it offline / with local models?](index.md#can-i-use-it-offline--with-local-models)
  - [How much does it cost?](index.md#how-much-does-it-cost)
  - [Can multiple people use one instance?](index.md#can-multiple-people-use-one-instance)
  - [What's the difference between memory and skills?](index.md#whats-the-difference-between-memory-and-skills)
  - [Can I use it in my own Python project?](index.md#can-i-use-it-in-my-own-python-project)
- [Troubleshooting](index.md#troubleshooting)
  - [Installation Issues](index.md#installation-issues)
  - [Provider & Model Issues](index.md#provider--model-issues)
  - [Terminal Issues](index.md#terminal-issues)
  - [Messaging Issues](index.md#messaging-issues)
  - [Performance Issues](index.md#performance-issues)
  - [MCP Issues](index.md#mcp-issues)
- [Profiles](index.md#profiles)
  - [How do profiles differ from just setting HERMES\_HOME?](index.md#how-do-profiles-differ-from-just-setting-hermes_home)
  - [Can two profiles share the same bot token?](index.md#can-two-profiles-share-the-same-bot-token)
  - [Do profiles share memory or sessions?](index.md#do-profiles-share-memory-or-sessions)
  - [What happens when I run `hermes update`?](index.md#what-happens-when-i-run-hermes-update)
  - [How many profiles can I run?](index.md#how-many-profiles-can-i-run)
- [Workflows & Patterns](index.md#workflows--patterns)
  - [Using different models for different tasks (multi-model workflows)](index.md#using-different-models-for-different-tasks-multi-model-workflows)
  - [Running multiple agents on one WhatsApp number (per-chat binding)](index.md#running-multiple-agents-on-one-whatsapp-number-per-chat-binding)
  - [Controlling what shows up in Telegram (hiding logs and reasoning)](index.md#controlling-what-shows-up-in-telegram-hiding-logs-and-reasoning)
  - [Managing skills on Telegram (slash command limit)](index.md#managing-skills-on-telegram-slash-command-limit)
  - [Shared thread sessions (multiple users, one conversation)](index.md#shared-thread-sessions-multiple-users-one-conversation)
  - [Exporting Hermes to another machine](index.md#exporting-hermes-to-another-machine)
  - [Moving a single profile to another machine](index.md#moving-a-single-profile-to-another-machine)
  - [`hermes backup` vs `hermes profile export`](index.md#hermes-backup-vs-hermes-profile-export)
  - [Permission denied when reloading shell after install](index.md#permission-denied-when-reloading-shell-after-install)
  - [Error 400 on first agent run](index.md#error-400-on-first-agent-run)
- [Still Stuck?](index.md#still-stuck)
