...
## Prefer to watch?[​](index.md#prefer-to-watch "Direct link to Prefer to watch?")
...
## Who this is for[​](index.md#who-this-is-for "Direct link to Who this is for")
...
## The fastest path[​](index.md#the-fastest-path "Direct link to The fastest path")
...
## 1. Install Hermes Agent[​](index.md#1-install-hermes-agent "Direct link to 1. Install Hermes Agent")
...
If you're installing on a phone, see the dedicated [Termux guide](../termux/index.md) for the tested manual path, supported extras, and current Android-specific limitations.
...
For detailed installation options, prerequisites, and troubleshooting, see the [Installation guide](../installation/index.md).

## 2. Choose a Provider[​](index.md#2-choose-a-provider "Direct link to 2. Choose a Provider")
...
| **AWS Bedrock** | Claude, Nova, Llama, DeepSeek via native Converse API | IAM role or `aws configure` ([guide](../../guides/aws-bedrock/index.md)) |
...
For most first-time users: choose a provider, accept the defaults unless you know why you're changing them. The full provider catalog with env vars and setup steps lives on the [Providers](../../integrations/providers/index.md) page.
...
You can switch providers at any time with `hermes model` — no lock-in. For a full list of all supported providers and setup details, see [AI Providers](../../integrations/providers/index.md).

### How settings are stored[​](index.md#how-settings-are-stored "Direct link to How settings are stored")
...
## 3. Run Your First Chat[​](index.md#3-run-your-first-chat "Direct link to 3. Run Your First Chat")
...
Hermes ships with two terminal interfaces: the classic `prompt_toolkit` CLI and a newer [TUI](../../user-guide/tui/index.md) with modal overlays, mouse selection, and non-blocking input. Both share the same sessions, slash commands, and config — try each with `hermes` vs `hermes --tui`.
...
## 4. Verify Sessions Work[​](index.md#4-verify-sessions-work "Direct link to 4. Verify Sessions Work")
...
## 5. Try Key Features[​](index.md#5-try-key-features "Direct link to 5. Try Key Features")

### Use the terminal[​](index.md#use-the-terminal "Direct link to Use the terminal")
...
### Slash commands[​](index.md#slash-commands "Direct link to Slash commands")
...
### Interrupt the agent[​](index.md#interrupt-the-agent "Direct link to Interrupt the agent")
...
## 6. Add the Next Layer[​](index.md#6-add-the-next-layer "Direct link to 6. Add the Next Layer")

Only after the base chat works. Pick what you need:

### Bot or shared assistant[​](index.md#bot-or-shared-assistant "Direct link to Bot or shared assistant")

```
hermes gateway setup    # Interactive platform configuration
```

Connect [Telegram](../../user-guide/messaging/telegram/index.md), [Discord](../../user-guide/messaging/discord/index.md), [Slack](../../user-guide/messaging/slack/index.md), [WhatsApp](../../user-guide/messaging/whatsapp/index.md), [Signal](../../user-guide/messaging/signal/index.md), [Email](../../user-guide/messaging/email/index.md), or [Home Assistant](../../user-guide/messaging/homeassistant/index.md), or [Microsoft Teams](../../user-guide/messaging/teams/index.md).

### Automation and tools[​](index.md#automation-and-tools "Direct link to Automation and tools")
...
### Sandboxed terminal[​](index.md#sandboxed-terminal "Direct link to Sandboxed terminal")
...
### Voice mode[​](index.md#voice-mode "Direct link to Voice mode")
...
Then in the CLI: `/voice on`. Press `Ctrl+B` to record. See [Voice Mode](../../user-guide/features/voice-mode/index.md).

### Skills[​](index.md#skills "Direct link to Skills")
...
### Editor integration (ACP)[​](index.md#editor-integration-acp "Direct link to Editor integration (ACP)")
...
See [ACP Editor Integration](../../user-guide/features/acp/index.md).
...
## Recovery Toolkit[​](index.md#recovery-toolkit "Direct link to Recovery Toolkit")
...
## Next Steps[​](index.md#next-steps "Direct link to Next Steps")

- **[CLI Guide](../../user-guide/cli/index.md)** — Master the terminal interface
- **[Configuration](../../user-guide/configuration/index.md)** — Customize your setup
...
- **[Tools & Toolsets](../../user-guide/features/tools/index.md)** — Explore available capabilities
- **[AI Providers](../../integrations/providers/index.md)** — Full provider list and setup details
- **[Skills System](../../user-guide/features/skills/index.md)** — Reusable workflows and knowledge
- **[Tips & Best Practices](../../guides/tips/index.md)** — Power user tips

- [Prefer to watch?](index.md#prefer-to-watch)
- [Who this is for](index.md#who-this-is-for)
- [The fastest path](index.md#the-fastest-path)
- [1. Install Hermes Agent](index.md#1-install-hermes-agent)
- [2. Choose a Provider](index.md#2-choose-a-provider)
  - [How settings are stored](index.md#how-settings-are-stored)
- [3. Run Your First Chat](index.md#3-run-your-first-chat)
- [4. Verify Sessions Work](index.md#4-verify-sessions-work)
- [5. Try Key Features](index.md#5-try-key-features)
  - [Use the terminal](index.md#use-the-terminal)
  - [Slash commands](index.md#slash-commands)
  - [Multi-line input](index.md#multi-line-input)
  - [Interrupt the agent](index.md#interrupt-the-agent)
- [6. Add the Next Layer](index.md#6-add-the-next-layer)
  - [Bot or shared assistant](index.md#bot-or-shared-assistant)
  - [Automation and tools](index.md#automation-and-tools)
  - [Sandboxed terminal](index.md#sandboxed-terminal)
  - [Voice mode](index.md#voice-mode)
  - [Skills](index.md#skills)
  - [MCP servers](index.md#mcp-servers)
  - [Editor integration (ACP)](index.md#editor-integration-acp)
- [Common Failure Modes](index.md#common-failure-modes)
- [Recovery Toolkit](index.md#recovery-toolkit)
