...
## Quick Install[​](index.md#quick-install "Direct link to Quick Install")

### Linux / macOS / WSL2[​](index.md#linux--macos--wsl2 "Direct link to Linux / macOS / WSL2")

```
curl -fsSL https://raw.githubusercontent.com/NousResearch/hermes-agent/main/scripts/install.sh | bash
```

### Windows (native, PowerShell) — Early Beta[​](index.md#windows-native-powershell--early-beta "Direct link to Windows (native, PowerShell) — Early Beta")
...
### Android / Termux[​](index.md#android--termux "Direct link to Android / Termux")
...
If you want the fully explicit path, follow the dedicated [Termux guide](../termux/index.md).
...
### What the Installer Does[​](index.md#what-the-installer-does "Direct link to What the Installer Does")

The installer handles everything automatically — all dependencies (Python, Node.js, ripgrep, ffmpeg), the repo clone, virtual environment, global `hermes` command setup, and LLM provider configuration. By the end, you're ready to chat.

#### Install Layout[​](index.md#install-layout "Direct link to Install Layout")
...
### After Installation[​](index.md#after-installation "Direct link to After Installation")
...
If you use Nix (on NixOS, macOS, or Linux), there's a dedicated setup path with a Nix flake, declarative NixOS module, and optional container mode. See the **[Nix & NixOS Setup](../nix-setup/index.md)** guide.

---

## Manual / Developer Installation[​](index.md#manual--developer-installation "Direct link to Manual / Developer Installation")

If you want to clone the repo and install from source — for contributing, running from a specific branch, or having full control over the virtual environment — see the [Development Setup](../../developer-guide/contributing/index.md#development-setup) section in the Contributing guide.
...
- [Quick Install](index.md#quick-install)
  - [Linux / macOS / WSL2](index.md#linux--macos--wsl2)
  - [Windows (native, PowerShell) — Early Beta](index.md#windows-native-powershell--early-beta)
  - [Android / Termux](index.md#android--termux)
  - [What the Installer Does](index.md#what-the-installer-does)
  - [After Installation](index.md#after-installation)
- [Prerequisites](index.md#prerequisites)
- [Manual / Developer Installation](index.md#manual--developer-installation)
