...
title: Nix & NixOS Setup | Hermes Agent
...
## Quick Start (Any Nix User)[​](index.md#quick-start-any-nix-user "Direct link to Quick Start (Any Nix User)")
...
After `nix profile install`, `hermes`, `hermes-agent`, and `hermes-acp` are on your PATH. From here, the workflow is identical to the [standard installation](../installation/index.md) — `hermes setup` walks you through provider selection, `hermes gateway install` sets up a launchd (macOS) or systemd user service, and config lives in `~/.hermes/`.
...
## NixOS Module[​](index.md#nixos-module "Direct link to NixOS Module")
...
### Add the Flake Input[​](index.md#add-the-flake-input "Direct link to Add the Flake Input")
...
### Minimal Configuration[​](index.md#minimal-configuration "Direct link to Minimal Configuration")
...
### Container-aware CLI[​](index.md#container-aware-cli "Direct link to Container-aware CLI")
...
### Verify It Works[​](index.md#verify-it-works "Direct link to Verify It Works")
...
### Choosing a Deployment Mode[​](index.md#choosing-a-deployment-mode "Direct link to Choosing a Deployment Mode")
...
### Declarative Settings[​](index.md#declarative-settings "Direct link to Declarative Settings")
...
### Escape Hatch: Bring Your Own Config[​](index.md#escape-hatch-bring-your-own-config "Direct link to Escape Hatch: Bring Your Own Config")
...
### Customization Cheatsheet[​](index.md#customization-cheatsheet "Direct link to Customization Cheatsheet")
...
| Add MCP tool servers | `mcpServers.<name>` | See [MCP Servers](index.md#mcp-servers) |
...
## Secrets Management[​](index.md#secrets-management "Direct link to Secrets Management")
...
### sops-nix[​](index.md#sops-nix "Direct link to sops-nix")
...
### agenix[​](index.md#agenix "Direct link to agenix")
...
### OAuth / Auth Seeding[​](index.md#oauth--auth-seeding "Direct link to OAuth / Auth Seeding")
...
## Documents[​](index.md#documents "Direct link to Documents")
...
## MCP Servers[​](index.md#mcp-servers "Direct link to MCP Servers")
...
### Stdio Transport (Local Servers)[​](index.md#stdio-transport-local-servers "Direct link to Stdio Transport (Local Servers)")
...
### HTTP Transport (Remote Servers)[​](index.md#http-transport-remote-servers "Direct link to HTTP Transport (Remote Servers)")
...
### HTTP Transport with OAuth[​](index.md#http-transport-with-oauth "Direct link to HTTP Transport with OAuth")
...
### Sampling (Server-Initiated LLM Requests)[​](index.md#sampling-server-initiated-llm-requests "Direct link to Sampling (Server-Initiated LLM Requests)")
...
## Managed Mode[​](index.md#managed-mode "Direct link to Managed Mode")
...
## Container Architecture[​](index.md#container-architecture "Direct link to Container Architecture")
...
### What Persists Across What[​](index.md#what-persists-across-what "Direct link to What Persists Across What")
...
### GC Root Protection[​](index.md#gc-root-protection "Direct link to GC Root Protection")
...
## Plugins[​](index.md#plugins "Direct link to Plugins")

The NixOS module supports declarative plugin installation — no imperative `hermes plugins install` needed.

### Directory Plugins (`extraPlugins`)[​](index.md#directory-plugins-extraplugins "Direct link to directory-plugins-extraplugins")
...
### Entry-Point Plugins (`extraPythonPackages`)[​](index.md#entry-point-plugins-extrapythonpackages "Direct link to entry-point-plugins-extrapythonpackages")
...
### Optional Dependency Groups (`extraDependencyGroups`)[​](index.md#optional-dependency-groups-extradependencygroups "Direct link to optional-dependency-groups-extradependencygroups")
...
### Combining Both[​](index.md#combining-both "Direct link to Combining Both")
...
### Using the Overlay[​](index.md#using-the-overlay "Direct link to Using the Overlay")
...
### Plugin Configuration[​](index.md#plugin-configuration "Direct link to Plugin Configuration")
...
## Development[​](index.md#development "Direct link to Development")

### Dev Shell[​](index.md#dev-shell "Direct link to Dev Shell")
...
### direnv (Recommended)[​](index.md#direnv-recommended "Direct link to direnv (Recommended)")
...
### Flake Checks[​](index.md#flake-checks "Direct link to Flake Checks")
...
## Options Reference[​](index.md#options-reference "Direct link to Options Reference")
...
### Secrets & Environment[​](index.md#secrets--environment "Direct link to Secrets & Environment")
...
### Documents[​](index.md#documents-1 "Direct link to Documents")
...
### MCP Servers[​](index.md#mcp-servers-1 "Direct link to MCP Servers")
...
### Service Behavior[​](index.md#service-behavior "Direct link to Service Behavior")
...
### Container[​](index.md#container "Direct link to Container")
...
## Directory Layout[​](index.md#directory-layout "Direct link to Directory Layout")

### Native Mode[​](index.md#native-mode "Direct link to Native Mode")
...
### Container Mode[​](index.md#container-mode "Direct link to Container Mode")
...
### Service Logs[​](index.md#service-logs "Direct link to Service Logs")
...
### Container Inspection[​](index.md#container-inspection "Direct link to Container Inspection")
...
### Force Container Recreation[​](index.md#force-container-recreation "Direct link to Force Container Recreation")
...
### Verify Secrets Are Loaded[​](index.md#verify-secrets-are-loaded "Direct link to Verify Secrets Are Loaded")
...
### GC Root Verification[​](index.md#gc-root-verification "Direct link to GC Root Verification")

```
nix-store --query --roots $(docker exec hermes-agent readlink /data/current-package)
```

### Common Issues[​](index.md#common-issues "Direct link to Common Issues")
...
| `no container with name or ID "hermes-agent"` (Podman) | Podman rootful container not visible to regular user | Add passwordless sudo for podman (see [Container Mode](index.md#container-mode) section) |
...
- [Quick Start (Any Nix User)](index.md#quick-start-any-nix-user)
- [NixOS Module](index.md#nixos-module)
  - [Add the Flake Input](index.md#add-the-flake-input)
  - [Minimal Configuration](index.md#minimal-configuration)
  - [Container-aware CLI](index.md#container-aware-cli)
  - [Verify It Works](index.md#verify-it-works)
  - [Choosing a Deployment Mode](index.md#choosing-a-deployment-mode)
- [Configuration](index.md#configuration)
  - [Declarative Settings](index.md#declarative-settings)
  - [Escape Hatch: Bring Your Own Config](index.md#escape-hatch-bring-your-own-config)
  - [Customization Cheatsheet](index.md#customization-cheatsheet)
- [Secrets Management](index.md#secrets-management)
  - [sops-nix](index.md#sops-nix)
  - [agenix](index.md#agenix)
  - [OAuth / Auth Seeding](index.md#oauth--auth-seeding)
- [Documents](index.md#documents)
- [MCP Servers](index.md#mcp-servers)
  - [Stdio Transport (Local Servers)](index.md#stdio-transport-local-servers)
  - [HTTP Transport (Remote Servers)](index.md#http-transport-remote-servers)
  - [HTTP Transport with OAuth](index.md#http-transport-with-oauth)
  - [Sampling (Server-Initiated LLM Requests)](index.md#sampling-server-initiated-llm-requests)
- [Managed Mode](index.md#managed-mode)
- [Container Architecture](index.md#container-architecture)
  - [What Persists Across What](index.md#what-persists-across-what)
  - [GC Root Protection](index.md#gc-root-protection)
- [Plugins](index.md#plugins)
  - [Directory Plugins (`extraPlugins`)](index.md#directory-plugins-extraplugins)
  - [Entry-Point Plugins (`extraPythonPackages`)](index.md#entry-point-plugins-extrapythonpackages)
  - [Optional Dependency Groups (`extraDependencyGroups`)](index.md#optional-dependency-groups-extradependencygroups)
  - [Combining Both](index.md#combining-both)
  - [Using the Overlay](index.md#using-the-overlay)
  - [Plugin Configuration](index.md#plugin-configuration)
- [Development](index.md#development)
  - [Dev Shell](index.md#dev-shell)
  - [direnv (Recommended)](index.md#direnv-recommended)
  - [Flake Checks](index.md#flake-checks)
- [Options Reference](index.md#options-reference)
  - [Core](index.md#core)
  - [Configuration](index.md#configuration-1)
  - [Secrets & Environment](index.md#secrets--environment)
  - [Documents](index.md#documents-1)
  - [MCP Servers](index.md#mcp-servers-1)
  - [Service Behavior](index.md#service-behavior)
  - [Container](index.md#container)
- [Directory Layout](index.md#directory-layout)
  - [Native Mode](index.md#native-mode)
  - [Container Mode](index.md#container-mode)
- [Updating](index.md#updating)
- [Troubleshooting](index.md#troubleshooting)
  - [Service Logs](index.md#service-logs)
  - [Container Inspection](index.md#container-inspection)
  - [Force Container Recreation](index.md#force-container-recreation)
  - [Verify Secrets Are Loaded](index.md#verify-secrets-are-loaded)
  - [GC Root Verification](index.md#gc-root-verification)
