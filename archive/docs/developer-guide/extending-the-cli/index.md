...
## Extension points[​](index.md#extension-points "Direct link to Extension points")
...
## Quick start: a wrapper CLI[​](index.md#quick-start-a-wrapper-cli "Direct link to Quick start: a wrapper CLI")
...
### `_get_extra_tui_widgets()`[​](index.md#_get_extra_tui_widgets "Direct link to _get_extra_tui_widgets")
...
### `_register_extra_tui_keybindings(kb, *, input_area)`[​](index.md#_register_extra_tui_keybindingskb--input_area "Direct link to _register_extra_tui_keybindingskb--input_area")
...
### `_build_tui_layout_children(**widgets)`[​](index.md#_build_tui_layout_childrenwidgets "Direct link to _build_tui_layout_childrenwidgets")
...
## Layout diagram[​](index.md#layout-diagram "Direct link to Layout diagram")
...
- [Extension points](index.md#extension-points)
- [Quick start: a wrapper CLI](index.md#quick-start-a-wrapper-cli)
- [Hook reference](index.md#hook-reference)
  - [`_get_extra_tui_widgets()`](index.md#_get_extra_tui_widgets)
  - [`_register_extra_tui_keybindings(kb, *, input_area)`](index.md#_register_extra_tui_keybindingskb--input_area)
  - [`_build_tui_layout_children(**widgets)`](index.md#_build_tui_layout_childrenwidgets)
- [Layout diagram](index.md#layout-diagram)
- [Tips](index.md#tips)
