...
Before writing a tool, ask yourself: **should this be a [skill](../creating-skills/index.md) instead?**
...
- [Plugins](../../user-guide/features/plugins/index.md)
- [Build a Hermes Plugin](../../guides/build-a-hermes-plugin/index.md)
...
## Step 1: Create the Built-in Tool File[​](index.md#step-1-create-the-built-in-tool-file "Direct link to Step 1: Create the Built-in Tool File")
...
### Key Rules[​](index.md#key-rules "Direct link to Key Rules")
...
## Step 2: Add the Built-in Tool to a Toolset[​](index.md#step-2-add-the-built-in-tool-to-a-toolset "Direct link to Step 2: Add the Built-in Tool to a Toolset")
...
## ~~Step 3: Add Discovery Import~~ (No longer needed)[​](index.md#step-3-add-discovery-import-no-longer-needed "Direct link to step-3-add-discovery-import-no-longer-needed")
...
## Async Handlers[​](index.md#async-handlers "Direct link to Async Handlers")
...
## Handlers That Need task\_id[​](index.md#handlers-that-need-task_id "Direct link to Handlers That Need task_id")
...
## Agent-Loop Intercepted Tools[​](index.md#agent-loop-intercepted-tools "Direct link to Agent-Loop Intercepted Tools")
...
## Optional: Setup Wizard Integration[​](index.md#optional-setup-wizard-integration "Direct link to Optional: Setup Wizard Integration")
...
## Checklist[​](index.md#checklist "Direct link to Checklist")
...
- [Step 1: Create the Built-in Tool File](index.md#step-1-create-the-built-in-tool-file)
  - [Key Rules](index.md#key-rules)
- [Step 2: Add the Built-in Tool to a Toolset](index.md#step-2-add-the-built-in-tool-to-a-toolset)
- [~~Step 3: Add Discovery Import~~ (No longer needed)](index.md#step-3-add-discovery-import-no-longer-needed)
- [Async Handlers](index.md#async-handlers)
- [Handlers That Need task\_id](index.md#handlers-that-need-task_id)
- [Agent-Loop Intercepted Tools](index.md#agent-loop-intercepted-tools)
- [Optional: Setup Wizard Integration](index.md#optional-setup-wizard-integration)
- [Checklist](index.md#checklist)
