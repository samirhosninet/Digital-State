...
title: Session Storage | Hermes Agent
...
## SQLite Schema[​](index.md#sqlite-schema "Direct link to SQLite Schema")

### Sessions Table[​](index.md#sessions-table "Direct link to Sessions Table")
...
### Messages Table[​](index.md#messages-table "Direct link to Messages Table")
...
### FTS5 Full-Text Search[​](index.md#fts5-full-text-search "Direct link to FTS5 Full-Text Search")
...
## Schema Version and Migrations[​](index.md#schema-version-and-migrations "Direct link to Schema Version and Migrations")
...
## Write Contention Handling[​](index.md#write-contention-handling "Direct link to Write Contention Handling")
...
## Common Operations[​](index.md#common-operations "Direct link to Common Operations")

### Initialize[​](index.md#initialize "Direct link to Initialize")
...
### Create and Manage Sessions[​](index.md#create-and-manage-sessions "Direct link to Create and Manage Sessions")
...
### Store Messages[​](index.md#store-messages "Direct link to Store Messages")
...
### Retrieve Messages[​](index.md#retrieve-messages "Direct link to Retrieve Messages")
...
### Session Titles[​](index.md#session-titles "Direct link to Session Titles")
...
## Full-Text Search[​](index.md#full-text-search "Direct link to Full-Text Search")

The `search_messages()` method supports FTS5 query syntax with automatic
sanitization of user input.

### Basic Search[​](index.md#basic-search "Direct link to Basic Search")

```
results = db.search_messages("docker deployment")
```

### FTS5 Query Syntax[​](index.md#fts5-query-syntax "Direct link to FTS5 Query Syntax")
...
### Filtered Search[​](index.md#filtered-search "Direct link to Filtered Search")
...
### Search Results Format[​](index.md#search-results-format "Direct link to Search Results Format")
...
## Session Lineage[​](index.md#session-lineage "Direct link to Session Lineage")
...
### Query: Find Session Lineage[​](index.md#query-find-session-lineage "Direct link to Query: Find Session Lineage")
...
### Query: Recent Sessions with Preview[​](index.md#query-recent-sessions-with-preview "Direct link to Query: Recent Sessions with Preview")
...
### Query: Token Usage Statistics[​](index.md#query-token-usage-statistics "Direct link to Query: Token Usage Statistics")
...
## Export and Cleanup[​](index.md#export-and-cleanup "Direct link to Export and Cleanup")
...
## Database Location[​](index.md#database-location "Direct link to Database Location")
...
- [SQLite Schema](index.md#sqlite-schema)
  - [Sessions Table](index.md#sessions-table)
  - [Messages Table](index.md#messages-table)
  - [FTS5 Full-Text Search](index.md#fts5-full-text-search)
- [Schema Version and Migrations](index.md#schema-version-and-migrations)
- [Write Contention Handling](index.md#write-contention-handling)
- [Common Operations](index.md#common-operations)
  - [Initialize](index.md#initialize)
  - [Create and Manage Sessions](index.md#create-and-manage-sessions)
  - [Store Messages](index.md#store-messages)
  - [Retrieve Messages](index.md#retrieve-messages)
  - [Session Titles](index.md#session-titles)
- [Full-Text Search](index.md#full-text-search)
  - [Basic Search](index.md#basic-search)
  - [FTS5 Query Syntax](index.md#fts5-query-syntax)
  - [Filtered Search](index.md#filtered-search)
  - [Search Results Format](index.md#search-results-format)
- [Session Lineage](index.md#session-lineage)
  - [Query: Find Session Lineage](index.md#query-find-session-lineage)
  - [Query: Recent Sessions with Preview](index.md#query-recent-sessions-with-preview)
  - [Query: Token Usage Statistics](index.md#query-token-usage-statistics)
- [Export and Cleanup](index.md#export-and-cleanup)
- [Database Location](index.md#database-location)
