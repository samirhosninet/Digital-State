...
title: Prompt Assembly | Hermes Agent
...
## Cached system prompt layers[​](index.md#cached-system-prompt-layers "Direct link to Cached system prompt layers")
...
### Concrete example: assembled system prompt[​](index.md#concrete-example-assembled-system-prompt "Direct link to Concrete example: assembled system prompt")
...
## How SOUL.md appears in the prompt[​](index.md#how-soulmd-appears-in-the-prompt "Direct link to How SOUL.md appears in the prompt")
...
## How context files are injected[​](index.md#how-context-files-are-injected "Direct link to How context files are injected")
...
### Context file discovery details[​](index.md#context-file-discovery-details "Direct link to Context file discovery details")
...
## API-call-time-only layers[​](index.md#api-call-time-only-layers "Direct link to API-call-time-only layers")
...
## Memory snapshots[​](index.md#memory-snapshots "Direct link to Memory snapshots")
...
## Skills index[​](index.md#skills-index "Direct link to Skills index")

The skills system contributes a compact skills index to the prompt when skills tooling is available.

## Supported prompt customization surfaces[​](index.md#supported-prompt-customization-surfaces "Direct link to Supported prompt customization surfaces")
...
### Use these surfaces first[​](index.md#use-these-surfaces-first "Direct link to Use these surfaces first")
...
### When to edit code instead[​](index.md#when-to-edit-code-instead "Direct link to When to edit code instead")
...
## Why prompt assembly is split this way[​](index.md#why-prompt-assembly-is-split-this-way "Direct link to Why prompt assembly is split this way")
...
- [Cached system prompt layers](index.md#cached-system-prompt-layers)
  - [Concrete example: assembled system prompt](index.md#concrete-example-assembled-system-prompt)
- [How SOUL.md appears in the prompt](index.md#how-soulmd-appears-in-the-prompt)
- [How context files are injected](index.md#how-context-files-are-injected)
  - [Context file discovery details](index.md#context-file-discovery-details)
- [API-call-time-only layers](index.md#api-call-time-only-layers)
- [Memory snapshots](index.md#memory-snapshots)
- [Context files](index.md#context-files)
- [Skills index](index.md#skills-index)
- [Supported prompt customization surfaces](index.md#supported-prompt-customization-surfaces)
  - [Use these surfaces first](index.md#use-these-surfaces-first)
  - [When to edit code instead](index.md#when-to-edit-code-instead)
- [Why prompt assembly is split this way](index.md#why-prompt-assembly-is-split-this-way)
