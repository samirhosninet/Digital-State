...
## Core Responsibilities[​](index.md#core-responsibilities "Direct link to Core Responsibilities")

`AIAgent` is responsible for:

- Assembling the effective system prompt and tool schemas via `prompt_builder.py`
- Selecting the correct provider/API mode (chat\_completions, codex\_responses, anthropic\_messages)
...
## Two Entry Points[​](index.md#two-entry-points "Direct link to Two Entry Points")
...
## API Modes[​](index.md#api-modes "Direct link to API Modes")
...
## Turn Lifecycle[​](index.md#turn-lifecycle "Direct link to Turn Lifecycle")
...
### Message Format[​](index.md#message-format "Direct link to Message Format")
...
### Message Alternation Rules[​](index.md#message-alternation-rules "Direct link to Message Alternation Rules")
...
## Interruptible API Calls[​](index.md#interruptible-api-calls "Direct link to Interruptible API Calls")
...
## Tool Execution[​](index.md#tool-execution "Direct link to Tool Execution")

### Sequential vs Concurrent[​](index.md#sequential-vs-concurrent "Direct link to Sequential vs Concurrent")
...
### Execution Flow[​](index.md#execution-flow "Direct link to Execution Flow")
...
### Agent-Level Tools[​](index.md#agent-level-tools "Direct link to Agent-Level Tools")
...
## Callback Surfaces[​](index.md#callback-surfaces "Direct link to Callback Surfaces")
...
## Budget and Fallback Behavior[​](index.md#budget-and-fallback-behavior "Direct link to Budget and Fallback Behavior")

### Iteration Budget[​](index.md#iteration-budget "Direct link to Iteration Budget")
...
### Fallback Model[​](index.md#fallback-model "Direct link to Fallback Model")
...
## Compression and Persistence[​](index.md#compression-and-persistence "Direct link to Compression and Persistence")

### When Compression Triggers[​](index.md#when-compression-triggers "Direct link to When Compression Triggers")
...
### What Happens During Compression[​](index.md#what-happens-during-compression "Direct link to What Happens During Compression")
...
## Key Source Files[​](index.md#key-source-files "Direct link to Key Source Files")
...
- [Prompt Assembly](../prompt-assembly/index.md)
- [Context Compression & Prompt Caching](../context-compression-and-caching/index.md)
- [Tools Runtime](../tools-runtime/index.md)
- [Architecture Overview](../architecture/index.md)

- [Core Responsibilities](index.md#core-responsibilities)
- [Two Entry Points](index.md#two-entry-points)
- [API Modes](index.md#api-modes)
- [Turn Lifecycle](index.md#turn-lifecycle)
  - [Message Format](index.md#message-format)
  - [Message Alternation Rules](index.md#message-alternation-rules)
- [Interruptible API Calls](index.md#interruptible-api-calls)
- [Tool Execution](index.md#tool-execution)
  - [Sequential vs Concurrent](index.md#sequential-vs-concurrent)
  - [Execution Flow](index.md#execution-flow)
  - [Agent-Level Tools](index.md#agent-level-tools)
- [Callback Surfaces](index.md#callback-surfaces)
- [Budget and Fallback Behavior](index.md#budget-and-fallback-behavior)
  - [Iteration Budget](index.md#iteration-budget)
  - [Fallback Model](index.md#fallback-model)
- [Compression and Persistence](index.md#compression-and-persistence)
  - [When Compression Triggers](index.md#when-compression-triggers)
  - [What Happens During Compression](index.md#what-happens-during-compression)
  - [Session Persistence](index.md#session-persistence)
- [Key Source Files](index.md#key-source-files)
