...
title: Provider Runtime Resolution | Hermes Agent
...
If you are trying to add a new first-class inference provider, read [Adding Providers](../adding-providers/index.md) and the [Model Provider Plugin guide](../model-provider-plugin/index.md) alongside this page.

## Resolution precedence[​](index.md#resolution-precedence "Direct link to Resolution precedence")
...
## Providers[​](index.md#providers "Direct link to Providers")
...
## Output of runtime resolution[​](index.md#output-of-runtime-resolution "Direct link to Output of runtime resolution")
...
## Why this matters[​](index.md#why-this-matters "Direct link to Why this matters")
...
## AI Gateway[​](index.md#ai-gateway "Direct link to AI Gateway")
...
## OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs[​](index.md#openrouter-ai-gateway-and-custom-openai-compatible-base-urls "Direct link to OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs")
...
## Native Anthropic path[​](index.md#native-anthropic-path "Direct link to Native Anthropic path")
...
## OpenAI Codex path[​](index.md#openai-codex-path "Direct link to OpenAI Codex path")
...
## Auxiliary model routing[​](index.md#auxiliary-model-routing "Direct link to Auxiliary model routing")
...
## Fallback models[​](index.md#fallback-models "Direct link to Fallback models")
...
### How it works internally[​](index.md#how-it-works-internally "Direct link to How it works internally")
...
### What does NOT support fallback[​](index.md#what-does-not-support-fallback "Direct link to What does NOT support fallback")
...
Cron jobs **do** support fallback: `run_job()` reads `fallback_providers` (or legacy `fallback_model`) from `config.yaml` and passes it to `AIAgent(fallback_model=...)`, matching the gateway's `_load_fallback_model()` pattern. See [Cron Internals](../cron-internals/index.md).

### Test coverage[​](index.md#test-coverage "Direct link to Test coverage")
...
- [Resolution precedence](index.md#resolution-precedence)
- [Providers](index.md#providers)
- [Output of runtime resolution](index.md#output-of-runtime-resolution)
- [Why this matters](index.md#why-this-matters)
- [AI Gateway](index.md#ai-gateway)
- [OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs](index.md#openrouter-ai-gateway-and-custom-openai-compatible-base-urls)
- [Native Anthropic path](index.md#native-anthropic-path)
- [OpenAI Codex path](index.md#openai-codex-path)
- [Auxiliary model routing](index.md#auxiliary-model-routing)
- [Fallback models](index.md#fallback-models)
  - [How it works internally](index.md#how-it-works-internally)
  - [What does NOT support fallback](index.md#what-does-not-support-fallback)
  - [Test coverage](index.md#test-coverage)
