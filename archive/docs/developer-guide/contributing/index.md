...
## Contribution Priorities[​](index.md#contribution-priorities "Direct link to Contribution Priorities")
...
5. **New skills** — broadly useful ones (see [Creating Skills](../creating-skills/index.md))
6. **New tools** — rarely needed; most capabilities should be skills
7. **Documentation** — fixes, clarifications, new examples

## Common contribution paths[​](index.md#common-contribution-paths "Direct link to Common contribution paths")

- Building a custom/local tool without modifying Hermes core? Start with [Build a Hermes Plugin](../../guides/build-a-hermes-plugin/index.md)
- Building a new built-in core tool for Hermes itself? Start with [Adding Tools](../adding-tools/index.md)
- Building a new skill? Start with [Creating Skills](../creating-skills/index.md)
- Building a new inference provider? Start with [Adding Providers](../adding-providers/index.md)

## Development Setup[​](index.md#development-setup "Direct link to Development Setup")
...
### Clone and Install[​](index.md#clone-and-install "Direct link to Clone and Install")
...
### Configure for Development[​](index.md#configure-for-development "Direct link to Configure for Development")
...
### Run[​](index.md#run "Direct link to Run")
...
### Run Tests[​](index.md#run-tests "Direct link to Run Tests")

```
pytest tests/ -v
```

## Code Style[​](index.md#code-style "Direct link to Code Style")
...
## Cross-Platform Compatibility[​](index.md#cross-platform-compatibility "Direct link to Cross-Platform Compatibility")
...
### 1. `termios` and `fcntl` are Unix-only[​](index.md#1-termios-and-fcntl-are-unix-only "Direct link to 1-termios-and-fcntl-are-unix-only")
...
### 2. File encoding[​](index.md#2-file-encoding "Direct link to 2. File encoding")
...
### 3. Process management[​](index.md#3-process-management "Direct link to 3. Process management")
...
### 4. Path separators[​](index.md#4-path-separators "Direct link to 4. Path separators")
...
### Existing Protections[​](index.md#existing-protections "Direct link to Existing Protections")
...
### Contributing Security-Sensitive Code[​](index.md#contributing-security-sensitive-code "Direct link to Contributing Security-Sensitive Code")
...
## Pull Request Process[​](index.md#pull-request-process "Direct link to Pull Request Process")

### Branch Naming[​](index.md#branch-naming "Direct link to Branch Naming")
...
### Before Submitting[​](index.md#before-submitting "Direct link to Before Submitting")
...
### PR Description[​](index.md#pr-description "Direct link to PR Description")
...
### Commit Messages[​](index.md#commit-messages "Direct link to Commit Messages")
...
## Reporting Issues[​](index.md#reporting-issues "Direct link to Reporting Issues")
...
## Community[​](index.md#community "Direct link to Community")

- **Discord**: [discord.gg/NousResearch](https://discord.gg/NousResearch)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License[​](index.md#license "Direct link to License")
...
- [Contribution Priorities](index.md#contribution-priorities)
- [Common contribution paths](index.md#common-contribution-paths)
- [Development Setup](index.md#development-setup)
  - [Prerequisites](index.md#prerequisites)
  - [Clone and Install](index.md#clone-and-install)
  - [Configure for Development](index.md#configure-for-development)
  - [Run](index.md#run)
  - [Run Tests](index.md#run-tests)
- [Code Style](index.md#code-style)
- [Cross-Platform Compatibility](index.md#cross-platform-compatibility)
  - [1. `termios` and `fcntl` are Unix-only](index.md#1-termios-and-fcntl-are-unix-only)
  - [2. File encoding](index.md#2-file-encoding)
  - [3. Process management](index.md#3-process-management)
  - [4. Path separators](index.md#4-path-separators)
- [Security Considerations](index.md#security-considerations)
  - [Existing Protections](index.md#existing-protections)
  - [Contributing Security-Sensitive Code](index.md#contributing-security-sensitive-code)
- [Pull Request Process](index.md#pull-request-process)
  - [Branch Naming](index.md#branch-naming)
  - [Before Submitting](index.md#before-submitting)
  - [PR Description](index.md#pr-description)
  - [Commit Messages](index.md#commit-messages)
- [Reporting Issues](index.md#reporting-issues)
