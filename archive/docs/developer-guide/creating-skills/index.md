...
title: Creating Skills | Hermes Agent
...
## Should it be a Skill or a Tool?[​](index.md#should-it-be-a-skill-or-a-tool "Direct link to Should it be a Skill or a Tool?")
...
### Conditional Skill Activation[​](index.md#conditional-skill-activation "Direct link to Conditional Skill Activation")
...
### Environment Variable Requirements[​](index.md#environment-variable-requirements "Direct link to Environment Variable Requirements")

Skills can declare environment variables they need. When a skill is loaded via `skill_view`, its required vars are automatically registered for passthrough into sandboxed execution environments (terminal, execute\_code).
...
### Credential File Requirements (OAuth tokens, etc.)[​](index.md#credential-file-requirements-oauth-tokens-etc "Direct link to Credential File Requirements (OAuth tokens, etc.)")
...
## Skill Guidelines[​](index.md#skill-guidelines "Direct link to Skill Guidelines")

### No External Dependencies[​](index.md#no-external-dependencies "Direct link to No External Dependencies")
...
### Include Helper Scripts[​](index.md#include-helper-scripts "Direct link to Include Helper Scripts")
...
#### Referencing bundled scripts from SKILL.md[​](index.md#referencing-bundled-scripts-from-skillmd "Direct link to Referencing bundled scripts from SKILL.md")
...
#### Inline shell snippets (opt-in)[​](index.md#inline-shell-snippets-opt-in "Direct link to Inline shell snippets (opt-in)")
...
## Where Should the Skill Live?[​](index.md#where-should-the-skill-live "Direct link to Where Should the Skill Live?")
...
## Publishing Skills[​](index.md#publishing-skills "Direct link to Publishing Skills")

### To the Skills Hub[​](index.md#to-the-skills-hub "Direct link to To the Skills Hub")

```
hermes skills publish skills/my-skill --to github --repo owner/repo
```

### To a Custom Repository[​](index.md#to-a-custom-repository "Direct link to To a Custom Repository")
...
- [Should it be a Skill or a Tool?](index.md#should-it-be-a-skill-or-a-tool)
...
- [SKILL.md Format](index.md#skillmd-format)
  ...
  - [Conditional Skill Activation](index.md#conditional-skill-activation)
  - [Environment Variable Requirements](index.md#environment-variable-requirements)
- [Secure Setup on Load](index.md#secure-setup-on-load)
  - [Config Settings (config.yaml)](index.md#config-settings-configyaml)
  - [Credential File Requirements (OAuth tokens, etc.)](index.md#credential-file-requirements-oauth-tokens-etc)
- [Skill Guidelines](index.md#skill-guidelines)
  - [No External Dependencies](index.md#no-external-dependencies)
  - [Progressive Disclosure](index.md#progressive-disclosure)
  - [Include Helper Scripts](index.md#include-helper-scripts)
  - [Test It](index.md#test-it)
- [Where Should the Skill Live?](index.md#where-should-the-skill-live)
- [Publishing Skills](index.md#publishing-skills)
  - [To the Skills Hub](index.md#to-the-skills-hub)
  - [To a Custom Repository](index.md#to-a-custom-repository)
