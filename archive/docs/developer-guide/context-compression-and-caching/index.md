...
## Pluggable Context Engine[​](index.md#pluggable-context-engine "Direct link to Pluggable Context Engine")
...
For building a context engine plugin, see [Context Engine Plugins](../context-engine-plugin/index.md).

## Dual Compression System[​](index.md#dual-compression-system "Direct link to Dual Compression System")
...
### 1. Gateway Session Hygiene (85% threshold)[​](index.md#1-gateway-session-hygiene-85-threshold "Direct link to 1. Gateway Session Hygiene (85% threshold)")
...
### 2. Agent ContextCompressor (50% threshold, configurable)[​](index.md#2-agent-contextcompressor-50-threshold-configurable "Direct link to 2. Agent ContextCompressor (50% threshold, configurable)")
...
### Parameter Details[​](index.md#parameter-details "Direct link to Parameter Details")
...
### Computed Values (for a 200K context model at defaults)[​](index.md#computed-values-for-a-200k-context-model-at-defaults "Direct link to Computed Values (for a 200K context model at defaults)")
...
## Compression Algorithm[​](index.md#compression-algorithm "Direct link to Compression Algorithm")

The `ContextCompressor.compress()` method follows a 4-phase algorithm:

### Phase 1: Prune Old Tool Results (cheap, no LLM call)[​](index.md#phase-1-prune-old-tool-results-cheap-no-llm-call "Direct link to Phase 1: Prune Old Tool Results (cheap, no LLM call)")
...
### Phase 2: Determine Boundaries[​](index.md#phase-2-determine-boundaries "Direct link to Phase 2: Determine Boundaries")
...
Boundaries are aligned to avoid splitting tool\_call/tool\_result groups.
...
### Phase 3: Generate Structured Summary[​](index.md#phase-3-generate-structured-summary "Direct link to Phase 3: Generate Structured Summary")
...
### Phase 4: Assemble Compressed Messages[​](index.md#phase-4-assemble-compressed-messages "Direct link to Phase 4: Assemble Compressed Messages")
...
### Iterative Re-compression[​](index.md#iterative-re-compression "Direct link to Iterative Re-compression")
...
## Before/After Example[​](index.md#beforeafter-example "Direct link to Before/After Example")

### Before Compression (45 messages, ~95K tokens)[​](index.md#before-compression-45-messages-95k-tokens "Direct link to Before Compression (45 messages, ~95K tokens)")
...
### After Compression (25 messages, ~45K tokens)[​](index.md#after-compression-25-messages-45k-tokens "Direct link to After Compression (25 messages, ~45K tokens)")
...
## Prompt Caching (Anthropic)[​](index.md#prompt-caching-anthropic "Direct link to Prompt Caching (Anthropic)")
...
### Strategy: system\_and\_3[​](index.md#strategy-system_and_3 "Direct link to Strategy: system_and_3")

Anthropic allows a maximum of 4 `cache_control` breakpoints per request. Hermes
uses the "system\_and\_3" strategy:
...
### Cache-Aware Design Patterns[​](index.md#cache-aware-design-patterns "Direct link to Cache-Aware Design Patterns")
...
### Enabling Prompt Caching[​](index.md#enabling-prompt-caching "Direct link to Enabling Prompt Caching")
...
- [Pluggable Context Engine](index.md#pluggable-context-engine)
- [Dual Compression System](index.md#dual-compression-system)
  - [1. Gateway Session Hygiene (85% threshold)](index.md#1-gateway-session-hygiene-85-threshold)
  - [2. Agent ContextCompressor (50% threshold, configurable)](index.md#2-agent-contextcompressor-50-threshold-configurable)
- [Configuration](index.md#configuration)
  - [Parameter Details](index.md#parameter-details)
  - [Computed Values (for a 200K context model at defaults)](index.md#computed-values-for-a-200k-context-model-at-defaults)
- [Compression Algorithm](index.md#compression-algorithm)
  - [Phase 1: Prune Old Tool Results (cheap, no LLM call)](index.md#phase-1-prune-old-tool-results-cheap-no-llm-call)
  - [Phase 2: Determine Boundaries](index.md#phase-2-determine-boundaries)
  - [Phase 3: Generate Structured Summary](index.md#phase-3-generate-structured-summary)
  - [Phase 4: Assemble Compressed Messages](index.md#phase-4-assemble-compressed-messages)
  - [Iterative Re-compression](index.md#iterative-re-compression)
- [Before/After Example](index.md#beforeafter-example)
  - [Before Compression (45 messages, ~95K tokens)](index.md#before-compression-45-messages-95k-tokens)
  - [After Compression (25 messages, ~45K tokens)](index.md#after-compression-25-messages-45k-tokens)
- [Prompt Caching (Anthropic)](index.md#prompt-caching-anthropic)
  - [Strategy: system\_and\_3](index.md#strategy-system_and_3)
  - [How It Works](index.md#how-it-works)
  - [Cache-Aware Design Patterns](index.md#cache-aware-design-patterns)
  - [Enabling Prompt Caching](index.md#enabling-prompt-caching)
